...
\begin{proof}
	Pour $j \in \NNs$, notons $\probaset*{P}{j}$ la propriété \emph{\og $\forall m \in \NN$, $\forall k \in \NN$ tel que $0 \leq k \leq j$ , soit (1) est vrai, soit (2) est vrai \fg}.
	...
	\end{mvts}
		...
		\item \textbf{Hérédité :} supposons que $\probaset*{P}{j}$ soit vérifiée avec $j \geq 1$. Nous devons en déduire que $\probaset*{P}{j+1}$ l'est aussi.
