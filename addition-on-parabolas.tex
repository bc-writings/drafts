...
\input{addition-on-parabolas/conjecture}



\section{Preuve de la validité de la conjecture} \label{proof}

\input{addition-on-parabolas/proof}
...
\input{addition-on-parabolas/group}



%  ????? \section{\texorpdfstring{Une propriété caractéristique de la parabole d'équation $y = x^2$}%
%                        {Une propriété caractéristique de la parabole d'équation y = x**2}}
