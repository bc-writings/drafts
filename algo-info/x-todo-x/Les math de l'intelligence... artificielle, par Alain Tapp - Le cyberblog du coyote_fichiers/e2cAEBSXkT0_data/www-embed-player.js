...
;function Ta(a,b){if(Error.captureStackTrace)Error.captureStackTrace(this,Ta);else{var c=Error().stack;c&&(this.stack=c)}a&&(this.message=String(a));b&&(this.Qa=b)}
...
function od(a){var b=ld();b.update(a);return b.Ra().toLowerCase()}
...
function Sd(a,b){b||(b={});b[Ud(a)]=!0;var c=a.stack||"";(a=a.Qa)&&!b[Ud(a)]&&(c+="\nCaused by: ",a.stack&&0==a.stack.indexOf(a.toString())||(c+="string"===typeof a?a:a.message+"\n"),c+=Sd(a,b));return c}
...
ce.prototype.L=function(){return this};function de(a){if(a instanceof ee||a instanceof fe||a instanceof ge)return a;if("function"==typeof a.next)return new ee(function(){return he(a)});
if("function"==typeof a[Symbol.iterator])return new ee(function(){return a[Symbol.iterator]()});
if("function"==typeof a.L)return new ee(function(){return he(a.L())});
...
ee.prototype.L=function(){return new fe(this.h())};
...
m.keys=function(){return de(this.L(!0)).i()};
m.values=function(){return de(this.L(!1)).i()};
m.entries=function(){var a=this;return Nd(this.keys(),function(b){return[b,a.get(b)]})};
m.L=function(a){ke(this);var b=0,c=this.V,d=this,e=new ce;e.h=function(){if(c!=d.V)throw Error("The map has changed since the iterator was created");if(b>=d.h.length)throw be;var f=d.h[b++];return a?f:d.i[f]};
...
this.i=a;a.defaultPrevented&&pe.O.preventDefault.call(this)};
pe.prototype.stopPropagation=function(){pe.O.stopPropagation.call(this);this.i.stopPropagation?this.i.stopPropagation():this.i.cancelBubble=!0};
pe.prototype.preventDefault=function(){pe.O.preventDefault.call(this);var a=this.i;a.preventDefault?a.preventDefault():a.returnValue=!1};var re="closure_listenable_"+(1E6*Math.random()|0);var se=0;function te(a,b,c,d,e){this.listener=a;this.h=null;this.src=b;this.type=c;this.capture=!!d;this.la=e;this.key=++se;this.fa=this.ia=!1}
...
return a[Le]}
;function Me(){L.call(this);this.i=new ve(this);this.M=this;this.u=null}
...
function Ne(a,b){var c=a.u;if(c){var d=[];for(var e=1;c;c=c.u)d.push(c),++e}a=a.M;c=b.type||b;"string"===typeof b?b=new oe(b,a):b instanceof oe?b.target=b.target||a:(e=b,b=new oe(c,a),nb(b,e));e=!0;if(d)for(var f=d.length-1;!b.j&&0<=f;f--){var g=b.h=d[f];e=Oe(g,c,!0,b)&&e}b.j||(g=b.h=a,e=Oe(g,c,!0,b)&&e,b.j||(e=Oe(g,c,!1,b)&&e));if(d)for(f=0;!b.j&&f<d.length;f++)g=b.h=d[f],e=Oe(g,c,!1,b)&&e}
Me.prototype.D=function(){Me.O.D.call(this);if(this.i){var a=this.i,b=0,c;for(c in a.listeners){for(var d=a.listeners[c],e=0;e<d.length;e++)++b,ue(d[e]);delete a.listeners[c];a.h--}}this.u=null};
...
m.D=function(){M.O.D.call(this);this.clear();this.l.length=0};function qf(a){this.h=a}
...
rf.prototype.set=function(a,b){rf.O.set.call(this,a,tf(b))};
rf.prototype.i=function(a){a=rf.O.get.call(this,a);if(void 0===a||a instanceof Object)return a;throw"Storage: Invalid value was encountered";};
...
C(uf,rf);uf.prototype.set=function(a,b,c){if(b=tf(b)){if(c){if(c<Date.now()){uf.prototype.remove.call(this,a);return}b.expiration=c}b.creation=Date.now()}uf.O.set.call(this,a,b)};
uf.prototype.i=function(a){var b=uf.O.i.call(this,a);if(b){var c=b.creation,d=b.expiration;if(d&&d<Date.now()||c&&c>Date.now())uf.prototype.remove.call(this,a);else return b}};function vf(){}
;function wf(){}
C(wf,vf);wf.prototype[Symbol.iterator]=function(){return de(this.L(!0)).i()};
...
m.L=function(a){var b=0,c=this.h,d=new ce;d.h=function(){if(b>=c.length)throw be;var e=c.key(b++);if(a)return e;e=c.getItem(e);if("string"!==typeof e)throw"Storage mechanism: Invalid value was encountered";return e};
...
m.L=function(a){var b=0,c=this.h.XMLDocument.documentElement.attributes,d=new ce;d.h=function(){if(b>=c.length)throw be;var e=c[b++];if(a)return decodeURIComponent(e.nodeName.replace(/\./g,"%")).substr(1);e=e.nodeValue;if("string"!==typeof e)throw"Storage mechanism: Invalid value was encountered";return e};
d.next=d.h.bind(d);return d};
...
Ef.prototype.L=function(a){var b=this.i.L(!0),c=this,d=new ce;d.h=function(){for(var e=b.next();e.substr(0,c.h.length)!=c.h;)e=b.next();return a?e.substr(c.h.length):c.i.get(e)};
...
;function fg(a){this.C=a;this.i=null;this.m=0;this.A=null;this.u=0;this.j=[];for(a=0;4>a;a++)this.j.push(0);this.l=0;this.J=ag(window,"mousemove",Oa(this.K,this));a=Oa(this.G,this);"function"===typeof a&&(a=Mf(a));this.M=window.setInterval(a,25)}
C(fg,L);fg.prototype.K=function(a){void 0===a.h&&Xf(a);var b=a.h;void 0===a.i&&Xf(a);this.i=new Qc(b,a.i)};
...
fg.prototype.D=function(){window.clearInterval(this.M);bg(this.J)};function gg(){}
...
function ng(a){var b=void 0===a?{}:a;a=void 0===b.kb?!1:b.kb;b=void 0===b.Ua?!0:b.Ua;if(null==B("_lact",window)){var c=parseInt(E("LACT"),10);c=isFinite(c)?Date.now()-Math.max(c,0):-1;z("_lact",c,window);z("_fact",c,window);-1==c&&og();ag(document,"keydown",og);ag(document,"keyup",og);ag(document,"mousedown",og);ag(document,"mouseup",og);a?ag(window,"touchmove",function(){pg("touchmove",200)},{passive:!0}):(ag(window,"resize",function(){pg("resize",200)}),b&&ag(window,"scroll",function(){pg("scroll",200)}));
...
;function Eg(a){var b=Fg;a=void 0===a?B("yt.ads.biscotti.lastId_")||"":a;var c=Object,d=c.assign,e={};e.dt=jd;e.flash="0";a:{try{var f=b.h.top.location.href}catch(Sa){f=2;break a}f=f?f===b.i.location.href?0:1:2}e=(e.frm=f,e);e.u_tz=-(new Date).getTimezoneOffset();var g=void 0===g?I:g;try{var h=g.history.length}catch(Sa){h=0}e.u_his=h;e.u_java=!!I.navigator&&"unknown"!==typeof I.navigator.javaEnabled&&!!I.navigator.javaEnabled&&I.navigator.javaEnabled();I.screen&&(e.u_h=I.screen.height,e.u_w=I.screen.width,
e.u_ah=I.screen.availHeight,e.u_aw=I.screen.availWidth,e.u_cd=I.screen.colorDepth);I.navigator&&I.navigator.plugins&&(e.u_nplug=I.navigator.plugins.length);I.navigator&&I.navigator.mimeTypes&&(e.u_nmime=I.navigator.mimeTypes.length);h=b.h;try{var k=h.screenX;var l=h.screenY}catch(Sa){}try{var n=h.outerWidth;var q=h.outerHeight}catch(Sa){}try{var r=h.innerWidth;var p=h.innerHeight}catch(Sa){}try{var A=h.screenLeft;var J=h.screenTop}catch(Sa){}try{r=h.innerWidth,p=h.innerHeight}catch(Sa){}try{var F=
h.screen.availWidth;var Q=h.screen.availTop}catch(Sa){}k=[A,J,k,l,F,Q,n,q,r,p];l=b.h.top;try{var V=(l||window).document,K="CSS1Compat"==V.compatMode?V.documentElement:V.body;var T=(new Rc(K.clientWidth,K.clientHeight)).round()}catch(Sa){T=new Rc(-12245933,-12245933)}V=T;T={};K=new wd;y.SVGElement&&y.document.createElementNS&&K.set(0);l=cd();l["allow-top-navigation-by-user-activation"]&&K.set(1);l["allow-popups-to-escape-sandbox"]&&K.set(2);y.crypto&&y.crypto.subtle&&K.set(3);y.TextDecoder&&y.TextEncoder&&
...
v(R,yi);function Ii(a){R.call(this,"MISSING_OBJECT_STORE",{gb:a},Di.MISSING_OBJECT_STORE);Object.setPrototypeOf(this,Ii.prototype)}
...
oj.prototype.open=function(){function a(){return H(c,function g(){var h=this,k,l,n,q,r;return x(g,function(p){switch(p.h){case 1:return ra(p,2),w(p,h.i(h.name,h.options.version,e),4);case 4:k=p.i;a:{var A=h.options;for(var J=u(Object.keys(A.ma)),F=J.next();!F.done;F=J.next()){F=F.value;var Q=A.ma[F],V=void 0===Q.mb?Number.MAX_VALUE:Q.mb;if(k.h.version>=Q.ea&&!(k.h.version>=V)&&!k.h.objectStoreNames.contains(F)){A=F;break a}}A=void 0}l=A;if(void 0===l){p.B(5);break}if(h.j){p.B(6);break}h.j=!0;return w(p,
h.delete(),7);case 7:return wi(new R("DB_DELETED_BY_MISSING_OBJECT_STORE",{dbName:h.name,gb:l})),p.return(a());case 6:throw new Ii(l);case 5:return p.return(k);case 2:n=sa(p);if(n instanceof DOMException?"VersionError"!==n.name:"DOMError"in self&&n instanceof DOMError?"VersionError"!==n.name:!(n instanceof Object&&"message"in n)||"An attempt was made to open a database using a lower version than the existing version."!==n.message){p.B(8);break}return w(p,h.i(h.name,void 0,Object.assign(Object.assign({},
...
function Oj(a){var b=Sf("nwl_latency_sampling_rate",.01);.02<b||Math.random()<=b&&ki("nwl_transaction_latency_payload",a)}
...
;var ck=Sf("network_polling_interval",3E4);function U(){Me.call(this);this.J=0;this.A=this.l=!1;this.G=0;this.K=!1;this.j=this.wa();dk(this);ek(this)}
...
m.hb=function(a){this.l=!0;if(void 0===a?0:a)this.J||gk(this)};
m.wa=function(){var a=window.navigator.onLine;return void 0===a?!0:a};
m.Sa=function(){this.K=!0};
m.ca=function(a,b){return Me.prototype.ca.call(this,a,b)};
function ek(a){window.addEventListener("online",function(){return H(a,function c(){var d=this;return x(c,function(e){if(1==e.h)return w(e,d.Y(),2);hk(d);if(d.K&&O("offline_error_handling")){var f=ak().get("errors",!0);if(f){for(var g in f)if(f[g]){var h=new yi(g,"sent via offline_errors");h.name=f[g].name;h.stack=f[g].stack;h.level=f[g].level;Nf(h)}ak().set("errors",{},2592E3,!0)}}e.h=0})})})}
function dk(a){window.addEventListener("offline",function(){return H(a,function c(){var d=this;return x(c,function(e){if(1==e.h)return w(e,d.Y(),2);hk(d);e.h=0})})})}
function gk(a){a.J=hg(function(){return H(a,function c(){var d=this;return x(c,function(e){if(1==e.h){if(!d.j)return w(e,d.Y(),3);if(d.wa())return e.B(3);d.A=!0;d.G=P();return d.l?w(e,d.Y(),3):e.B(3)}gk(d);e.h=0})})},ck)}
function hk(a){a.A&&(Of(new yi("NetworkStatusManager state did not match poll",P()-a.G)),a.A=!1)}
m.Y=function(a){var b=this;return this.m?this.m:this.m=new Promise(function(c){return H(b,function e(){var f,g,h,k=this;return x(e,function(l){switch(l.h){case 1:return f=window.AbortController?new window.AbortController:void 0,g=null===f||void 0===f?void 0:f.signal,h=!1,ra(l,2,3),f&&(k.C=jg(function(){f.abort()},a||2E4)),w(l,fetch("/generate_204",{method:"HEAD",
signal:g}),5);case 5:h=!0;case 3:ta(l);k.m=void 0;k.C&&lg(k.C);h!==k.j&&(k.j=h,k.j&&k.l?Ne(k,"ytnetworkstatus-online"):k.l&&Ne(k,"ytnetworkstatus-offline"));c(h);ua(l);break;case 2:sa(l),h=!1,l.B(3)}})})})};
U.prototype.sendNetworkCheckRequest=U.prototype.Y;U.prototype.listen=U.prototype.ca;U.prototype.enableErrorFlushing=U.prototype.Sa;U.prototype.getWindowStatus=U.prototype.wa;U.prototype.monitorNetworkStatusChange=U.prototype.hb;U.prototype.isNetworkAvailable=U.prototype.N;U.getInstance=fk;function ik(a){a=void 0===a?{}:a;Me.call(this);var b=this;this.l=this.A=0;this.j=fk();var c=B("yt.networkStatusManager.instance.monitorNetworkStatusChange").bind(this.j);c&&c(a.Ta);a.fb&&(c=B("yt.networkStatusManager.instance.enableErrorFlushing").bind(this.j))&&c();if(c=B("yt.networkStatusManager.instance.listen").bind(this.j))a.oa?(this.oa=a.oa,c("ytnetworkstatus-online",function(){jk(b,"publicytnetworkstatus-online")}),c("ytnetworkstatus-offline",function(){jk(b,"publicytnetworkstatus-offline")})):
...
v(ik,Me);ik.prototype.N=function(){var a=B("yt.networkStatusManager.instance.isNetworkAvailable").bind(this.j);return a?a():!0};
...
;var kk=!1,lk=!1,mk=0,nk=0,ok,pk=y.ytNetworklessLoggingInitializationOptions||{isNwlInitialized:kk,isIdbSupported:lk,potentialEsfErrorCounter:nk};O("export_networkless_options")&&z("ytNetworklessLoggingInitializationOptions",pk,void 0);
function qk(){H(this,function b(){return x(b,function(c){switch(c.h){case 1:return w(c,xj(),2);case 2:if(!c.i){c.B(0);break}lk=!0;return w(c,Gj("LogsDatabaseV2"),4);case 4:if(!(O("enable_nwl_cleaning_logic")&&Math.random()<=Sf("nwl_cleaning_rate",.1))){c.B(5);break}return w(c,Tj(),6);case 6:return w(c,Xj(),5);case 5:kk=!0;rk();sk().N()&&tk();sk().ca("publicytnetworkstatus-online",tk);sk().ca("publicytnetworkstatus-offline",uk);if(!O("networkless_immediately_drop_sw_health_store")){c.B(8);break}return w(c,
vk(),8);case 8:if(!O("networkless_immediately_drop_all_requests")){c.B(10);break}return w(c,Uj(),10);case 10:O("export_networkless_options")&&(pk.isNwlInitialized=kk,pk.isIdbSupported=lk),c.h=0}})})}
function wk(a,b){function c(d){var e=sk().N();if(!xk()||!d||e&&O("vss_networkless_bypass_write"))yk(a,b);else{var f={url:a,options:b,timestamp:P(),status:"NEW",sendCount:0};Nj(f).then(function(g){f.id=g;(sk().N()||O("networkless_always_online"))&&zk(f)}).catch(function(g){zk(f);
sk().N()?Nf(g):bk(g)})}}
b=void 0===b?{}:b;O("skip_is_supported_killswitch")?xj().then(function(d){c(d)}):c(Ak())}
...
yk(e.url,e.options);Nj(e).then(function(h){e.id=h;f&&Sj(e.id)}).catch(function(h){sk().N()?Nf(h):bk(h)})}else yk(a,b)}
b=void 0===b?{}:b;O("skip_is_supported_killswitch")?xj().then(function(d){c(d)}):c(Ak())}
function tk(){var a=this;mk||(mk=jg(function(){return H(a,function c(){var d;return x(c,function(e){if(1==e.h)return w(e,Pj("NEW"),2);if(3!=e.h)return d=e.i,d?w(e,zk(d),3):(uk(),e.return());mk&&(mk=0,tk());e.h=0})})},100))}
function uk(){lg(mk);mk=0}
function zk(a){return H(this,function c(){var d;return x(c,function(e){switch(e.h){case 1:if(void 0===a.id){e.B(2);break}return w(e,Qj(a.id),3);case 3:(d=e.i)?a=d:Of(Error("The request cannot be found in the database."));case 2:if(Ck(a,2592E6)){e.B(4);break}Of(Error("Networkless Logging: Stored logs request expired age limit"));if(void 0===a.id){e.B(5);break}return w(e,Sj(a.id),5);case 5:return e.return();case 4:var f=a=Dk(a),g,h;if(null===(h=null===(g=null===f||void 0===f?void 0:f.options)||void 0===
g?void 0:g.postParams)||void 0===h?0:h.requestTimeMs)f.options.postParams.requestTimeMs=Math.round(P());(a=f)&&yk(a.url,a.options);e.h=0}})})}
function Dk(a){var b=this,c=a.options.onError?a.options.onError:function(){};
a.options.onError=function(e,f){return H(b,function h(){return x(h,function(k){switch(k.h){case 1:if(!((B("ytNetworklessLoggingInitializationOptions")?pk.potentialEsfErrorCounter:nk)<=Sf("potential_esf_error_limit",10))){k.B(2);break}return w(k,sk().Y(),3);case 3:if(sk().N())B("ytNetworklessLoggingInitializationOptions")&&pk.potentialEsfErrorCounter++,nk++;else return c(e,f),k.return();case 2:if(void 0===(null===a||void 0===a?void 0:a.id)){k.B(4);break}return 1>a.sendCount?w(k,Rj(a.id),8):w(k,Sj(a.id),
4);case 8:jg(function(){sk().N()&&tk()},5E3);
case 4:c(e,f),k.h=0}})})};
...
function rk(){var a=this;Pj("QUEUED").then(function(b){b&&!Ck(b,12E4)?jg(function(){return H(a,function d(){return x(d,function(e){if(1==e.h)return void 0===b.id?e.B(2):w(e,Rj(b.id),2);rk();e.h=0})})}):sk().N()&&tk()})}
function vk(){return H(this,function b(){return x(b,function(c){return c.return(Yj().catch(function(d){Nf(d)}))})})}
...
function Ak(){return B("ytNetworklessLoggingInitializationOptions")?pk.isIdbSupported:lk}
...
c.onFetchSuccess=function(F,Q){ci(p);J(F,Q)}}try{r&&d.retry&&!d.La.bypassNetworkless?(g.method="POST",!d.La.writeThenSend&&O("nwl_send_fast_on_unload")?Bk(q,g):wk(q,g)):(g.method="POST",g.postParams||(g.postParams={}),Og(q,g))}catch(F){if("InvalidAccessError"==F.name)p&&(ci(p),p=0),Of(Error("An extension is blocking network request."));
...
Lk();c=u(a.T);for(d=c.next();!d.done;d=c.next())if(d=d.value,l.message&&l.message.match(d.kl)){a=d.weight;break a}a=u(a.P);for(c=a.next();!c.done;c=a.next())if(c=c.value,c.Ea(l)){a=c.weight;break a}a=1}l.sampleWeight=a;a=u(Gk);for(c=a.next();!c.done;c=a.next())if(c=c.value,c.na[l.name])for(e=u(c.na[l.name]),d=e.next();!d.done;d=e.next())if(f=d.value,d=l.message.match(f.regexp)){l.params["params.error.original"]=d[0];e=f.groups;f={};for(g=0;g<e.length;g++)f[e[g]]=d[g+1],l.params["params.error."+e[g]]=
...
Gk:22678,Hk:69076,Jk:100856,Kk:17736,Lk:3832,Mk:55759,Nk:64031,Ok:93044,Pk:93045,Qk:34388,Rk:17657,Sk:17655,Tk:39579,Uk:39578,Vk:77448,Wk:8196,Xk:11357,Yk:69877,Zk:8197,al:82039};function bl(){var a=kb(cl),b;return cf(new We(function(c,d){a.onSuccess=function(e){Ig(e)?c(new dl(e)):d(new el("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
...
return a.join("")}
;var tl,ul=y.ytLoggingDocDocumentNonce_;ul||(ul=sl(),Qa("ytLoggingDocDocumentNonce_",ul));tl=ul;var vl={ne:0,jc:1,sc:2,th:3,pe:4,Ik:5,hi:6,kj:7,0:"DEFAULT",1:"CHAT",2:"CONVERSATIONS",3:"MINIPLAYER",4:"DIALOG",5:"VOZ",6:"MUSIC_WATCH_TABS",7:"SHARE"};function wl(a){this.h=a}
...
'script[name="mobile_blazer_watch_mod"]':"mbwj"};Oa(W.clearResourceTimings||W.webkitClearResourceTimings||W.mozClearResourceTimings||W.msClearResourceTimings||W.oClearResourceTimings||Ea,W);function bm(a){var b=cm(a);if(b.aft)return b.aft;a=E((a||"")+"TIMING_AFT_KEYS",["ol"]);for(var c=a.length,d=0;d<c;d++){var e=b[a[d]];if(e)return e}return NaN}
...
function gm(a){var b;(b=B("ytcsi."+(a||"")+"data_"))||(b={tick:{},info:{}},Qa("ytcsi."+(a||"")+"data_",b));return b}
...
um={},vm=(um.ccs="CANARY_STATE_",um.mver="MEASUREMENT_VERSION_",um.pis="PLAYER_INITIALIZED_STATE_",um.yt_pt="LATENCY_PLAYER_",um.pa="LATENCY_ACTION_",um.yt_vst="VIDEO_STREAM_TYPE_",um),wm="all_vc ap aq c cver cbrand cmodel cplatform ctheme ei l_an l_mm plid srt yt_fss yt_li vpst vpni2 vpil2 icrc icrt pa GetAccountOverview_rid GetHistory_rid cmt d_vpct d_vpnfi d_vpni nsru pc pfa pfeh pftr pnc prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis ytu_pvis yt_ref yt_sts tds".split(" ");
...
function Jm(){var a=window.location.protocol,b=W.getEntriesByType("resource");b=Xa(b,function(c){return 0===c.name.indexOf(a+"//fonts.gstatic.com/s/")});
...
function Mm(a,b,c){c=void 0===c?0:c;b.then(function(d){var e,f;a.i.has(c)&&a.j&&a.j();var g=Dl(c),h=Bl(c);g&&h&&(d.csn=g,(null===(e=d.response)||void 0===e?0:e.trackingParams)&&Ml(a.client,g,h,[xl(d.response.trackingParams)]),(null===(f=d.playerResponse)||void 0===f?0:f.trackingParams)&&Ml(a.client,g,h,[xl(d.playerResponse.trackingParams)]))})}
...
function Pm(a,b,c){c=void 0===c?{}:c;c.layer||(c.layer=0);var d=void 0!==c.jb?c.jb:c.layer;var e=Dl(d);d=Bl(d);var f;d&&(void 0!==c.parentCsn?f={clientScreenNonce:c.parentCsn,visualElement:d}:e&&"UNDEFINED_CSN"!==e&&(f={clientScreenNonce:e,visualElement:d}));var g,h=E("EVENT_ID");"UNDEFINED_CSN"===e&&h&&(g={servletData:{serializedServletEventId:h}});try{var k=a.client;h=f;var l=c.Ga,n=c.F,q=Kl(),r={csn:q,pageVe:(new wl({veType:b,youtubeData:g})).getAsJson()};h&&h.visualElement?r.implicitGesture={parentCsn:h.clientScreenNonce,
gesturedVe:h.visualElement.getAsJson()}:h&&Yk(new yi("newScreen() parent element does not have a VE - rootVe",b));l&&(r.cloneCsn=l);l={F:n,U:q};k?Lh("screenCreated",r,k,l):Fk("screenCreated",r,l);ki(ni,new Hl(q));var p=q}catch(A){$k(A,{nl:b,rootVe:d,parentVisualElement:void 0,il:e,ml:f,Ga:c.Ga});Zk(A);return}Gl(p,b,c.layer,c.F);if((b=e&&"UNDEFINED_CSN"!==e&&d)&&!(b=O("screen_manager_skip_hide_killswitch"))){a:{b=u(Object.values(vl));for(f=b.next();!f.done;f=b.next())if(Dl(f.value)==e){b=!0;break a}b=
!1}b=!b}b&&(b=a.client,f=!0,k=(f=void 0===f?!1:f)?16:8,d={csn:e,ve:d.getAsJson(),eventType:k},f={F:Fl(e),U:e,Va:f},"UNDEFINED_CSN"==e?Nl("visualElementHidden",d,f):b?Lh("visualElementHidden",d,b,f):Fk("visualElementHidden",d,f));a.h[a.h.length-1]&&!a.h[a.h.length-1].csn&&(a.h[a.h.length-1].csn=p||"");Cm("csn",p);Ol.getInstance().clear();d=Bl(c.layer);e&&"UNDEFINED_CSN"!==e&&d&&(O("web_mark_root_visible")||O("music_web_mark_root_visible"))&&(e=p,p=O("use_default_events_client")?void 0:Ek,b={csn:e,
ve:d.getAsJson(),eventType:1},f={F:Fl(e),U:e},"UNDEFINED_CSN"==e?Nl("visualElementShown",b,f):p?Lh("visualElementShown",b,p,f):Fk("visualElementShown",b,f));a.i.delete(c.layer||0);a.j=void 0;e=u(a.m);for(p=e.next();!p.done;p=e.next())p=u(p.value),b=p.next().value,p.next().value.has(c.layer)&&d&&Nm(a,b,d,c.layer)}
...
function Xm(a,b,c){c=void 0===c?null:c;var d=Ym(a),e=document.getElementById(d),f=e&&Sm(e,"loaded"),g=e&&!f;f?b&&b():(b&&(f=hh(d,b),b=""+Ja(b),Zm[b]=f),g||(e=$m(a,d,function(){Sm(e,"loaded")||(Qm(e),kh(d),dg(Pa(lh,d),0))},c)))}
...
try{Wm("//static.doubleclick.net/instream/ad_status.js",a)}catch(b){}cn.push(jg(function(){if(!(dn||"google_ad_status"in window)){try{bn("//static.doubleclick.net/instream/ad_status.js",a)}catch(b){}dn=!0;N("DCLKSTAT",3)}},5E3))}}
...
un.prototype.D=function(){window.removeEventListener("message",this.A);L.prototype.D.call(this)};function vn(){this.i=[];this.isReady=!1;this.j={};var a=this.h=new un(!!E("WIDGET_ID_ENFORCE")),b=this.lb.bind(this);a.m=b;a.u=null;this.h.channel="widget";if(a=E("WIDGET_ID"))this.h.sessionId=a}
m=vn.prototype;m.lb=function(a,b,c){"addEventListener"===a&&b?(a=b[0],this.j[a]||"onReady"===a||(this.addEventListener(a,wn(this,a)),this.j[a]=!0)):this.Ca(a,b,c)};
m.Ca=function(){};
...
;function Bn(a){vn.call(this);this.listeners=[];this.api=a;this.addEventListener("onReady",this.onReady.bind(this));this.addEventListener("onVideoProgress",this.sb.bind(this));this.addEventListener("onVolumeChange",this.tb.bind(this));this.addEventListener("onApiChange",this.nb.bind(this));this.addEventListener("onPlaybackQualityChange",this.pb.bind(this));this.addEventListener("onPlaybackRateChange",this.qb.bind(this));this.addEventListener("onStateChange",this.rb.bind(this));this.addEventListener("onWebglSettingsChanged",
this.ub.bind(this))}
...
m.pb=function(a){xn(this,{playbackQuality:a})};
m.qb=function(a){xn(this,{playbackRate:a})};
...
m.tb=function(){xn(this,{muted:this.api.isMuted(),volume:this.api.getVolume()})};
...
m.ub=function(){var a={sphericalProperties:this.api.getSphericalProperties()};xn(this,a)};
m.dispose=function(){vn.prototype.dispose.call(this);for(var a=0;a<this.listeners.length;a++){var b=this.listeners[a];this.api.removeEventListener(b.eventType,b.listener)}this.listeners=[]};function Cn(a){L.call(this);this.i={};this.started=!1;this.connection=a;this.connection.subscribe("command",this.Ma,this)}
...
m.D=function(){var a=this.connection;a.h||of(a.i,"command",this.Ma,this);this.connection=null;for(var b in this.i)this.i.hasOwnProperty(b)&&this.removeListener(b);L.prototype.D.call(this)};function Fn(a,b){Cn.call(this,b);this.api=a;this.start()}
...
Fn.prototype.D=function(){Cn.prototype.D.call(this);delete this.api};function Gn(a){a=void 0===a?!1:a;L.call(this);this.i=new M(a);Xd(this,Pa(Vd,this.i))}
...
Hn.prototype.D=function(){this.destination=this.j=null;Gn.prototype.D.call(this)};function In(a,b,c){L.call(this);this.destination=a;this.origin=c;this.i=ag(window,"message",this.j.bind(this));this.connection=new Hn(this,a,b);Xd(this,Pa(Vd,this.connection))}
...
function Nn(a){var b=On(a),c=document.getElementById(b),d=c&&Sm(c,"loaded");d||c&&!d||(c=Pn(a,b,function(){Sm(c,"loaded")||(Qm(c),kh(b),dg(Pa(lh,b),0))}))}
...
;function Qn(a,b,c,d){L.call(this);var e=this;this.G=b;this.webPlayerContextConfig=d;this.qa=!1;this.api={};this.ba=this.m=null;this.J=new M;this.i={};this.M=this.ga=this.elementId=this.ra=this.config=null;this.K=!1;this.l=this.A=null;this.ha={};this.Oa=["onReady"];this.lastError=null;this.Da=NaN;this.C={};this.Pa=new Jn(this);this.aa=0;this.j=this.u=a;Xd(this,Pa(Vd,this.J));Rn(this);Sn(this);Xd(this,Pa(Vd,this.Pa));c?this.aa=dg(function(){e.loadNewVideoConfig(c)},0):d&&(Tn(this),Un(this))}
...
function Un(a){if(!a.h&&!a.K){var b=Yn(a);if(b&&"html5"===(Zn(a)?"html5":null))a.M="html5",a.isReady()||ao(a);else if(bo(a),a.M="html5",b&&a.l&&a.u)a.u.appendChild(a.l),ao(a);else{a.config&&(a.config.loaded=!0);var c=!1;a.A=function(){c=!0;var d=co(a,"player_bootstrap_method")?B("yt.player.Application.createAlternate")||B("yt.player.Application.create"):B("yt.player.Application.create");var e=a.config?Wn(a.config):void 0;d&&d(a.u,e,a.webPlayerContextConfig);ao(a)};
a.K=!0;b?a.A():(Wm($n(a),a.A),(b=eo(a))&&Mn(b),fo(a)&&!c&&z("yt.player.Application.create",null,void 0))}}}
function Zn(a){var b=Sc(a.elementId);!b&&a.j&&a.j.querySelector&&(b=a.j.querySelector("#"+a.elementId));return b}
function ao(a){var b;if(!a.h){var c=Zn(a),d=!1;c&&c.getApiInterface&&c.getApiInterface()&&(d=!0);d?(a.K=!1,!co(a,"html5_remove_not_servable_check_killswitch")&&(null===c||void 0===c?0:c.isNotServable)&&a.config&&(null===c||void 0===c?0:c.isNotServable(null===(b=a.config.args)||void 0===b?void 0:b.video_id))||go(a)):a.Da=dg(function(){ao(a)},50)}}
function go(a){Rn(a);a.qa=!0;var b=Zn(a);if(b){a.m=ho(a,b,"addEventListener");a.ba=ho(a,b,"removeEventListener");var c=b.getApiInterface();c=c.concat(b.getInternalApiInterface());for(var d=a.api,e=0;e<c.length;e++){var f=c[e];d[f]||(d[f]=ho(a,b,f))}}for(var g in a.i)a.i.hasOwnProperty(g)&&a.m&&a.m(g,a.i[g]);Vn(a);a.ga&&a.ga(a.api);a.J.W("onReady",a.api)}
...
m.addEventListener=function(a,b){var c=this,d=Xn(this,b);d&&(0<=Wa(this.Oa,a)||this.i[a]||(b=io(this,a),this.m&&this.m(a,b)),this.J.subscribe(a,d),"onReady"===a&&this.isReady()&&dg(function(){d(c.api)},0))};
m.removeEventListener=function(a,b){this.h||(b=Xn(this,b))&&of(this.J,a,b)};
function Xn(a,b){var c=b;if("string"===typeof b){if(a.ha[b])return a.ha[b];c=function(d){for(var e=[],f=0;f<arguments.length;++f)e[f-0]=arguments[f];if(f=B(b))try{f.apply(y,e)}catch(g){Zk(g)}};
...
hb(a.C,String(e))};
return c}
m.getPlayerType=function(){return this.M||(Zn(this)?"html5":null)};
m.getLastError=function(){return this.lastError};
function bo(a){a.cancel();Rn(a);a.M=null;a.config&&(a.config.loaded=!1);var b=Zn(a);b&&(Yn(a)||!fo(a)?a.l=b:(b&&b.destroy&&b.destroy(),a.l=null));if(a.u)for(a=a.u;b=a.firstChild;)a.removeChild(b)}
m.cancel=function(){this.A&&bn($n(this),this.A);eg(this.Da);this.K=!1};
m.D=function(){bo(this);if(this.l&&this.config&&this.l.destroy)try{this.l.destroy()}catch(b){Zk(b)}this.ha=null;for(var a in this.i)this.i.hasOwnProperty(a)&&(y[this.i[a]]=null);this.ra=this.config=this.api=null;delete this.u;delete this.j;L.prototype.D.call(this)};
...
E("PL_ATT")&&ln.dispose();for(var a=0,b=cn.length;a<b;a++)lg(cn[a]);cn.length=0;an("//static.doubleclick.net/instream/ad_status.js");dn=!1;N("DCLKSTAT",0);Wd(po,oo);no&&(no.removeEventListener("onVideoDataChange",qo),no.destroy())});
window.addEventListener?(window.addEventListener("load",to),window.addEventListener("unload",uo)):window.attachEvent&&(window.attachEvent("onload",to),window.attachEvent("onunload",uo));Qa("yt.abuse.player.botguardInitialized",B("yt.abuse.player.botguardInitialized")||mn);Qa("yt.abuse.player.invokeBotguard",B("yt.abuse.player.invokeBotguard")||nn);Qa("yt.abuse.dclkstatus.checkDclkStatus",B("yt.abuse.dclkstatus.checkDclkStatus")||fn);
Qa("yt.player.exports.navigate",B("yt.player.exports.navigate")||so);Qa("yt.util.activity.init",B("yt.util.activity.init")||ng);Qa("yt.util.activity.getTimeSinceActive",B("yt.util.activity.getTimeSinceActive")||qg);Qa("yt.util.activity.setTimestamp",B("yt.util.activity.setTimestamp")||og);}).call(this);
