(function(global, factory) {
    typeof exports === "object" && typeof module !== "undefined" ? module.exports = factory(require("jquery")) : typeof define === "function" && define.amd ? define([ "jquery" ], factory) : global.UIkit = factory(global.jQuery);
})(this, function($) {
    "use strict";
    ...
    var hasTouch = "ontouchstart" in window || window.DocumentTouch && document instanceof DocumentTouch || navigator.msPointerEnabled && navigator.msMaxTouchPoints > 0 || navigator.pointerEnabled && navigator.maxTouchPoints > 0;
    ...
    var transitionend = function() {
        var element = document.body || document.documentElement, names = {
    ...
    function FastDom() {
        ...
        self.reads = [];
        self.writes = [];
        self.raf = requestAnimationFrame$1.bind(window);
    }
    FastDom.prototype = {
        constructor: FastDom,
    ...
    function flush(fastdom) {
        var reads = fastdom.reads.splice(0, fastdom.reads.length), writes = fastdom.writes.splice(0, fastdom.writes.length), error;
        try {
            runTasks(reads);
            runTasks(writes);
        } catch (e) {
    ...
    strats.defaults = strats.methods = function(parentVal, childVal) {
        return childVal ? parentVal ? $.extend(true, {}, parentVal, childVal) : childVal : parentVal;
    };
    ...
    function position(element, target, attach, targetAttach, offset, targetOffset, flip, boundary) {
        ...
        if (flip) {
            $__default.each(dirs, function(dir, ref) {
                ...
                var elemOffset = attach[dir] === align ? -dim[prop] : attach[dir] === alignFlip ? dim[prop] : 0, targetOffset = targetAttach[dir] === align ? targetDim[prop] : targetAttach[dir] === alignFlip ? -targetDim[prop] : 0;
    ...
    function getDimensions(elem) {
        elem = $__default(elem);
        var width = Math.round(elem.outerWidth()), height = Math.round(elem.outerHeight()), offset = elem[0] && elem[0].getClientRects ? elem.offset() : null, left = offset ? Math.round(offset.left) : elem.scrollLeft(), top = offset ? Math.round(offset.top) : elem.scrollTop();
        return {
            width: width,
            height: height,
            left: left,
    ...
    function internalAPI(UIkit) {
        ...
        UIkit.prototype._initData = function() {
            var this$1 = this;
            var defaults = $.extend(true, {}, this.$options.defaults), data = this.$options.data || {}, args = this.$options.args || [], props = this.$options.props || {};
            if (!defaults) {
                return;
            }
        ...
        UIkit.prototype._initProps = function() {
            var this$1 = this;
            var el = this.$el[0], args = this.$options.args || [], props = this.$options.props || {}, options = el.getAttribute(this.$name) || el.getAttribute("data-" + this.$name), key, prop;
            if (!props) {
                return;
            }
            for (key in props) {
        ...
        UIkit.prototype._initEvents = function(unbind) {
            var this$1 = this;
            var events = this.$options.events, connect = function(event, key) {
    ...
    function instanceAPI(UIkit) {
        ...
        UIkit.prototype.$emitSync = function(e) {
            this._callUpdate(createEvent(e || "update", true, false, {
                sync: true
            }));
        };
        ...
        UIkit.prototype.$updateSync = function(e, parents) {
            UIkit.update(createEvent(e || "update", true, false, {
                sync: true
            }), this.$el, parents);
        };
        ...
        UIkit.component = function(id, options) {
            ...
            UIkit[name] = function(element, data) {
                ...
                $__default(element).each(function(i, el) {
                    return result.push(el[DATA] && el[DATA][name] || new UIkit.components[name]({
                        el: el,
                        data: data
                    }));
                });
    ...
    var Toggable = {
        ...
        methods: {
            toggleElement: function toggleElement(targets, show, animate) {
                var this$1 = this;
                var toggles, body = document.body, scroll = body.scrollTop, all = function(targets) {
            ...
            _toggleElement: function _toggleElement(el, show, animate) {
                ...
                var promise = (this.animation === true && animate !== false ? this._toggleHeight : this.animation && animate !== false ? this._toggleAnimation : this._toggleImmediate)(el, show);
            ...
            _toggleHeight: function _toggleHeight(el, show) {
                var this$1 = this;
                var inProgress = Transition.inProgress(el), inner = parseFloat(el.children().first().css("margin-top")) + parseFloat(el.children().last().css("margin-bottom")), height = el[0].offsetHeight ? el.height() + (inProgress ? 0 : inner) : 0, endHeight;
                return Transition.cancel(el).then(function() {
                    ...
                    el.height(height);
                    return show ? Transition.start(el, $.extend(this$1.initProps, {
                        overflow: "hidden",
                        height: endHeight
                    }), Math.round(this$1.duration * (1 - height / endHeight)), this$1.transition) : Transition.start(el, this$1.hideProps, Math.round(this$1.duration * (height / endHeight)), this$1.transition).then(function() {
    ...
    var Mouse = {
        ...
        methods: {
            ...
            movesTo: function movesTo(target) {
                var p = getDimensions(target), points = [ [ {
                    x: p.left,
                    y: p.top
                }, {
                    x: p.right,
                    ...
                    x: p.left,
                    y: p.bottom
                } ] ], position = this.positions[this.positions.length - 1], prevPos = this.positions[0] || position;
                if (!position) {
                    return false;
                }
    ...
    var Position = {
        ...
        methods: {
            positionAt: function positionAt(element, target, boundary) {
                removeClass(element, this.clsPos + "-(top|bottom|left|right)(-[a-z]+)?").css({
                    top: "",
                    left: ""
                });
                this.dir = this.pos[0];
                this.align = this.pos[1];
                var offset = toNumber(this.offset) || 0, axis = this.getAxis(), flipped = position(element, target, axis === "x" ? flipPosition(this.dir) + " " + this.align : this.align + " " + flipPosition(this.dir), axis === "x" ? this.dir + " " + this.align : this.align + " " + this.dir, axis === "x" ? "" + (this.dir === "left" ? -1 * offset : offset) : " " + (this.dir === "top" ? -1 * offset : offset), null, this.flip, boundary);
    ...
    function Accordion(UIkit) {
        UIkit.component("accordion", {
            ...
            update: function update() {
                var this$1 = this;
                var items = $__default(this.targets, this.$el), changed = !this.items || items.length !== this.items.length || items.toArray().some(function(el, i) {
            ...
            methods: {
                show: function show(item, animate) {
                    ...
                    var index = getIndex(item, this.items), active = this.items.filter("." + this.clsOpen);
    ...
    function Drop(UIkit) {
        ...
        UIkit.component("drop", {
            ...
            ready: function ready() {
                ...
                if (this.toggle) {
                    this.toggle = UIkit.toggle(query(this.toggle, this.$el), {
                        target: this.$el,
                        mode: this.mode
                    })[0];
                }
            ...
            events: [ {
                ...
                handler: function handler(e) {
                    ...
                    if (active && active !== this && active.toggle && active.toggle.mode === "hover" && !isWithin(e.target, active.$el) && !isWithin(e.target, active.toggle.$el)) {
                        active.hide(false);
                    }
                    e.preventDefault();
            ...
            update: {
                write: function write() {
                    ...
                    removeClass(this.$el, this.clsDrop + "-(stack|boundary)").css({
                        top: "",
                        left: ""
                    });
    ...
    function Icon(UIkit) {
        ...
        [ "close", "navbar-toggle-icon", "overlay-icon", "pagination-previous", "pagination-next", "search-icon", "totop" ].forEach(function(name) {
            return UIkit.component(name, UIkit.components.icon.extend({
                name: name
            }));
        });
                ...
                write: function write() {
                    ...
                    this.rows.forEach(function(row, i) {
                        return row.forEach(function(el, j) {
                            return $__default(el).toggleClass(this$1.margin, i !== 0).toggleClass(this$1.firstColumn, j === 0);
                        });
                    });
                },
                events: [ "load", "resize", "orientationchange" ]
            ...
            methods: {
                transitionTo: function transitionTo(height) {
                    ...
                    return Transition.cancel(this.$el).then(function() {
                        return Transition.start(this$1.$el, {
                            height: height
                        }, this$1.duration);
                    });
                }
        ...
        UIkit.component("scroll", {
            ...
            methods: {
                scrollToElement: function scrollToElement(el) {
                    ...
                    $__default("html,body").stop().animate({
                        scrollTop: parseInt(target, 10) || 1
            ...
            update: [ {
                ...
                read: function read() {
                    ...
                    this.elements.each(function(_, el) {
                        if (!el._scrollspy) {
                            el._scrollspy = {
                                toggles: ($__default(el).attr("uk-scrollspy-class") || this$1.cls).split(",")
                            };
                        }
                        ...
                        if (data.show) {
                            if (!data.inview && !data.timer) {
                                data.timer = setTimeout(function() {
                                    $el.css("visibility", "").addClass(this$1.inViewClass).toggleClass(data.toggles[0]).trigger("inview");
                                    data.inview = true;
                                    delete data.timer;
                                }, this$1.delay * index++);
                            }
                            ...
                            if (data.inview && this$1.repeat) {
                                ...
                                $el.removeClass(this$1.inViewClass).toggleClass(data.toggles[0]).css("visibility", this$1.hidden ? "hidden" : "").trigger("outview");
                                data.inview = false;
                            }
                        }
        ...
        UIkit.component("spinner", UIkit.components.icon.extend({
            ...
            connected: function connected() {
                ...
                this.svg.then(function(svg) {
                    var circle = svg.find("circle"), diameter = Math.floor(this$1.width / 2);
        ...
        UIkit.component("sticky", {
            ...
            ready: function ready() {
                ...
                if (this.target && location.hash && win.scrollTop() > 0) {
                    ...
                    if (target) {
                        requestAnimationFrame$1(function() {
                            var top = target.offset().top, elTop = this$1.$el.offset().top, elHeight = this$1.$el.outerHeight(), elBottom = elTop + elHeight;
            ...
            methods: {
                show: function show() {
                    this.update();
                    this.$el.removeClass(this.clsInactive).addClass(this.clsActive).trigger("active");
    ...
    function Svg(UIkit) {
        UIkit.component("svg", {
            ...
            update: {
                ...
                write: function write() {
                    ...
                    var dimensions = el.getAttribute("viewBox");
                    if (dimensions) {
        ...
        function getSrc(el) {
            ...
            if (!image) {
                el = el.clone().empty().attr({
                    "uk-no-boot": "",
                    style: el.attr("style") + ";display:block !important;"
        ...
        UIkit.component("switcher", {
            ...
            methods: {
                show: function show(item) {
                    ...
                    var length = this.toggles.length, prev = this.connects.children("." + this.cls).index(), hasPrev = prev >= 0, index = getIndex(item, this.toggles, prev), dir = item === "previous" ? -1 : 1, toggle;
    ...
    function core(UIkit) {
        ...
        UIkit.use(Toggle);
        function toMs(time) {
            return !time ? 0 : time.substr(-2) === "ms" ? parseFloat(time) : parseFloat(time) * 1e3;
        }
    }
    function boot(UIkit) {
        if (Observer) {
...
(function(global, factory) {
    typeof exports === "object" && typeof module !== "undefined" ? module.exports = factory() : typeof define === "function" && define.amd ? define(factory) : global.UIkitLightbox = factory();
})(this, function() {
    "use strict";
            ...
            update: {
                write: function write() {
                    ...
                    Transition.start(panel, newDim, this.duration).then(function() {
                        Transition.start(this$1.modal.content, {
                            opacity: 1
                        }, 400).then(function() {
            ...
            events: {
                showitem: function showitem(e) {
                    ...
                    var vid = $('<video class="uk-responsive-width" controls></video>').on("loadedmetadata", function() {
                        return this$1.setItem(item, vid.attr({
                            width: vid[0].videoWidth,
                            height: vid[0].videoHeight
                        }), vid[0].videoWidth, vid[0].videoHeight);
        ...
        UIkit.mixin({
            events: {
                showitem: function showitem(e) {
                    ...
                    var id = matches[1], img = new Image(), lowres = false, setIframe = function(width, height) {
        ...
        UIkit.mixin({
            events: {
                showitem: function showitem(e) {
                    ...
                    var id = matches[2], setIframe = function(width, height) {
...
(function(global, factory) {
    typeof exports === "object" && typeof module !== "undefined" ? module.exports = factory() : typeof define === "function" && define.amd ? define(factory) : global.UIkitNotification = factory();
})(this, function() {
    "use strict";
    function plugin(UIkit) {
        if (plugin.installed) {
            ...
            ready: function ready() {
                ...
                Transition.start(this.$el.css({
                    ...
                    if (this$1.timeout) {
                        ...
                        this$1.$el.on(pointerEnter, function() {
...
(function(global, factory) {
    typeof exports === "object" && typeof module !== "undefined" ? module.exports = factory() : typeof define === "function" && define.amd ? define(factory) : global.UIkitSortable = factory();
})(this, function() {
    "use strict";
    function plugin(UIkit) {
        if (plugin.installed) {
        ...
        UIkit.component("sortable", {
            ...
            methods: {
                ...
                move: function move(e) {
                    ...
                    this.$emit();
                    var target = e.type === "mousemove" ? e.target : document.elementFromPoint(this.pos.x - document.body.scrollLeft, this.pos.y - document.body.scrollTop), sortable = getSortable(target), previous = getSortable(this.placeholder[0]), move = sortable !== previous;
                ...
                animate: function animate(action) {
                    var this$1 = this;
                    var props = [], children = this.$el.children().toArray().map(function(el) {
                        el = $(el);
                        props.push(extend({
                            position: "absolute",
                            pointerEvents: "none",
...
(function(global, factory) {
    typeof exports === "object" && typeof module !== "undefined" ? module.exports = factory() : typeof define === "function" && define.amd ? define(factory) : global.UIkitTooltip = factory();
})(this, function() {
    "use strict";
    function plugin(UIkit) {
        if (plugin.installed) {
...
(function(global, factory) {
    typeof exports === "object" && typeof module !== "undefined" ? module.exports = factory() : typeof define === "function" && define.amd ? define(factory) : global.UIkitUpload = factory();
})(this, function() {
    "use strict";
    function plugin(UIkit) {
        if (plugin.installed) {
...
(function(factory) {
    ...
    function Autocomplete(el, options) {
        var noop = $.noop, that = this, defaults = {
            ajaxSettings: {},
