...
try {
	var __IntegralASConfig = {
		...
		protocol: 'https',
		jsref: "https:\/\/www.ultimedia.com\/deliver\/generic\/iframe?mdtk=01617843&zone=3&type_player=0&sendstats=0&src=m8m055&width=720&height=405&urlfacebook=https%3A%2F%2Fwww.futura-sciences.com%2Fsciences%2Factualites%2Fmathematiques-oubliez-vos-tables-multiplication-voici-nouvelle-methode-bien-plus-efficace-75678%2F&ad=1&autoplay=no&fstart=2&title=Des+vers+marins+film%C3%A9s+dans+la+fosse+de+Porto+Rico&endMessage=um_ultimedia_wrapper_actualite_75678_ultimediaEndRoll&widgetPrefix=um_ultimedia_wrapper_actualite_75678_&adsparam=&visible=&xtn2=14&xtpage=sciences%3A%3Aactualite%3A%3A75678_oubliez-vos-tables-de-multiplication-%3A-voici-une-nouvelle-methode-bien-plus-efficace",
		asid: "692fed47-5f58-11e9-a956-00259086cc16",
		...
		mode: "fwjsvid",
		requrl: "",
		dtBaseURL: "https:\/\/dt.adsafeprotected.com\/dt?advEntityId=260082",
		adsafeSrc: "https:\/\/pixel.adsafeprotected.com\/rfw\/st\/260082\/34512695\/skeleton.js?videoId=2e491c429ef47ad775d0522be945cc43&xmtp=v&xmapp=0&xsId=89f12d0e-9b74-40d1-a0f4-75688d5e1d15",
		tpiLookupURL: "",
		getTpl: "false",
		use100v: false,
		useBapiCallback: "",
		useViewabilityNotification: "",
		scriptUrl: "https:\/\/pixel.adsafeprotected.com\/fwjsvid\/st\/260082\/34512695\/skeleton.js?videoId=2e491c429ef47ad775d0522be945cc43&xmtp=v&xmapp=0&xsId=89f12d0e-9b74-40",
		accountForSadImps: '',
		sendCookie: 'true',
		cookieBaseURL: 'sc.iasds01.com\/dtc?advEntityId=260082&pubEnt=34512695',
		fwMonitoring: 'true',
		doNothing: false,
		mn: "app01ami",
		mobOrTab: false,
		...
		anId: '',
		advEntityId: '260082',
		pubEntityId: '34512695',
		videoId: '2e491c429ef47ad775d0522be945cc43',
		videoChannel: '',
		rts: {},
		customViewability: [{ "id":"hp1", "tiv": 5, "minunit":1, "thresholds": [{"piv":100, "lb": 0}], "mediaTypes":["display"], "deviceGroups":["desktop","mobile"], "distributionChannels":["web","app"] }, { "id":"hp2", "tiv": "15|50%",  "sound": "any", "minunit":1, "thresholds": [{"piv":100, "lb": 0}], "mediaTypes":["video"], "deviceGroups":["desktop","mobile"], "distributionChannels":["web","app"] }],
...
"='"+b+"'\">"].join("");f.open().write(b);f.close()})(b);return{getWindow:function(){return c.contentWindow}}};try{Oa()}catch(ee){__IntegralASDiagnosticCall("main",ee,m)}};try{(function(){var m=__IntegralASConfig.useFIF?__IASScope.parent:__IASScope;__IntegralASConfig.initVideo(__IntegralASConfig,m,m.document)})()}catch(err$$10){__IntegralASDiagnosticCall("initialize",err$$10,__IntegralASConfig)};
