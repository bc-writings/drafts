...
K:"ytp-mdx-popup-dialog",V:{role:"dialog"},U:[{D:"div",K:"ytp-mdx-popup-dialog-inner-content",U:[{D:"div",K:"ytp-mdx-popup-title",qa:"Vous \u00eates d\u00e9connect\u00e9"},{D:"div",K:"ytp-mdx-popup-description",qa:"Les vid\u00e9os que vous visionnez peuvent \u00eatre ajout\u00e9es \u00e0 l'historique des vid\u00e9os regard\u00e9es sur votre t\u00e9l\u00e9viseur et avoir une influence sur les recommandations qui vous sont faites. Pour \u00e9viter ce probl\u00e8me, annulez et connectez-vous \u00e0 YouTube sur un ordinateur."},
{D:"div",K:"ytp-mdx-privacy-popup-buttons",U:[{D:"button",Ga:["ytp-button","ytp-mdx-privacy-popup-cancel"],qa:"Annuler"},{D:"button",Ga:["ytp-button","ytp-mdx-privacy-popup-confirm"],qa:"Confirmer"}]}]}]});this.i=new g.OK(this,250);this.cancelButton=this.Da("ytp-mdx-privacy-popup-cancel");this.confirmButton=this.Da("ytp-mdx-privacy-popup-confirm");g.J(this,this.i);this.S(this.cancelButton,"click",this.j);this.S(this.confirmButton,"click",this.u)},N9=function(a){g.W.call(this,{D:"div",
...
b=g.V(b,128)?g.kH("Erreur sur $RECEIVER_NAME",c):b.Ic()||g.V(b,4)?g.kH("Lecture sur $RECEIVER_NAME",c):g.kH("Connect\u00e9 \u00e0 $RECEIVER_NAME",c);a.Ma("statustext",b);a.i.show()}else a.i.hide()},O9=function(a,b){g.uP.call(this,"Lire sur",0,a,b);
...
this.ll={key:f7(),name:"Cet ordinateur"};this.ji=null;this.subscriptions=[];this.NG=this.Wb=null;this.Uo=[this.ll];this.Gn=this.ll;this.Gd=new g.QI(64);this.AM=0;this.Cf=-1;this.yx=!1;this.wx=this.Ot=null;if(!g.dE(this.player.T())&&!g.eE(this.player.T())){a=this.player;var b=g.WL(a);b&&(b=b.Yn())&&(b=new O9(a,b),g.J(this,b));b=new N9(a);g.J(this,b);g.fM(a,b.element,4);this.Ot=new M9;g.J(this,this.Ot);g.fM(a,this.Ot.element,4);this.yx=!!w9()}},Q9=function(a){a.wx&&(a.player.removeEventListener("presentingplayerstatechange",
a.wx),a.wx=null)},H0a=function(a,b,c){a.Gd=c;
