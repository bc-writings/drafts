...
q("String.prototype.endsWith",function(a){return a?a:function(b,c){var d=wa(this,b,"endsWith");b+="";void 0===c&&(c=d.length);for(var e=Math.max(0,Math.min(c|0,d.length)),f=b.length;0<f&&0<e;)if(d[--e]!=b[--f])return!1;return 0>=f}});
q("String.prototype.startsWith",function(a){return a?a:function(b,c){var d=wa(this,b,"startsWith");b+="";for(var e=d.length,f=b.length,g=Math.max(0,Math.min(c|0,d.length)),h=0;h<f&&g<e;)if(d[g++]!=b[h++])return!1;return h>=f}});
...
q("Object.assign",function(a){return a||ya});
q("Promise",function(a){function b(g){this.g=0;this.h=void 0;this.f=[];var h=this.i();try{g(h.resolve,h.reject)}catch(k){h.reject(k)}}
...
var h=this,k=!1;return{resolve:g(this.D),reject:g(this.j)}};
b.prototype.D=function(g){if(g===this)this.j(new TypeError("A Promise cannot resolve to itself"));else if(g instanceof b)this.F(g);else{a:switch(typeof g){case "object":var h=null!=g;break a;case "function":h=!0;break a;default:h=!1}h?this.u(g):this.l(g)}};
...
b.prototype.then=function(g,h){function k(t,r){return"function"==typeof t?function(A){try{l(t(A))}catch(E){m(E)}}:r}
...
b.all=function(g){var h=u(g),k=h.next();return k.done?d([]):new b(function(l,m){function p(A){return function(E){t[A]=E;r--;0==r&&l(t)}}
var t=[],r=0;do t.push(void 0),r++,d(k.value).da(p(t.length-1),m),k=h.next();while(!k.done)})};
return b});
...
return e}
q("Array.prototype.keys",function(a){return a?a:function(){return za(this,function(b){return b})}});
q("Array.prototype.values",function(a){return a?a:function(){return za(this,function(b,c){return c})}});
...
q("String.prototype.includes",function(a){return a?a:function(b,c){return-1!==wa(this,b,"includes").indexOf(b,c||0)}});
...
return b});
q("Array.prototype.entries",function(a){return a?a:function(){return za(this,function(b,c){return[b,c]})}});
...
q("Object.entries",function(a){return a?a:function(b){var c=[],d;for(d in b)xa(b,d)&&c.push([d,b[d]]);return c}});
...
function b(p){for(var t=g,r=0;64>r;r+=4)t[r/4]=p[r]<<24|p[r+1]<<16|p[r+2]<<8|p[r+3];for(r=16;80>r;r++)p=t[r-3]^t[r-8]^t[r-14]^t[r-16],t[r]=(p<<1|p>>>31)&4294967295;p=e[0];var A=e[1],E=e[2],V=e[3],hd=e[4];for(r=0;80>r;r++){if(40>r)if(20>r){var Va=V^A&(E^V);var Ub=1518500249}else Va=A^E^V,Ub=1859775393;else 60>r?(Va=A&E|V&(A|E),Ub=2400959708):(Va=A^E^V,Ub=3395469782);Va=((p<<5|p>>>27)&4294967295)+Va+hd+Ub+t[r]&4294967295;hd=V;V=E;E=(A<<30|A>>>2)&4294967295;A=p;p=Va}e[0]=e[0]+p&4294967295;e[1]=e[1]+
A&4294967295;e[2]=e[2]+E&4294967295;e[3]=e[3]+V&4294967295;e[4]=e[4]+hd&4294967295}
function c(p,t){if("string"===typeof p){p=unescape(encodeURIComponent(p));for(var r=[],A=0,E=p.length;A<E;++A)r.push(p.charCodeAt(A));p=r}t||(t=p.length);r=0;if(0==l)for(;r+64<t;)b(p.slice(r,r+64)),r+=64,m+=64;for(;r<t;)if(f[l++]=p[r++],m++,64==l)for(l=0,b(f);r+64<t;)b(p.slice(r,r+64)),r+=64,m+=64}
...
for(var e=[],f=[],g=[],h=[128],k=1;64>k;++k)h[k]=0;var l,m;a();return{reset:a,update:c,digest:d,Ea:function(){for(var p=d(),t="",r=0;r<p.length;r++)t+="0123456789ABCDEF".charAt(Math.floor(p[r]/16))+"0123456789ABCDEF".charAt(p[r]%16);return t}}}
...
z("yt.ads_.signals_.getAdSignalsString",function(a){return eg(hg(a))},void 0);var lg="XMLHttpRequest"in y?function(){return new XMLHttpRequest}:null;
...
function di(a){return L(this,function c(){var d;return x(c,function(e){switch(e.f){case 1:if(!a.id){e.I(2);break}return w(e,Mh(a.id),3);case 3:(d=e.g)?a=d:Ae(Error("The request cannot be found in the database."));case 2:var f=a.timestamp;if(!(2592E6<=W()-f)){e.I(4);break}Ae(Error("Networkless Logging: Stored logs request expired age limit"));if(!a.id){e.I(5);break}return w(e,Oh(a.id),5);case 5:return e["return"]();case 4:f=a=ei(a);var g,h;if(null===(h=null===(g=null===f||void 0===f?void 0:f.options)||
...
c,k,h);if(t){var r=f.onSuccess,A=f.va;f.onSuccess=function(E,V){Lg(t);r(E,V)};
c.va=function(E,V){Lg(t);A(E,V)}}}try{T("use_fetch_for_op_xhr")?tg(m,f):T("networkless_gel")&&d.retry?(f.method="POST",bi(m,f)):(f.method="POST",f.C||(f.C={}),wg(m,f))}catch(E){if("InvalidAccessError"==E.name)t&&(Lg(t),t=0),Ae(Error("An extension is blocking network request."));
...
(window&&window.yterr||g)&&!(5<=ni)&&0!==a.sampleWeight)){var h=pc(a);g=h.message||"Unknown Error";d=h.name||"UnknownError";e=h.lineNumber||"Not available";f=h.fileName||"Not available";h=h.stack||a.f||"Not available";if(a.hasOwnProperty("args")&&a.args&&a.args.length)for(var k=0,l=0;l<a.args.length;l++){var m=a.args[l],p="params."+l;k+=p.length;if(m)if(Array.isArray(m))for(var t=c,r=0;r<m.length&&!(m[r]&&(k+=ri(r,m[r],p,t),500<k));r++);else if("object"===typeof m)for(t in t=void 0,r=c,m){if(m[t]&&
(k+=ri(t,m[t],p,r),500<k))break}else c[p]=String(JSON.stringify(m)).substring(0,500),k+=c[p].length;else c[p]=String(JSON.stringify(m)).substring(0,500),k+=c[p].length;if(500<=k)break}else if(a.hasOwnProperty("params")&&a.params)if(m=a.params,"object"===typeof a.params)for(l in p=0,m){if(m[l]&&(k="params."+l,t=String(JSON.stringify(m[l])).substr(0,500),c[k]=t,p+=k.length+t.length,500<p))break}else c.params=String(JSON.stringify(m)).substr(0,500);navigator.vendor&&!c.hasOwnProperty("vendor")&&(c.vendor=
...
function nj(a){if(!a.g&&!a.L){var b=qj(a);if(b&&"html5"==(rj(a)?"html5":null))a.U="html5",a.u||tj(a);else if(uj(a),a.U="html5",b&&a.l)a.aa.appendChild(a.l),tj(a);else{a.f&&(a.f.loaded=!0);var c=!1;a.D=function(){c=!0;var d=vj(a,"player_bootstrap_method")?B("yt.player.Application.createAlternate")||B("yt.player.Application.create"):B("yt.player.Application.create");var e=a.f?a.f.clone():void 0;d(a.aa,e,a.i);tj(a)};
a.L=!0;b?a.D():(Xe(sj(a),a.D),(b=a.i?a.i.cssUrl:a.f.assets.css)&&gj(b),wj(a)&&!c&&z("yt.player.Application.create",null,void 0))}}}
...
n.cancel=function(){if(this.D){var a=sj(this);cf(a,this.D)}Ke(this.oa);this.L=!1};
...
Pj.prototype.o=function(){Lj.prototype.o.call(this);delete this.i};function Qj(a,b,c){N.call(this);var d=this;c=c||R("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname;this.h=b||null;this.u="*";this.i=c;this.sessionId=null;this.channel="widget";this.D=!!a;this.m=function(e){a:if(!("*"!=d.i&&e.origin!=d.i||d.h&&e.source!=d.h||"string"!==typeof e.data)){try{var f=JSON.parse(e.data)}catch(g){break a}if(!(null==f||d.D&&(d.sessionId&&d.sessionId!=f.id||d.channel&&d.channel!=f.channel))&&f)switch(f.event){case "listening":"null"!=
...
c))&&c<l;){var m=a.charCodeAt(c-1);if(38==m||63==m){var p=a.charCodeAt(c+2);if(!p||61==p||38==p||35==p){var t=c;break d}}c+=3}t=-1}if(0>t)var r=null;else{var A=a.indexOf("&",t);if(0>A||A>l)A=l;t+=3;r=decodeURIComponent(a.substr(t,A-t).replace(/\+/g," "))}k="1"!==r}f=!k;break b}}catch(E){}f=!1}f?wk(a)?(b&&b(),f=!0):f=!1:f=!1;f||xk(a,b)}}
