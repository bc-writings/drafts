(function(g){var window=this;'use strict';var $Pa=function(a,b){return g.Pb(a,b)},aQa=function(a,b){b=b instanceof g.Ic?b:g.Oc(b,/^data:image\//i.test(b));
a.src=g.Jc(b)},bQa=function(a){if(a instanceof g.Xh)return a;
...
c.next=c.i.bind(c);return c}throw Error("Not implemented");},cQa=function(a,b,c){if(g.La(a))try{g.Cb(a,b,c)}catch(d){if(d!==g.ci)throw d;
}else{a=bQa(a);try{for(;;)b.call(c,a.next(),void 0,a)}catch(d){if(d!==g.ci)throw d;}}},B6=function(a){g.rk(a,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^g.Ra()).toString(36));
return a},C6=function(a,b,c){Array.isArray(c)||(c=[String(c)]);
g.wk(a.l,b,c)},dQa=function(a,b){var c=[];
cQa(b,function(d){try{var e=g.lr.prototype.l.call(this,d,!0)}catch(f){if("Storage: Invalid value was encountered"==f)return;throw f;}void 0===e?c.push(d):g.kr(e)&&c.push(d)},a);
return c},eQa=function(a,b){dQa(a,b).forEach(function(c){g.lr.prototype.remove.call(this,c)},a)},fQa=function(a){if(a.V){if(a.V.locationOverrideToken)return{locationOverrideToken:a.V.locationOverrideToken};
if(null!=a.V.latitudeE7&&null!=a.V.longitudeE7)return{latitudeE7:a.V.latitudeE7,longitudeE7:a.V.longitudeE7}}return null},gQa=function(a,b){g.jb(a,b)||a.push(b)},D6=function(a){var b=0,c;
for(c in a)b++;return b},hQa=function(a){try{return g.B.JSON.parse(a)}catch(b){}a=String(a);
if(/^\s*$/.test(a)?0:/^[\],:{}\s\u2028\u2029]*$/.test(a.replace(/\\["\\\/bfnrtu]/g,"@").replace(/(?:"[^"\\\n\r\u2028\u2029\x00-\x08\x0a-\x1f]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?)[\s\u2028\u2029]*(?=:|,|]|}|$)/g,"]").replace(/(?:^|:|,)(?:[\s\u2028\u2029]*\[)+/g,"")))try{return eval("("+a+")")}catch(b){}throw Error("Invalid JSON string: "+a);},E6=function(a){if(g.B.JSON)try{return g.B.JSON.parse(a)}catch(b){}return hQa(a)},iQa=function(a,b,c,d){var e=new g.fk(null,void 0);
...
a.user||"",this.avatar=a.userAvatarUri||"",this.obfuscatedGaiaId=a.obfuscatedGaiaId||"",this.theme=a.theme||"u",jQa(this,a.capabilities||""),kQa(this,a.experiments||""),this.brand=a.brand||"",this.model=a.model||"",this.year=a.year||0,this.os=a.os||"",this.osVersion=a.osVersion||"",this.chipset=a.chipset||"",this.mdxDialServerType=a.mdxDialServerType||"MDX_DIAL_SERVER_TYPE_UNKNOWN",a=a.deviceInfo)&&(a=JSON.parse(a),this.brand=a.brand||"",this.model=a.model||"",this.year=a.year||0,this.os=a.os||"",
this.osVersion=a.osVersion||"",this.chipset=a.chipset||"",this.clientName=a.clientName?a.clientName.toUpperCase():"UNKNOWN_INTERFACE",this.mdxDialServerType=a.mdxDialServerType||"MDX_DIAL_SERVER_TYPE_UNKNOWN")},jQa=function(a,b){a.capabilities.clear();
g.To(b.split(","),g.Pa($Pa,lQa)).forEach(function(c){a.capabilities.add(c)})},kQa=function(a,b){a.experiments.clear();
b.split(",").forEach(function(c){a.experiments.add(c)})},H6=function(a){a=a||{};
this.name=a.name||"";this.id=a.id||a.screenId||"";this.token=a.token||a.loungeToken||"";this.uuid=a.uuid||a.dialId||"";this.idType=a.screenIdType||"normal"},I6=function(a,b){return!!b&&(a.id==b||a.uuid==b)},mQa=function(a){return{name:a.name,
screenId:a.id,loungeToken:a.token,dialId:a.uuid,screenIdType:a.idType}},nQa=function(a){return new H6(a)},oQa=function(a){return Array.isArray(a)?g.Se(a,nQa):[]},J6=function(a){return a?'{name:"'+a.name+'",id:'+a.id.substr(0,6)+"..,token:"+((a.token?".."+a.token.slice(-6):"-")+",uuid:"+(a.uuid?".."+a.uuid.slice(-6):"-")+",idType:"+a.idType+"}"):"null"},K6=function(a){return Array.isArray(a)?"["+g.Se(a,J6).join(",")+"]":"null"},L6=function(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,
function(a){var b=16*Math.random()|0;
return("x"==a?b:b&3|8).toString(16)})},pQa=function(a){return g.Se(a,function(b){return{key:b.id,
name:b.name}})},M6=function(a,b){return g.fb(a,function(c){return c||b?!c!=!b?!1:c.id==b.id:!0})},N6=function(a,b){return g.fb(a,function(c){return I6(c,b)})},qQa=function(){var a=(0,g.qz)();
a&&eQa(a,a.i.Eg(!0))},O6=function(){var a=g.tz("yt-remote-connected-devices")||[];
g.zb(a);return a},rQa=function(a){if(g.kb(a))return[];
var b=a[0].indexOf("#"),c=-1==b?a[0]:a[0].substring(0,b);return g.Se(a,function(d,e){return 0==e?d:d.substring(c.length)})},sQa=function(a){g.sz("yt-remote-connected-devices",a,86400)},Q6=function(){if(P6)return P6;
...
g.jb(a,b);g.wz()&&g.Bb(a,b);a=rQa(a);if(g.kb(a))try{g.xt("remote_sid")}catch(c){}else try{g.vt("remote_sid",a.join(","),-1)}catch(c){}},tQa=function(){return g.tz("yt-remote-session-browser-channel")},uQa=function(){return g.tz("yt-remote-local-screens")||[]},vQa=function(){g.sz("yt-remote-lounge-token-expiration",!0,86400)},wQa=function(a){5<a.length&&(a=a.slice(a.length-5));
var b=g.Se(uQa(),function(d){return d.loungeToken}),c=g.Se(a,function(d){return d.loungeToken});
g.Fm(c,function(d){return!g.jb(b,d)})&&vQa();
g.sz("yt-remote-local-screens",a,31536E3)},xQa=function(a,b){g.sz("yt-remote-session-browser-channel",a);
g.sz("yt-remote-session-screen-id",b);a=O6();b=Q6();g.jb(a,b)||a.push(b);sQa(a);R6()},S6=function(a){a||(g.vz("yt-remote-session-screen-id"),g.vz("yt-remote-session-video-id"));
R6();a=O6();g.ob(a,Q6());sQa(a)},yQa=function(){if(!T6){var a=g.vr();
a&&(T6=new g.fr(a))}},zQa=function(){yQa();
return T6?!!T6.get("yt-remote-use-staging-server"):!1},U6=function(){var a=window.navigator.userAgent.match(/Chrome\/([0-9]+)/);
return a?parseInt(a[1],10):0},AQa=function(a){return!!document.currentScript&&(-1!=document.currentScript.src.indexOf("?"+a)||-1!=document.currentScript.src.indexOf("&"+a))},BQa=function(){return"function"==typeof window.__onGCastApiAvailable?window.__onGCastApiAvailable:null},V6=function(a){a.length?CQa(a.shift(),function(){V6(a)}):W6()},DQa=function(a){return"chrome-extension://"+a+"/cast_sender.js"},CQa=function(a,b,c){var d=document.createElement("script");
d.onerror=b;c&&(d.onload=c);g.Fj(d,g.Al(a));(document.head||document.documentElement).appendChild(d)},EQa=function(){var a=U6(),b=[];
if(1<a){var c=a-1;b.push("//www.gstatic.com/eureka/clank/"+a+"/cast_sender.js");b.push("//www.gstatic.com/eureka/clank/"+c+"/cast_sender.js")}return b},W6=function(){var a=BQa();
a&&a(!1,"No cast extension found")},X6=function(){if(FQa){var a=2,b=BQa(),c=function(){a--;
0==a&&b&&b(!0)};
window.__onGCastApiAvailable=c;CQa("//www.gstatic.com/cast/sdk/libs/sender/1.0/cast_framework.js",W6,c)}},GQa=function(){X6();
var a=EQa();a.push("//www.gstatic.com/eureka/clank/cast_sender.js");V6(a)},IQa=function(){X6();
var a=EQa();a.push.apply(a,g.la(HQa.map(DQa)));a.push("//www.gstatic.com/eureka/clank/cast_sender.js");V6(a)},Y6=function(a,b,c){g.E.call(this);
...
return g.B.setTimeout(function(){a()},b)},d7=function(a){c7.dispatchEvent(new JQa(c7,a))},JQa=function(a,b){g.mf.call(this,"statevent",a);
this.stat=b},e7=function(a,b,c,d){this.i=a;
this.l=b;this.L=c;this.J=d||1;this.C=45E3;this.B=new g.xk(this);this.u=new g.mh;this.u.setInterval(250)},LQa=function(a,b,c){a.Es=1;
a.Am=B6(b.clone());a.Up=c;a.G=!0;KQa(a,null)},f7=function(a,b,c,d,e){a.Es=1;
a.Am=B6(b.clone());a.Up=null;a.G=c;e&&(a.KL=!1);KQa(a,d)},KQa=function(a,b){a.qs=Date.now();
g7(a);a.Pn=a.Am.clone();C6(a.Pn,"t",a.J);a.Dw=0;a.We=a.i.bC(a.i.gw()?b:null);0<a.WA&&(a.rz=new Z6((0,g.C)(a.JM,a,a.We),a.WA));a.B.Qa(a.We,"readystatechange",a.DO);b=a.Bo?g.Wb(a.Bo):{};a.Up?(a.gA="POST",b["Content-Type"]="application/x-www-form-urlencoded",a.We.send(a.Pn,a.gA,a.Up,b)):(a.gA="GET",a.KL&&!g.mg&&(b.Connection="close"),a.We.send(a.Pn,a.gA,null,b));a.i.nj(1)},OQa=function(a,b,c){for(var d=!0;!a.Oo&&a.Dw<c.length;){var e=MQa(a,c);
if(e==h7){4==b&&(a.tm=4,d7(15),d=!1);break}else if(e==NQa){a.tm=4;d7(16);d=!1;break}else i7(a,e)}4==b&&0==c.length&&(a.tm=1,d7(17),d=!1);a.Bj=a.Bj&&d;d||(j7(a),k7(a))},MQa=function(a,b){var c=a.Dw,d=b.indexOf("\n",c);
if(-1==d)return h7;c=Number(b.substring(c,d));if(isNaN(c))return NQa;d+=1;if(d+c>b.length)return h7;b=b.substr(d,c);a.Dw=d+c;return b},QQa=function(a,b){a.qs=Date.now();
g7(a);var c=b?window.location.hostname:"";a.Pn=a.Am.clone();g.rk(a.Pn,"DOMAIN",c);g.rk(a.Pn,"t",a.J);try{a.Fj=new ActiveXObject("htmlfile")}catch(m){j7(a);a.tm=7;d7(22);k7(a);return}var d="<html><body>";if(b){var e="";for(b=0;b<c.length;b++){var f=c.charAt(b);if("<"==f)f=e+"\\x3c";else if(">"==f)f=e+"\\x3e";else{if(f in l7)f=l7[f];else if(f in PQa)f=l7[f]=PQa[f];else{var h=f.charCodeAt(0);if(31<h&&127>h)var l=f;else{if(256>h){if(l="\\x",16>h||256<h)l+="0"}else l="\\u",4096>h&&(l+="0");l+=h.toString(16).toUpperCase()}f=
...
a.C;
RQa(a,a.C)},RQa=function(a,b){if(null!=a.Ls)throw Error("WatchDog timer not null");
...
g.jf(a.rz);a.rz=null;a.u.stop();g.zk(a.B);if(a.We){var b=a.We;a.We=null;b.abort();b.dispose()}a.Fj&&(a.Fj=null)},i7=function(a,b){try{a.i.VK(a,b),a.i.nj(4)}catch(c){}},TQa=function(a,b,c,d,e){if(0==d)c(!1);
else{var f=e||0;d--;SQa(a,b,function(h){h?c(!0):g.B.setTimeout(function(){TQa(a,b,c,d,f)},f)})}},SQa=function(a,b,c){var d=new Image;
...
aQa(d,a)},n7=function(a){a.onload=null;
a.onerror=null;a.onabort=null;a.ontimeout=null},UQa=function(a){this.i=a;
this.l=new a7},VQa=function(a){var b=o7(a.i,a.Lt,"/mail/images/cleardot.gif");
B6(b);TQa(b.toString(),5E3,(0,g.C)(a.xP,a),3,2E3);a.nj(1)},q7=function(a){var b=a.i.L;
if(null!=b)d7(5),b?(d7(11),p7(a.i,a,!1)):(d7(12),p7(a.i,a,!0));else if(a.hh=new e7(a,void 0,void 0,void 0),a.hh.Bo=a.XA,b=a.i,b=o7(b,b.gw()?a.ut:null,a.YA),d7(5),!g.ie||g.ce(10))C6(b,"TYPE","xmlhttp"),f7(a.hh,b,!1,a.ut,!1);else{C6(b,"TYPE","html");var c=a.hh;a=!!a.ut;c.Es=3;c.Am=B6(b.clone());QQa(c,a)}},r7=function(a,b,c){this.Pa=1;
this.i=[];this.u=[];this.B=new a7;this.J=a||null;this.L=null!=b?b:null;this.C=c||!1},WQa=function(a,b){this.i=a;
this.map=b;this.context=null},XQa=function(a,b,c,d){g.mf.call(this,"timingevent",a);
this.size=b;this.Xv=d},YQa=function(a){g.mf.call(this,"serverreachability",a)},aRa=function(a){ZQa(a);
if(3==a.Pa){var b=a.ov++,c=a.xx.clone();g.rk(c,"SID",a.l);g.rk(c,"RID",b);g.rk(c,"TYPE","terminate");s7(a,c);b=new e7(a,a.l,b,void 0);b.Es=2;b.Am=B6(c.clone());aQa(new Image,b.Am.toString());b.qs=Date.now();g7(b)}$Qa(a)},bRa=function(a){a.YP(1,0);
a.xx=o7(a,null,a.ZA);t7(a)},ZQa=function(a){a.Fm&&(a.Fm.abort(),a.Fm=null);
a.Ae&&(a.Ae.cancel(),a.Ae=null);a.ql&&(g.B.clearTimeout(a.ql),a.ql=null);u7(a);a.Og&&(a.Og.cancel(),a.Og=null);a.Mm&&(g.B.clearTimeout(a.Mm),a.Mm=null)},cRa=function(a,b){if(0==a.Pa)throw Error("Invalid operation: sending map when state is closed");
a.i.push(new WQa(a.GR++,b));2!=a.Pa&&3!=a.Pa||t7(a)},dRa=function(a){var b=0;
a.Ae&&b++;a.Og&&b++;return b},t7=function(a){a.Og||a.Mm||(a.Mm=b7((0,g.C)(a.aL,a),0),a.wr=0)},fRa=function(a,b){if(1==a.Pa){if(!b){a.ov=Math.floor(1E5*Math.random());
b=a.ov++;var c=new e7(a,"",b,void 0);c.Bo=a.Tj;var d=v7(a),e=a.xx.clone();g.rk(e,"RID",b);g.rk(e,"CVER","1");s7(a,e);LQa(c,e,d);a.Og=c;a.Pa=2}}else 3==a.Pa&&(b?eRa(a,b):0==a.i.length||a.Og||eRa(a))},eRa=function(a,b){if(b)if(6<a.Po){a.i=a.u.concat(a.i);
a.u.length=0;var c=a.ov-1;b=v7(a)}else c=b.L,b=b.Up;else c=a.ov++,b=v7(a);var d=a.xx.clone();g.rk(d,"SID",a.l);g.rk(d,"RID",c);g.rk(d,"AID",a.Nr);s7(a,d);c=new e7(a,a.l,c,a.wr+1);c.Bo=a.Tj;c.setTimeout(1E4+Math.round(1E4*Math.random()));a.Og=c;LQa(c,d,b)},s7=function(a,b){a.If&&(a=a.If.zI())&&g.Eb(a,function(c,d){g.rk(b,d,c)})},v7=function(a){var b=Math.min(a.i.length,1E3),c=["count="+b];
...
return c.join("&")},gRa=function(a){a.Ae||a.ql||(a.G=1,a.ql=b7((0,g.C)(a.ZK,a),0),a.Tq=0)},w7=function(a){if(a.Ae||a.ql||3<=a.Tq)return!1;
a.G++;a.ql=b7((0,g.C)(a.ZK,a),hRa(a,a.Tq));a.Tq++;return!0},p7=function(a,b,c){a.eA=c;
a.Uj=b.Uk;a.C||bRa(a)},u7=function(a){null!=a.Xo&&(g.B.clearTimeout(a.Xo),a.Xo=null)},hRa=function(a,b){var c=5E3+Math.floor(1E4*Math.random());
a.isActive()||(c*=2);return c*b},x7=function(a,b){if(2==b||9==b){var c=null;
a.If&&(c=null);var d=(0,g.C)(a.QV,a);c||(c=new g.fk("//www.google.com/images/cleardot.gif"),B6(c));SQa(c.toString(),1E4,d)}else d7(2);iRa(a,b)},iRa=function(a,b){a.Pa=0;
a.If&&a.If.PH(b);$Qa(a);ZQa(a)},$Qa=function(a){a.Pa=0;
...
if(""!=d.i)b&&g.hk(d,b+"."+d.i),g.ik(d,d.u);else{var e=window.location;d=iQa(e.protocol,b?b+"."+e.hostname:e.hostname,+e.port,c)}a.ju&&g.Eb(a.ju,function(f,h){g.rk(d,h,f)});
g.rk(d,"VER",a.Po);s7(a,d);return d},jRa=function(){},kRa=function(){this.i=[];
...
e=void 0===e?!1:e;this.xa=a;this.G=b;this.u=new g.er;this.l=new y7(this.vV,this);this.i=null;this.ea=!1;this.C=null;this.V="";this.L=this.B=0;this.J=[];this.ya=c;this.Y=d;this.Aa=e},mRa=function(a){return{firstTestResults:[""],
secondTestResults:!a.i.eA,sessionId:a.i.l,arrayId:a.i.Nr}},nRa=function(a,b){a.L=b||0;
a.l.stop();A7(a);a.i&&(3==a.i.getState()&&fRa(a.i),aRa(a.i));a.L=0},B7=function(a){return!!a.i&&3==a.i.getState()},A7=function(a){if(a.i){var b=a.Y(),c=a.i.Tj||{};
...
method:"POST",context:a,timeout:5E3,withCredentials:!1,onSuccess:g.Pa(a.B,d,!0),onError:g.Pa(a.u,e),onTimeout:g.Pa(a.C,e)};c&&(a.postParams=c,a.headers={"Content-Type":"application/x-www-form-urlencoded"});return g.jt(b,a)},rRa=function(){var a=oRa;
pRa();F7.push(a);qRa()},G7=function(a,b){pRa();
var c=sRa(a,String(b));g.kb(F7)?tRa(c):(qRa(),g.Cb(F7,function(d){d(c)}))},pRa=function(){F7||(F7=g.Ha("yt.mdx.remote.debug.handlers_")||[],g.Ga("yt.mdx.remote.debug.handlers_",F7,void 0))},tRa=function(a){var b=(H7+1)%50;
...
this.G=a;this.screens=[]},vRa=function(a,b){var c=a.get(b.uuid)||a.get(b.id);
...
this.l=a;this.i=NaN;M7(this);this.info("Initializing with "+K6(this.screens))},yRa=function(a){if(a.screens.length){var b=g.Se(a.screens,function(d){return d.id}),c=D7(a.l,"/pairing/get_lounge_token_batch");
E7(a.l,c,{screen_ids:b.join(",")},(0,g.C)(a.xQ,a),(0,g.C)(a.wQ,a))}},M7=function(a){if(g.gs("deprecate_pair_servlet_enabled"))return wRa(a,[]);
var b=oQa(uQa());b=g.To(b,function(c){return!c.uuid});
return wRa(a,b)},O7=function(a,b){wQa(g.Se(a.screens,mQa));
b&&vQa()},Q7=function(a,b){g.P.call(this);
...
else{c=g.Mb(b);for(var d=0,e=c.length;d<e;++d)if(!a.i[c[d]]){c=!1;break a}c=!0}c||(P7("Updated online screens: "+g.Qh(a.i)),a.i=b,a.Z("screenChange"));zRa(a)},T7=function(a){isNaN(a.u)||g.et(a.u);
a.u=g.ct((0,g.C)(a.rE,a),0<a.B&&a.B<g.Ra()?2E4:1E4)},P7=function(a){G7("OnlineScreenService",a)},ARa=function(a){var b={};
g.Cb(a.G(),function(c){c.token?b[c.token]=c.id:this.Wd("Requesting availability of screen w/o lounge token.")});
return b},zRa=function(a){a=g.Mb(g.Fb(a.i,function(b){return b}));
...
K7.call(this,"ScreenService");this.B=a;this.J=b;this.i=this.l=null;this.u=[];this.C={};BRa(this)},DRa=function(a,b,c,d,e,f){a.info("getAutomaticScreenByIds "+c+" / "+b);
c||(c=a.C[b]);var h=a.Ch(),l=c?N6(h,c):null;c&&(a.J||l)||(l=N6(h,b));if(l){l.uuid=b;var m=V7(a,l);R7(a.i,m,function(n){e(n?m:null)})}else c?CRa(a,c,(0,g.C)(function(n){var p=V7(this,new H6({name:d,
screenId:c,loungeToken:n,dialId:b||""}));R7(this.i,p,function(r){e(r?p:null)})},a),f):e(null)},ERa=function(a,b){for(var c=0,d=a.screens.length;c<d;++c)if(a.screens[c].name==b)return a.screens[c];
return null},FRa=function(a,b,c){R7(a.i,b,c)},CRa=function(a,b,c,d){a.info("requestLoungeToken_ for "+b);
...
g.jt(D7(a.B,"/pairing/get_lounge_token_batch"),e)},GRa=function(a){a.screens=a.l.Ch();
var b=a.C,c={},d;for(d in b)c[b[d]]=d;b=0;for(d=a.screens.length;b<d;++b){var e=a.screens[b];e.uuid=c[e.id]||""}a.info("Updated manual screens: "+K6(a.screens))},BRa=function(a){W7(a);
a.l=new N7(a.B);a.l.subscribe("screenChange",(0,g.C)(a.GQ,a));GRa(a);a.J||(a.u=oQa(g.tz("yt-remote-automatic-screen-cache")||[]));W7(a);a.info("Initializing automatic screens: "+K6(a.u));a.i=new Q7(a.B,(0,g.C)(a.Ch,a,!0));a.i.subscribe("screenChange",(0,g.C)(function(){this.Z("onlineScreenChange")},a))},V7=function(a,b){var c=a.get(b.id);
c?(c.uuid=b.uuid,b=c):((c=N6(a.u,b.uuid))?(c.id=b.id,c.token=b.token,b=c):a.u.push(b),a.J||HRa(a));W7(a);a.C[b.uuid]=b.id;g.sz("yt-remote-device-id-map",a.C,31536E3);return b},HRa=function(a){a=g.To(a.u,function(b){return"shortLived"!=b.idType});
g.sz("yt-remote-automatic-screen-cache",g.Se(a,mQa))},W7=function(a){a.C=g.tz("yt-remote-device-id-map")||{}},X7=function(a,b,c){g.P.call(this);
this.Aa=c;this.u=a;this.i=b;this.B=null},Y7=function(a,b){a.B=b;
a.Z("sessionScreen",a.B)},IRa=function(a,b){a.B&&(a.B.token=b,V7(a.u,a.B));
a.Z("sessionScreen",a.B)},Z7=function(a,b){G7(a.Aa,b)},$7=function(a,b,c){X7.call(this,a,b,"CastSession");
var d=this;this.config_=c;this.l=null;this.Y=(0,g.C)(this.IO,this);this.ya=(0,g.C)(this.XU,this);this.ea=g.ct(function(){JRa(d,null)},12E4);
this.J=this.C=this.G=this.L=0;this.xa=!1;this.V="unknown"},a8=function(a,b){g.et(a.J);
a.J=0;0==b?KRa(a):a.J=g.ct(function(){KRa(a)},b)},KRa=function(a){LRa(a,"getLoungeToken");
g.et(a.C);a.C=g.ct(function(){MRa(a,null)},3E4)},LRa=function(a,b){a.info("sendYoutubeMessage_: "+b+" "+g.Qh(void 0));
var c={};c.type=b;a.l?a.l.sendMessage("urn:x-cast:com.google.youtube.mdx",c,g.Ia,(0,g.C)(function(){Z7(this,"Failed to send message: "+b+".")},a)):Z7(a,"Sending yt message without session: "+g.Qh(c))},b8=function(a,b){b?(a.info("onConnectedScreenId_: Received screenId: "+b),a.getScreen()&&a.getScreen().id==b||a.OI(b,function(c){Y7(a,c)},function(){return a.gg()},5)):a.gg(Error("Waiting for session status timed out."))},ORa=function(a,b,c){a.info("onConnectedScreenData_: Received screenData: "+JSON.stringify(b));
var d=new H6(b);NRa(a,d,function(e){e?(a.xa=!0,V7(a.u,d),Y7(a,d),a.V="unknown",a8(a,c)):(g.ls(Error("CastSession, RemoteScreen from screenData: "+JSON.stringify(b)+" is not online.")),a.gg())},5)},JRa=function(a,b){g.et(a.ea);
a.ea=0;b?a.config_.enableCastLoungeToken&&b.loungeToken?b.deviceId?a.getScreen()&&a.getScreen().uuid==b.deviceId||(b.loungeTokenRefreshIntervalMs?ORa(a,{name:a.i.friendlyName,screenId:b.screenId,loungeToken:b.loungeToken,dialId:b.deviceId,screenIdType:"shortLived"},b.loungeTokenRefreshIntervalMs):(g.ls(Error("No loungeTokenRefreshIntervalMs presents in mdxSessionStatusData: "+JSON.stringify(b)+".")),b8(a,b.screenId))):(g.ls(Error("No device id presents in mdxSessionStatusData: "+JSON.stringify(b)+
".")),b8(a,b.screenId)):b8(a,b.screenId):a.gg(Error("Waiting for session status timed out."))},MRa=function(a,b){g.et(a.C);
a.C=0;var c=null;if(b)if(b.loungeToken){var d;(null==(d=a.getScreen())?void 0:d.token)==b.loungeToken&&(c="staleLoungeToken")}else c="missingLoungeToken";else c="noLoungeTokenResponse";c?(a.info("Did not receive a new lounge token in onLoungeToken_ with data: "+(JSON.stringify(b)+", error: "+c)),a.V=c,a8(a,3E4)):(IRa(a,b.loungeToken),a.xa=!1,a.V="unknown",a8(a,b.loungeTokenRefreshIntervalMs))},NRa=function(a,b,c,d){g.et(a.G);
a.G=0;FRa(a.u,b,function(e){e||0>d?c(e):a.G=g.ct(function(){NRa(a,b,c,d-1)},300)})},PRa=function(a){g.et(a.L);
...
return!!(a.config_.enableDialLoungeToken&&(null==(b=a.l)?0:b.getDialAppInfo))},QRa=function(a){a.C=a.u.rG(a.ya,a.i.label,a.i.friendlyName,d8(a),function(b,c){a.C=g.Ia;
a.Y=!0;Y7(a,b);"shortLived"==b.idType&&0<c&&e8(a,c)},function(b){a.C=g.Ia;
a.gg(b)})},RRa=function(a){var b={};
b.pairingCode=a.ya;b.theme=a.Ia;zQa()&&(b.env_useStageMdx=1);return g.ui(b)},f8=function(a){return new Promise(function(b){a.ya=L6();
if(a.Ja){var c=new chrome.cast.DialLaunchResponse(!0,RRa(a));b(c);QRa(a)}else a.ea=function(){g.et(a.V);a.ea=function(){};
a.V=NaN;var d=new chrome.cast.DialLaunchResponse(!0,RRa(a));b(d);QRa(a)},a.V=g.ct(function(){a.ea()},100)})},TRa=function(a,b,c){a.info("initOnConnectedScreenDataPromise_: Received screenData: "+JSON.stringify(b));
var d=new H6(b);return(new Promise(function(e){SRa(a,d,function(f){f?(a.Y=!0,V7(a.u,d),Y7(a,d),e8(a,c)):g.ls(Error("DialSession, RemoteScreen from screenData: "+JSON.stringify(b)+" is not online."));e(f)},5)})).then(function(e){return e?new chrome.cast.DialLaunchResponse(!1):f8(a)})},URa=function(a,b){var c=a.L.receiver.label,d=a.i.friendlyName;
return(new Promise(function(e){DRa(a.u,c,b,d,function(f){f&&f.token&&Y7(a,f);e(f)},function(f){Z7(a,"Failed to get DIAL screen: "+f);
e(null)})})).then(function(e){return e&&e.token?new chrome.cast.DialLaunchResponse(!1):f8(a)})},SRa=function(a,b,c,d){g.et(a.G);
a.G=0;FRa(a.u,b,function(e){e||0>d?c(e):a.G=g.ct(function(){SRa(a,b,c,d-1)},300)})},e8=function(a,b){a.info("getDialAppInfoWithTimeout_ "+b);
d8(a)&&(g.et(a.J),a.J=0,0==b?VRa(a):a.J=g.ct(function(){VRa(a)},b))},VRa=function(a){d8(a)&&a.l.getDialAppInfo(function(b){a.info("getDialAppInfo dialLaunchData: "+JSON.stringify(b));
b=b.extraData||{};var c=null;if(b.loungeToken){var d;(null==(d=a.getScreen())?void 0:d.token)==b.loungeToken&&(c="staleLoungeToken")}else c="missingLoungeToken";c?(a.xa=c,e8(a,3E4)):(a.Y=!1,a.xa="unknown",IRa(a,b.loungeToken),e8(a,b.loungeTokenRefreshIntervalMs))},function(b){a.info("getDialAppInfo error: "+b);
a.xa="noLoungeTokenResponse";e8(a,3E4)})},WRa=function(a){g.et(a.G);
...
this.config_=b;this.l=a;this.J=b.appId||"233637DE";this.B=b.theme||"cl";this.L=b.disableCastApi||!1;this.V=b.forceMirroring||!1;this.i=null;this.G=!1;this.u=[];this.C=(0,g.C)(this.QT,this)},XRa=function(a,b){return b?g.fb(a.u,function(c){return I6(b,c.label)},a):null},i8=function(a){G7("Controller",a)},oRa=function(a){window.chrome&&chrome.cast&&chrome.cast.logMessage&&chrome.cast.logMessage(a)},j8=function(a){return a.G||!!a.u.length||!!a.i},k8=function(a,b,c){b!=a.i&&(g.jf(a.i),(a.i=b)?(c?a.Z("yt-remote-cast2-receiver-resumed",
b.i):a.Z("yt-remote-cast2-receiver-selected",b.i),b.subscribe("sessionScreen",(0,g.C)(a.YK,a,b)),b.subscribe("sessionFailed",function(){return YRa(a,b)}),b.getScreen()?a.Z("yt-remote-cast2-session-change",b.getScreen()):c&&a.i.Or(null)):a.Z("yt-remote-cast2-session-change",null))},YRa=function(a,b){a.i==b&&a.Z("yt-remote-cast2-session-failed")},ZRa=function(a){var b=a.l.qG(),c=a.i&&a.i.i;
a=g.Se(b,function(d){c&&I6(d,c.label)&&(c=null);var e=d.uuid?d.uuid:d.id,f=XRa(this,d);f?(f.label=e,f.friendlyName=d.name):(f=new chrome.cast.Receiver(e,d.name),f.receiverType=chrome.cast.ReceiverType.CUSTOM);return f},a);
c&&(c.receiverType!=chrome.cast.ReceiverType.CUSTOM&&(c=new chrome.cast.Receiver(c.label,c.friendlyName),c.receiverType=chrome.cast.ReceiverType.CUSTOM),a.push(c));return a},dSa=function(a,b,c,d){d.disableCastApi?l8("Cannot initialize because disabled by Mdx config."):$Ra()?aSa(b,d)&&(m8(!0),window.chrome&&chrome.cast&&chrome.cast.isAvailable?bSa(a,c):(window.__onGCastApiAvailable=function(e,f){e?bSa(a,c):(n8("Failed to load cast API: "+f),o8(!1),m8(!1),g.vz("yt-remote-cast-available"),g.vz("yt-remote-cast-receiver"),
cSa(),c(!1))},d.loadCastApiSetupScript?g.xz("https://www.gstatic.com/cv/js/sender/v1/cast_sender.js"):0<=window.navigator.userAgent.indexOf("Android")&&0<=window.navigator.userAgent.indexOf("Chrome/")&&window.navigator.presentation?60<=U6()&&GQa():!window.chrome||!window.navigator.presentation||0<=window.navigator.userAgent.indexOf("Edge")?W6():89<=U6()?IQa():(X6(),V6(HQa.map(DQa))))):l8("Cannot initialize because not running Chrome")},cSa=function(){l8("dispose");
var a=p8();a&&a.dispose();g.Ga("yt.mdx.remote.cloudview.instance_",null,void 0);eSa(!1);g.Su(q8);q8.length=0},r8=function(){return!!g.tz("yt-remote-cast-installed")},fSa=function(){var a=g.tz("yt-remote-cast-receiver");
return a?a.friendlyName:null},gSa=function(){l8("clearCurrentReceiver");
g.vz("yt-remote-cast-receiver")},hSa=function(){return r8()?p8()?p8().getCastSession():(n8("getCastSelector: Cast is not initialized."),null):(n8("getCastSelector: Cast API is not installed!"),null)},t8=function(){r8()?p8()?s8()?(l8("Requesting cast selector."),p8().requestSession()):(l8("Wait for cast API to be ready to request the session."),q8.push(g.Ru("yt-remote-cast2-api-ready",t8))):n8("requestCastSelector: Cast is not initialized."):n8("requestCastSelector: Cast API is not installed!")},u8=
function(a,b){s8()?p8().setConnectedScreenStatus(a,b):n8("setConnectedScreenStatus called before ready.")},$Ra=function(){var a=0<=g.Xc.search(/ (CrMo|Chrome|CriOS)\//);
return g.ej||a},iSa=function(a,b){p8().init(a,b)},aSa=function(a,b){var c=!1;
...
l8("cloudview.createSingleton_: "+c);return c},p8=function(){return g.Ha("yt.mdx.remote.cloudview.instance_")},bSa=function(a,b){o8(!0);
m8(!1);iSa(a,function(c){c?(eSa(!0),g.Tu("yt-remote-cast2-api-ready")):(n8("Failed to initialize cast API."),o8(!1),g.vz("yt-remote-cast-available"),g.vz("yt-remote-cast-receiver"),cSa());b(c)})},l8=function(a){G7("cloudview",a)},n8=function(a){G7("cloudview",a)},o8=function(a){l8("setCastInstalled_ "+a);
g.sz("yt-remote-cast-installed",a)},s8=function(){return!!g.Ha("yt.mdx.remote.cloudview.apiReady_")},eSa=function(a){l8("setApiReady_ "+a);
...
this.Pa=0;this.u=a;this.C=[];this.B=new kRa;this.l=this.i=null;this.L=(0,g.C)(this.qS,this);this.G=(0,g.C)(this.zv,this);this.J=(0,g.C)(this.pS,this);this.V=(0,g.C)(this.xS,this);var c=0;a?(c=a.getProxyState(),3!=c&&(a.subscribe("proxyStateChange",this.GE,this),jSa(this))):c=3;0!=c&&(b?this.GE(c):g.ct((0,g.C)(function(){this.GE(c)},this),0));
(a=hSa())&&C8(this,a);this.subscribe("yt-remote-cast2-session-change",this.V)},E8=function(a){return new v8(a.u.getPlayerContextData())},jSa=function(a){g.Cb("nowAutoplaying autoplayDismissed remotePlayerChange remoteQueueChange autoplayModeChange autoplayUpNext previousNextChange multiStateLoopEnabled".split(" "),function(b){this.C.push(this.u.subscribe(b,g.Pa(this.NT,b),this))},a)},kSa=function(a){g.Cb(a.C,function(b){this.u.unsubscribeByKey(b)},a);
...
a.u.setPlayerContextData(B8(b));jSa(a)},C8=function(a,b){a.l&&(a.l.removeUpdateListener(a.L),a.l.removeMediaListener(a.G),a.zv(null));
a.l=b;a.l&&(G7("CP","Setting cast session: "+a.l.sessionId),a.l.addUpdateListener(a.L),a.l.addMediaListener(a.G),a.l.media.length&&a.zv(a.l.media[0]))},lSa=function(a){var b=a.i.media,c=a.i.customData;
...
this.C=NaN;this.xa=!1;this.L=this.J=this.ea=this.Y=NaN;this.V=[];this.B=this.G=this.u=this.fc=this.i=null;this.Aa=a;this.V.push(g.iu(window,"beforeunload",(0,g.C)(this.sQ,this)));this.l=[];this.fc=new v8;this.Da=b.id;this.ya=b.idType;this.i=mSa(this,c);this.i.subscribe("handlerOpened",this.uS,this);this.i.subscribe("handlerClosed",this.rS,this);this.i.subscribe("handlerError",this.sS,this);this.i.subscribe("handlerMessage",this.tS,this);this.i.Gz(b.token);this.subscribe("remoteQueueChange",function(){var d=
this.fc.videoId;g.wz()&&g.sz("yt-remote-session-video-id",d)},this)},nSa=function(a){return g.fb(a.l,function(b){return"LOUNGE_SCREEN"==b.type})},M8=function(a){G7("conn",a)},mSa=function(a,b){return new z7(D7(a.Aa,"/bc"),b,!1,function(){return a.vG()},"shortLived"==a.ya)},N8=function(a,b){a.Z("proxyStateChange",b)},oSa=function(a){a.C=g.ct((0,g.C)(function(){M8("Connecting timeout");
this.lr(1)},a),2E4)},O8=function(a){g.et(a.C);
a.C=NaN},P8=function(a){g.et(a.Y);
a.Y=NaN},pSa=function(a){Q8(a);
a.ea=g.ct((0,g.C)(function(){R8(this,"getNowPlaying")},a),2E4)},Q8=function(a){g.et(a.ea);
a.ea=NaN},rSa=function(a,b){var c=null;
if(b){var d=nSa(a);d&&(c={clientName:d.clientName,deviceMake:d.brand,deviceModel:d.model,osVersion:d.osVersion})}g.Ga("yt.mdx.remote.remoteClient_",c,void 0);b&&(O8(a),P8(a));c=B7(a.i)&&isNaN(a.C);b==c?b&&(N8(a,1),R8(a,"getSubtitlesTrack")):b?(a.NI()&&a.fc.reset(),N8(a,1),R8(a,"getNowPlaying"),qSa(a)):a.lr(1)},sSa=function(a,b){var c=b.params.videoId;
delete b.params.videoId;c==a.fc.videoId&&(g.Sb(b.params)?a.fc.trackData=null:a.fc.trackData=b.params,a.Z("remotePlayerChange"))},tSa=function(a,b){var c=b.params.videoId||b.params.video_id,d=parseInt(b.params.currentIndex,10);
a.fc.listId=b.params.listId||a.fc.listId;A8(a.fc,c,d);a.Z("remoteQueueChange")},vSa=function(a,b){b.params=b.params||{};
tSa(a,b);uSa(a,b);a.Z("autoplayDismissed")},uSa=function(a,b){var c=parseInt(b.params.currentTime||b.params.current_time,10);
y8(a.fc,isNaN(c)?0:c);c=parseInt(b.params.state,10);c=isNaN(c)?-1:c;-1==c&&-1E3==a.fc.playerState&&(c=-1E3);a.fc.playerState=c;c=Number(b.params.loadedTime);a.fc.L=isNaN(c)?0:c;a.fc.yj(Number(b.params.duration));c=a.fc;var d=Number(b.params.liveIngestionTime);c.u=d;c.l=isNaN(d)?!1:!0;c=a.fc;d=Number(b.params.seekableStartTime);b=Number(b.params.seekableEndTime);c.B=isNaN(d)?0:d;c.i=isNaN(b)?0:b;1==a.fc.playerState?pSa(a):Q8(a);a.Z("remotePlayerChange")},wSa=function(a,b){if(-1E3!=a.fc.playerState){var c=
1085;
switch(parseInt(b.params.adState,10)){case 1:c=1081;break;case 2:c=1084;break;case 0:c=1083}a.fc.playerState=c;b=parseInt(b.params.currentTime,10);y8(a.fc,isNaN(b)?0:b);a.Z("remotePlayerChange")}},xSa=function(a,b){var c="true"==b.params.muted;
a.fc.volume=parseInt(b.params.volume,10);a.fc.muted=c;a.Z("remotePlayerChange")},ySa=function(a,b){a.G=b.params.videoId;
a.Z("nowAutoplaying",parseInt(b.params.timeout,10))},zSa=function(a,b){var c="true"==b.params.hasNext;
a.fc.qk="true"==b.params.hasPrevious;a.fc.hasNext=c;a.Z("previousNextChange")},qSa=function(a){g.et(a.L);
...
this.Ie=a;this.i=[];this.i.push(this.Ie.$_s("screenChange",(0,g.C)(this.NO,this)));this.i.push(this.Ie.$_s("onlineScreenChange",(0,g.C)(this.uT,this)))},DSa=function(a,b){yQa();
if(!T6||!T6.get("yt-remote-disable-remote-module-for-dev")){b=g.N("MDX_CONFIG")||b;qQa();R6();T8||(T8=new C7(b?b.loungeApiHost:void 0),zQa()&&(T8.i="/api/loungedev"));U8||(U8=g.Ha("yt.mdx.remote.deferredProxies_")||[],g.Ga("yt.mdx.remote.deferredProxies_",U8,void 0));ASa();var c=V8();if(!c){var d=new U7(T8,b?b.disableAutomaticScreenCache||!1:!1);g.Ga("yt.mdx.remote.screenService_",d,void 0);c=V8();var e={};b&&(e={appId:b.appId,disableDial:b.disableDial,theme:b.theme,loadCastApiSetupScript:b.loadCastApiSetupScript,
disableCastApi:b.disableCastApi,enableDialLoungeToken:b.enableDialLoungeToken,enableCastLoungeToken:b.enableCastLoungeToken,forceMirroring:b.forceMirroring});dSa(a,d,function(f){f?W8()&&u8(W8(),"YouTube TV"):d.subscribe("onlineScreenChange",function(){F6("yt-remote-receiver-availability-change")})},e)}b&&!g.Ha("yt.mdx.remote.initialized_")&&(g.Ga("yt.mdx.remote.initialized_",!0,void 0),X8("Initializing: "+g.Qh(b)),Y8.push(g.Ru("yt-remote-cast2-availability-change",function(){F6("yt-remote-receiver-availability-change")})),
Y8.push(g.Ru("yt-remote-cast2-receiver-selected",function(){Z8(null);
F6("yt-remote-auto-connect","cast-selector-receiver")})),Y8.push(g.Ru("yt-remote-cast2-receiver-resumed",function(){F6("yt-remote-receiver-resumed","cast-selector-receiver")})),Y8.push(g.Ru("yt-remote-cast2-session-change",BSa)),Y8.push(g.Ru("yt-remote-connection-change",function(f){f?u8(W8(),"YouTube TV"):$8()||(u8(null,null),gSa())})),Y8.push(g.Ru("yt-remote-cast2-session-failed",function(){F6("yt-remote-connection-failed")})),a=a9(),b.isAuto&&(a.id+="#dial"),e=b.capabilities||[],g.gs("desktop_enable_autoplay")&&
e.push("atp"),0<e.length&&(a.capabilities=e),a.name=b.device,a.app=b.app,(b=b.theme)&&(a.theme=b),X8(" -- with channel params: "+g.Qh(a)),a?(g.sz("yt-remote-session-app",a.app),g.sz("yt-remote-session-name",a.name)):(g.vz("yt-remote-session-app"),g.vz("yt-remote-session-name")),g.Ga("yt.mdx.remote.channelParams_",a,void 0),c.start(),W8()||CSa())}},ESa=function(){var a=V8().Ie.$_gos();
var b=b9();b&&c9()&&(M6(a,b)||a.push(b));return pQa(a)},d9=function(){var a=FSa();
!a&&r8()&&fSa()&&(a={key:"cast-selector-receiver",name:fSa()});return a},FSa=function(){var a=ESa(),b=b9();
b||(b=$8());return g.fb(a,function(c){return b&&I6(b,c.key)?!0:!1})},b9=function(){var a=W8();
if(!a)return null;var b=V8().Ch();return N6(b,a)},BSa=function(a){X8("remote.onCastSessionChange_: "+J6(a));
...
j9=a?new S8(a):null}return j9},W8=function(){return g.Ha("yt.mdx.remote.currentScreenId_")},GSa=function(a){g.Ga("yt.mdx.remote.currentScreenId_",a,void 0)},HSa=function(){return g.Ha("yt.mdx.remote.connectData_")},Z8=function(a){g.Ga("yt.mdx.remote.connectData_",a,void 0)},c9=function(){return g.Ha("yt.mdx.remote.connection_")},h9=function(a){var b=c9();
Z8(null);a||GSa("");g.Ga("yt.mdx.remote.connection_",a,void 0);U8&&(g.Cb(U8,function(c){c(a)}),U8.length=0);
...
b9()&&b9();k9?e9=a:(GSa(a.id),a=new L8(T8,a,a9()),a.connect(b,HSa()),a.subscribe("beforeDisconnect",function(c){F6("yt-remote-before-disconnect",c)}),a.subscribe("beforeDispose",function(){c9()&&(c9(),h9(null))}),a.subscribe("browserChannelAuthError",function(){var c=b9();
c&&"shortLived"==c.idType&&(s8()?p8().handleBrowserChannelAuthError():n8("refreshLoungeToken called before API ready."))}),h9(a))},CSa=function(){var a=$8();
a?(X8("Resume connection to: "+J6(a)),g9(a,0)):(S6(),gSa(),X8("Skipping connecting because no session screen found."))},ASa=function(){var a=a9();
...
var d=this;this.l=a;this.I=b;this.Pb=c;this.events=new g.fN(this);this.ea=this.events.N(this.I,"onVolumeChange",function(e){ISa(d,e)});
...
if(null===c||void 0===c?0:c.listId){var d=c.index;var e=c.listId.toString()}c=a.I.getVideoData(1);a.Pb.playVideo(c.videoId,b,d,e,c.playerParams,c.La,fQa(c));a.Lb(new g.nK(1))},KSa=function(a,b){if(b){var c=a.I.getOption("captions","tracklist",{iJ:1});
...
K:"ytp-mdx-manual-pairing-popup-dialog",U:{role:"dialog"},T:[{D:"div",K:"ytp-mdx-manual-pairing-popup-dialog-inner-content",T:[{D:"div",K:"ytp-mdx-manual-pairing-popup-title",ra:"Nous allons bient\u00f4t supprimer la possibilit\u00e9 de se connecter \u00e0 un t\u00e9l\u00e9viseur via Internet \u00e0 l'aide d'un code"},{D:"div",K:"ytp-mdx-manual-pairing-popup-buttons",T:[{D:"button",Ea:["ytp-button","ytp-mdx-manual-pairing-popup-learn-more"],ra:"En savoir plus"},{D:"button",Ea:["ytp-button","ytp-mdx-manual-pairing-popup-ok"],
ra:"OK"}]}]}]});this.i=new g.TL(this,250);this.learnMoreButton=this.Ca("ytp-mdx-manual-pairing-popup-learn-more");this.okButton=this.Ca("ytp-mdx-manual-pairing-popup-ok");g.F(this,this.i);this.N(this.learnMoreButton,"click",this.l);this.N(this.okButton,"click",this.u)},q9=function(){g.V.call(this,{D:"div",
K:"ytp-mdx-popup-dialog",U:{role:"dialog"},T:[{D:"div",K:"ytp-mdx-popup-dialog-inner-content",T:[{D:"div",K:"ytp-mdx-popup-title",ra:"Vous \u00eates d\u00e9connect\u00e9"},{D:"div",K:"ytp-mdx-popup-description",ra:"Les vid\u00e9os que vous visionnez peuvent \u00eatre ajout\u00e9es \u00e0 l'historique des vid\u00e9os regard\u00e9es sur votre t\u00e9l\u00e9viseur et avoir une influence sur les recommandations qui vous sont faites. Pour \u00e9viter ce probl\u00e8me, annulez et connectez-vous \u00e0 YouTube sur un ordinateur."},
{D:"div",K:"ytp-mdx-privacy-popup-buttons",T:[{D:"button",Ea:["ytp-button","ytp-mdx-privacy-popup-cancel"],ra:"Annuler"},{D:"button",Ea:["ytp-button","ytp-mdx-privacy-popup-confirm"],ra:"Confirmer"}]}]}]});this.i=new g.TL(this,250);this.cancelButton=this.Ca("ytp-mdx-privacy-popup-cancel");this.confirmButton=this.Ca("ytp-mdx-privacy-popup-confirm");g.F(this,this.i);this.N(this.cancelButton,"click",this.l);this.N(this.confirmButton,"click",this.u)},r9=function(a){g.V.call(this,{D:"div",
K:"ytp-remote",T:[{D:"div",K:"ytp-remote-display-status",T:[{D:"div",K:"ytp-remote-display-status-icon",T:[g.Dra()]},{D:"div",K:"ytp-remote-display-status-text",ra:"{{statustext}}"}]}]});this.api=a;this.i=new g.TL(this,250);g.F(this,this.i);this.N(a,"presentingplayerstatechange",this.l);LSa(this,a.ub())},LSa=function(a,b){if(3===a.api.getPresentingPlayerType()){var c={RECEIVER_NAME:a.api.getOption("remote","currentReceiver").name};
b=g.U(b,128)?g.NI("Erreur sur $RECEIVER_NAME",c):b.xc()||g.U(b,4)?g.NI("Lecture sur $RECEIVER_NAME",c):g.NI("Connect\u00e9 \u00e0 $RECEIVER_NAME",c);a.Ra("statustext",b);a.i.show()}else a.i.hide()},s9=function(a,b){g.eQ.call(this,"Lire sur",0,a,b);
...
this.lj={key:L6(),name:"Cet ordinateur"};this.Sh=null;this.subscriptions=[];this.fE=this.Pb=null;this.Mn=[this.lj];this.Hm=this.lj;this.md=new g.nK(64);this.HJ=0;this.kf=-1;this.Sr=null;this.Mv=this.Dy=!1;this.Wl=this.gs=null;if(!g.EF(this.player.S())&&!g.FF(this.player.S())){a=this.player;var b=g.TM(a);b&&(b=b.Vm())&&(b=new s9(a,b),g.F(this,b));b=new r9(a);g.F(this,b);g.cN(a,b.element,4);this.gs=new q9;g.F(this,this.gs);g.cN(a,this.gs.element,4);g.S(this.player.S().experiments,"pair_servlet_deprecation_warning_enabled")&&
!g.S(this.player.S().experiments,"deprecate_pair_servlet_enabled")&&(this.Sr=new p9,g.F(this,this.Sr),g.cN(a,this.Sr.element,4));this.Mv=!!$8();this.Dy=!!g.tz("yt-remote-manual-pairing-warning-shown")}},u9=function(a){a.Wl&&(a.player.removeEventListener("presentingplayerstatechange",a.Wl),a.Wl=null)},MSa=function(a,b,c){a.md=c;
a.player.Z("presentingplayerstatechange",new g.AI(c,b))},NSa=function(a,b,c){var d=!1;
1===b?d=!a.Mv:2===b&&(d=!a.Dy);d&&g.CI(c,8)&&(a.player.pauseVideo(),u9(a))},v9=function(a,b){if(b.key!==a.Hm.key)if(b.key===a.lj.key)f9();
else{if(a.Sr&&!a.Dy&&b!==a.lj&&"cast-selector-receiver"!==b.key&&g.WF(a.player.S()))OSa(a);else{var c;(c=!g.S(a.player.S().experiments,"mdx_enable_privacy_disclosure_ui"))||(c=((c=g.N("PLAYER_CONFIG"))&&c.args&&void 0!==c.args.authuser?!0:!(!g.N("SESSION_INDEX")&&!g.N("LOGGED_IN")))||a.Mv||!a.gs);(c?0:g.WF(a.player.S())||g.$F(a.player.S()))&&PSa(a)}a.Hm=b;if(!a.player.S().X("disable_mdx_connection_in_mdx_module_for_music_web")||!g.FF(a.player.S())){var d=a.player.getPlaylistId();c=a.player.getVideoData(1);
var e=c.videoId;if(!d&&!e||(2===a.player.getAppState()||1===a.player.getAppState())&&g.S(a.player.S().experiments,"should_clear_video_data_on_player_cued_unstarted"))a=null;else{var f=a.player.getPlaylist();if(f){var h=[];for(var l=0;l<f.length;l++)h[l]=f.ib(l).videoId}else h=[e];f=a.player.getCurrentTime(1);a={videoIds:h,listId:d,videoId:e,playerParams:c.playerParams,clickTrackingParams:c.La,index:Math.max(a.player.getPlaylistIndex(),0),currentTime:0===f?void 0:f};(c=fQa(c))&&(a.locationInfo=c)}X8("Connecting to: "+
g.Qh(b));"cast-selector-receiver"==b.key?(Z8(a||null),b=a||null,s8()?p8().setLaunchParams(b):n8("setLaunchParams called before ready.")):!a&&i9()&&W8()==b.key?F6("yt-remote-connection-change",!0):(f9(),Z8(a||null),a=V8().Ch(),(b=N6(a,b.key))&&g9(b,1))}}},PSa=function(a){a.player.ub().xc()?a.player.pauseVideo():(a.Wl=function(b){NSa(a,1,b)},a.player.addEventListener("presentingplayerstatechange",a.Wl));
a.gs&&a.gs.Yc();c9()||(k9=!0)},OSa=function(a){a.player.ub().xc()?a.player.pauseVideo():(a.Wl=function(b){NSa(a,2,b)},a.player.addEventListener("presentingplayerstatechange",a.Wl));
a.Sr&&a.Sr.Yc();c9()||(k9=!0)},PQa={"\x00":"\\0",
"\b":"\\b","\f":"\\f","\n":"\\n","\r":"\\r","\t":"\\t","\x0B":"\\x0B",'"':'\\"',"\\":"\\\\","<":"\\u003C"},l7={"'":"\\'"},lQa={iX:"atp",Z6:"ska",P5:"que",Z3:"mus",Y6:"sus",j0:"dsp",j6:"seq",C3:"mic",h_:"dpa",wX:"cds",X3:"mlm"},T6,P6="",FQa=AQa("loadCastFramework")||AQa("loadCastApplicationFramework"),HQa=["pkedcjkdefgpdelpbcmbmeomcjbeemfm","enhhojjnijigcajfphajepfemndkmdlo"];/*
...
g.k.dV=function(){var a=g.Pi(this.We),b=g.Ui(this.We);this.Dw<b.length&&(m7(this),OQa(this,a,b),this.Bj&&4!=a&&g7(this))};
...
g.k.UU=function(){this.Ls=null;var a=Date.now();0<=a-this.vF?(2!=this.Es&&this.i.nj(3),j7(this),this.tm=2,d7(18),k7(this)):RQa(this,this.vF-a)};
g.k.getLastError=function(){return this.tm};g.k=UQa.prototype;g.k.XA=null;g.k.hh=null;g.k.sz=!1;g.k.XL=null;g.k.wx=null;g.k.nD=null;g.k.YA=null;g.k.Pa=null;g.k.Uk=-1;g.k.ut=null;g.k.Lt=null;g.k.connect=function(a){this.YA=a;a=o7(this.i,null,this.YA);d7(3);this.XL=Date.now();var b=this.i.J;null!=b?(this.ut=b[0],(this.Lt=b[1])?(this.Pa=1,VQa(this)):(this.Pa=2,q7(this))):(C6(a,"MODE","init"),this.hh=new e7(this,void 0,void 0,void 0),this.hh.Bo=this.XA,f7(this.hh,a,!1,null,!0),this.Pa=0)};
...
g.k.Pw=function(){this.Uk=this.hh.qt;if(this.hh.Bj)0==this.Pa?this.Lt?(this.Pa=1,VQa(this)):(this.Pa=2,q7(this)):2==this.Pa&&((!g.ie||g.ce(10)?!this.sz:200>this.nD-this.wx)?(d7(11),p7(this.i,this,!1)):(d7(12),p7(this.i,this,!0)));else{0==this.Pa?d7(9):2==this.Pa&&d7(10);var a=this.i;this.hh.getLastError();a.Uj=this.Uk;x7(a,2)}};
g.k.gw=function(){return this.i.gw()};
g.k.isActive=function(){return this.i.isActive()};
g.k.nj=function(a){this.i.nj(a)};g.k=r7.prototype;g.k.Tj=null;g.k.ju=null;g.k.Og=null;g.k.Ae=null;g.k.ZA=null;g.k.xx=null;g.k.CH=null;g.k.Qw=null;g.k.ov=0;g.k.GR=0;g.k.If=null;g.k.Mm=null;g.k.ql=null;g.k.Xo=null;g.k.Fm=null;g.k.eA=null;g.k.Nr=-1;g.k.GJ=-1;g.k.Uj=-1;g.k.wr=0;g.k.Tq=0;g.k.Po=8;g.Sa(XQa,g.mf);g.Sa(YQa,g.mf);g.k=r7.prototype;g.k.connect=function(a,b,c,d,e){d7(0);this.ZA=b;this.ju=c||{};d&&void 0!==e&&(this.ju.OSID=d,this.ju.OAID=e);this.C?(b7((0,g.C)(this.VH,this,a),100),bRa(this)):this.VH(a)};
g.k.VH=function(a){this.Fm=new UQa(this);this.Fm.XA=this.Tj;this.Fm.l=this.B;this.Fm.connect(a)};
g.k.gf=function(){return 0==this.Pa};
g.k.getState=function(){return this.Pa};
g.k.aL=function(a){this.Mm=null;fRa(this,a)};
g.k.ZK=function(){this.ql=null;this.Ae=new e7(this,this.l,"rpc",this.G);this.Ae.Bo=this.Tj;this.Ae.WA=0;var a=this.CH.clone();g.rk(a,"RID","rpc");g.rk(a,"SID",this.l);g.rk(a,"CI",this.eA?"0":"1");g.rk(a,"AID",this.Nr);s7(this,a);if(!g.ie||g.ce(10))g.rk(a,"TYPE","xmlhttp"),f7(this.Ae,a,!0,this.Qw,!1);else{g.rk(a,"TYPE","html");var b=this.Ae,c=!!this.Qw;b.Es=3;b.Am=B6(a.clone());QQa(b,c)}};
...
a&&u7(this),!g.tc(b))for(a=this.B.parse(b),b=0;b<a.length;b++)c=a[b],this.Nr=c[0],c=c[1],2==this.Pa?"c"==c[0]?(this.l=c[1],this.Qw=c[2],c=c[3],null!=c?this.Po=c:this.Po=6,this.Pa=3,this.If&&this.If.RH(),this.CH=o7(this,this.gw()?this.Qw:null,this.ZA),gRa(this)):"stop"==c[0]&&x7(this,7):3==this.Pa&&("stop"==c[0]?x7(this,7):"noop"!=c[0]&&this.If&&this.If.QH(c),this.Tq=0)};
g.k.kS=function(){null!=this.Xo&&(this.Xo=null,this.Ae.cancel(),this.Ae=null,w7(this),d7(20))};
g.k.Pw=function(a){if(this.Ae==a){u7(this);this.Ae=null;var b=2}else if(this.Og==a)this.Og=null,b=1;else return;this.Uj=a.qt;if(0!=this.Pa)if(a.Bj)if(1==b){b=Date.now()-a.qs;var c=c7;c.dispatchEvent(new XQa(c,a.Up?a.Up.length:0,b,this.wr));t7(this);this.u.length=0}else gRa(this);else{c=a.getLastError();var d;if(!(d=3==c||7==c||0==c&&0<this.Uj)){if(d=1==b)this.Og||this.Mm||1==this.Pa||2<=this.wr?d=!1:(this.Mm=b7((0,g.C)(this.aL,this,a),hRa(this,this.wr)),this.wr++,d=!0);d=!(d||2==b&&w7(this))}if(d)switch(c){case 1:x7(this,
...
g.k.QV=function(a){a?d7(2):(d7(1),iRa(this,8))};
...
g.k.nj=function(a){var b=c7;b.dispatchEvent(new YQa(b,a))};
g.k.gw=function(){return!(!g.ie||g.ce(10))};
g.k=jRa.prototype;g.k.RH=function(){};
g.k.QH=function(){};
g.k.PH=function(){};
g.k.OB=function(){};
...
g.k.isActive=function(){return this.i.isActive()};
g.k.reset=function(){this.i.stop();this.Nf=5E3};g.Sa(z7,jRa);g.k=z7.prototype;g.k.subscribe=function(a,b,c){return this.u.subscribe(a,b,c)};
...
g.k.dispose=function(){this.ea||(this.ea=!0,g.jf(this.u),nRa(this),g.jf(this.l),this.l=null,this.Y=function(){return""})};
g.k.isDisposed=function(){return this.ea};
g.k.connect=function(a,b,c){if(!this.i||2!=this.i.getState()){this.V="";this.l.stop();this.C=a||null;this.B=b||0;a=this.xa+"/test";b=this.xa+"/bind";var d=new r7(c?c.firstTestResults:null,c?c.secondTestResults:null,this.ya),e=this.i;e&&(e.If=null);d.If=this;this.i=d;A7(this);if(this.i){d=g.N("ID_TOKEN");var f=this.i.Tj||{};d?f["x-youtube-identity-token"]=d:delete f["x-youtube-identity-token"];this.i.Tj=f}e?(3!=e.getState()&&0==dRa(e)||e.getState(),this.i.connect(a,b,this.G,e.l,e.Nr)):c?this.i.connect(a,
b,this.G,c.sessionId,c.arrayId):this.i.connect(a,b,this.G)}};
g.k.sendMessage=function(a,b){a={_sc:a};b&&g.Zb(a,b);this.l.isActive()||2==(this.i?this.i.getState():0)?this.J.push(a):B7(this)&&(A7(this),cRa(this.i,a))};
g.k.RH=function(){this.l.reset();this.C=null;this.B=0;if(this.J.length){var a=this.J;this.J=[];for(var b=0,c=a.length;b<c;++b)cRa(this.i,a[b])}this.Z("handlerOpened")};
...
g.k.QH=function(a){"S"==a[0]?this.V=a[1]:"gracefulReconnect"==a[0]?(this.l.start(),aRa(this.i)):this.Z("handlerMessage",new lRa(a[0],a[1]))};
...
g.k.vV=function(){this.l.isActive();0==dRa(this.i)&&this.connect(this.C,this.B)};C7.prototype.B=function(a,b,c,d){b?a(d):a({text:c.responseText})};
C7.prototype.u=function(a,b){a(Error("Request error: "+b.status))};
C7.prototype.C=function(a){a(Error("request timed out"))};var uRa=Date.now(),F7=null,I7=Array(50),H7=-1,J7=!1;g.Sa(K7,g.P);K7.prototype.Ch=function(){return this.screens};
...
g.k.EO=function(a){this.i=null;a.status&&404==a.status?this.l>=QSa.length?this.Z("pairingFailed",Error("DIAL polling timed out")):(a=QSa[this.l],this.Hb=g.ct((0,g.C)(this.jL,this),a),this.l++):this.Z("pairingFailed",Error("Server error "+a.status))};
g.k.GO=function(){this.i=null;this.Z("pairingFailed",Error("Server not responding"))};
var QSa=[2E3,2E3,1E3,1E3,1E3,2E3,2E3,5E3,5E3,1E4];g.Sa(N7,K7);g.k=N7.prototype;g.k.start=function(){M7(this)&&this.Z("screenChange");!g.tz("yt-remote-lounge-token-expiration")&&yRa(this);g.et(this.i);this.i=g.ct((0,g.C)(this.start,this),1E4)};
g.k.add=function(a,b){M7(this);vRa(this,a);O7(this,!1);this.Z("screenChange");b(a);a.token||yRa(this)};
g.k.remove=function(a,b){var c=M7(this);xRa(this,a)&&(O7(this,!1),c=!0);b(a);c&&this.Z("screenChange")};
...
g.k.rE=function(){g.et(this.u);this.u=NaN;this.l&&this.l.abort();var a=ARa(this);if(D6(a)){var b=D7(this.C,"/pairing/get_screen_availability");this.l=E7(this.C,b,{lounge_token:g.Mb(a).join(",")},(0,g.C)(this.lU,this,a),(0,g.C)(this.kU,this))}else S7(this,{}),T7(this)};
g.k.lU=function(a,b){this.l=null;var c=g.Mb(ARa(this));if(g.Ab(c,g.Mb(a))){b=b.screens||[];c={};for(var d=0,e=b.length;d<e;++d)c[a[b[d].loungeToken]]="online"==b[d].status;S7(this,c);T7(this)}else this.Wd("Changing Screen set during request."),this.rE()};
...
g.k.HO=function(a,b,c,d){g.jt(D7(this.B,"/pairing/get_screen"),{method:"POST",postParams:{pairing_code:a},timeout:5E3,onSuccess:(0,g.C)(function(e,f){e=new H6(f.screen||{});if(!e.name||ERa(this,e.name)){a:{f=e.name;for(var h=2,l=b(f,h);ERa(this,l);){h++;if(20<h)break a;l=b(f,h)}f=l}e.name=f}c(V7(this,e))},this),
...
g.k.GQ=function(){GRa(this);this.Z("screenChange");this.i.update()};
...
g.k.va=function(){this.EE("");X7.Vd.va.call(this)};g.v($7,X7);g.k=$7.prototype;g.k.DE=function(a){if(this.l){if(this.l==a)return;Z7(this,"Overriding cast session with new session object");PRa(this);this.xa=!1;this.V="unknown";this.l.removeUpdateListener(this.Y);this.l.removeMessageListener("urn:x-cast:com.google.youtube.mdx",this.ya)}this.l=a;this.l.addUpdateListener(this.Y);this.l.addMessageListener("urn:x-cast:com.google.youtube.mdx",this.ya);LRa(this,"getMdxSessionStatus")};
...
g.k.EE=function(){};
g.k.va=function(){this.info("disposeInternal");PRa(this);this.l&&(this.l.removeUpdateListener(this.Y),this.l.removeMessageListener("urn:x-cast:com.google.youtube.mdx",this.ya));this.l=null;X7.prototype.va.call(this)};
g.k.XU=function(a,b){if(!this.isDisposed())if(b)if(b=E6(b),g.Ma(b))switch(a=""+b.type,b=b.data||{},this.info("onYoutubeMessage_: "+a+" "+g.Qh(b)),a){case "mdxSessionStatus":JRa(this,b);break;case "loungeToken":MRa(this,b);break;default:Z7(this,"Unknown youtube message: "+a)}else Z7(this,"Unable to parse message.");else Z7(this,"No data in message.")};
g.k.OI=function(a,b,c,d){g.et(this.L);this.L=0;DRa(this.u,this.i.label,a,this.i.friendlyName,(0,g.C)(function(e){e?b(e):0<=d?(Z7(this,"Screen "+a+" appears to be offline. "+d+" retries left."),this.L=g.ct((0,g.C)(this.OI,this,a,b,c,d-1),300)):c(Error("Unable to fetch screen."))},this),c)};
...
g.k.stop=function(){WRa(this);this.l?this.l.stop((0,g.C)(this.gg,this,null),(0,g.C)(this.gg,this,"Failed to stop DIAL device.")):this.gg()};
g.k.va=function(){WRa(this);this.l&&this.l.removeUpdateListener(this.Da);this.l=null;X7.prototype.va.call(this)};
...
g.k.va=function(){this.l.unsubscribe("onlineScreenChange",(0,g.C)(this.tG,this));window.chrome&&chrome.cast&&chrome.cast.removeReceiverActionListener(this.C);var a=oRa,b=g.Ha("yt.mdx.remote.debug.handlers_");g.ob(b||[],a);g.jf(this.i);g.P.prototype.va.call(this)};
...
this.Z("yt-remote-cast2-session-change",this.i.getScreen()),Promise.resolve(new chrome.cast.DialLaunchResponse(!1));this.Wd('Changing CAST intent from "'+c.receiverType+'" to "dial" for '+b.friendlyName);k8(this,new c8(this.l,b,this.B,this.config_))}b=this.i;b.L=a;b.L.appState==chrome.cast.DialAppState.RUNNING?(a=b.L.extraData||{},c=a.screenId||null,d8(b)&&a.loungeToken?a.loungeTokenRefreshIntervalMs?a=TRa(b,{name:b.i.friendlyName,screenId:a.screenId,loungeToken:a.loungeToken,dialId:b.L.receiver.label,
screenIdType:"shortLived"},a.loungeTokenRefreshIntervalMs):(g.ls(Error("No loungeTokenRefreshIntervalMs presents in additionalData: "+JSON.stringify(a)+".")),a=URa(b,c)):a=URa(b,c)):a=f8(b);return a};
...
g.k.tG=function(){this.isDisposed()||(this.u=ZRa(this),i8("Updating custom receivers: "+g.Qh(this.u)),chrome.cast.setCustomReceivers(this.u,g.Ia,(0,g.C)(function(){this.Wd("Failed to set custom receivers.")},this)),this.Z("yt-remote-cast2-availability-change",j8(this)))};
...
g.k.va=function(){kSa(this);this.u=null;this.B.clear();C8(this,null);g.P.prototype.va.call(this)};
...
g.k.zv=function(a){G7("CP","Cast media: "+!!a);this.i&&this.i.removeUpdateListener(this.J);if(this.i=a)this.i.addUpdateListener(this.J),lSa(this),this.Z("remotePlayerChange")};
g.k.pS=function(a){a?(lSa(this),this.Z("remotePlayerChange")):this.zv(null)};
g.k.ZE=function(){J8(this,"sendDebugCommand",{debugCommand:"stats4nerds "})};
g.k.xS=function(){var a=hSa();a&&C8(this,a)};
...
3;y8(this.fc,p);this.B="UNSUPPORTED";c=c?"setInitialState":"setPlaylist";M8("Connecting with "+c+" and params: "+g.Qh(n));this.i.connect({method:c,params:g.Qh(n)},a,tQa())}else M8("Connecting without params"),this.i.connect({},a,tQa());oSa(this)};
...
rSa(this,a);a=this.sJ("mlm");this.Z("multiStateLoopEnabled",a);break;case "loungeScreenDisconnected":g.pb(this.l,function(c){return"LOUNGE_SCREEN"==c.type});
rSa(this,!1);break;case "remoteConnected":var b=new G6(E6(a.params.device));g.fb(this.l,function(c){return b?c.id==b.id:!1})||gQa(this.l,b);
break;case "remoteDisconnected":b=new G6(E6(a.params.device));g.pb(this.l,function(c){return b?c.id==b.id:!1});
break;case "gracefulDisconnect":break;case "playlistModified":tSa(this,a);break;case "nowPlaying":vSa(this,a);break;case "onStateChange":uSa(this,a);break;case "onAdStateChange":wSa(this,a);break;case "onVolumeChanged":xSa(this,a);break;case "onSubtitlesTrackChanged":sSa(this,a);break;case "nowAutoplaying":ySa(this,a);break;case "autoplayDismissed":this.Z("autoplayDismissed");break;case "autoplayUpNext":this.G=a.params.videoId||null;this.Z("autoplayUpNext",this.G);break;case "onAutoplayModeChanged":this.B=
a.params.autoplayMode;this.Z("autoplayModeChange",this.B);"DISABLED"==this.B&&this.Z("autoplayDismissed");break;case "onHasPreviousNextChanged":zSa(this,a);break;case "requestAssistedSignIn":this.Z("assistedSignInRequested",a.params.authCode);break;case "onLoopModeChanged":this.Z("loopModeChange",a.params.loopMode);break;default:M8("Unrecognized action: "+a.action)}};
...
g.k.lr=function(a){M8("Disconnecting with "+a);g.Ga("yt.mdx.remote.remoteClient_",null,void 0);O8(this);this.Z("beforeDisconnect",a);1==a&&S6();nRa(this.i,a);this.dispose()};
...
g.k.zV=function(a,b){R8(this,a,b);qSa(this)};
...
g.k.eT=function(){g.Sb(this.B)||KSa(this,this.B);this.C=!1};
...
break;case -1:this.Lb(new g.nK(64));break;case -1E3:this.Lb(new g.nK(128,{errorCode:"mdx.remoteerror",errorMessage:"Cette vid\u00e9o ne peut pas \u00eatre visionn\u00e9e \u00e0 distance."}))}a=E8(this.Pb).trackData;var b=this.B;(a||b?a&&b&&a.trackName==b.trackName&&a.languageCode==b.languageCode&&a.languageName==b.languageName&&a.kind==b.kind:1)||(this.B=a,KSa(this,a));a=E8(this.Pb);-1===a.volume||Math.round(this.I.getVolume())===a.volume&&this.I.isMuted()===a.muted||this.V.isActive()||this.DM()}else JSa(this)};
g.k.RK=function(){this.I.Z("mdxpreviousnextchange")};
g.k.cz=function(){m9(this)||JSa(this)};
...
g.k.DM=function(){var a=this;if(m9(this)){var b=E8(this.Pb);this.events.hc(this.ea);b.muted?this.I.mute():this.I.unMute();this.I.setVolume(b.volume);this.ea=this.events.N(this.I,"onVolumeChange",function(c){ISa(a,c)})}};
...
g.k.Lb=function(a){this.u.stop();var b=this.G;if(!g.sK(b,a)){var c=g.U(a,2);c!==g.U(this.G,2)&&this.I.xs(c);this.G=a;MSa(this.l,b,a)}};g.v(p9,g.V);p9.prototype.Yc=function(){this.i.show()};
...
q9.prototype.u=function(){F6("mdx-privacy-popup-confirm");this.Bb()};g.v(r9,g.V);r9.prototype.l=function(a){LSa(this,a.state)};g.v(s9,g.eQ);s9.prototype.C=function(){var a=this.I.getOption("remote","receivers");a&&1<a.length&&!this.I.getOption("remote","quickCast")?(this.Mn=g.Db(a,this.i,this),g.fQ(this,g.Se(a,this.i)),a=this.I.getOption("remote","currentReceiver"),a=this.i(a),this.options[a]&&this.Ph(a),this.enable(!0)):this.enable(!1)};
s9.prototype.i=function(a){return a.key};
s9.prototype.Vi=function(a){return"cast-selector-receiver"===a?"Caster sur\u2026":this.Mn[a].name};
...
g.k.load=function(){this.player.cancelPlayback();g.oN.prototype.load.call(this);this.Sh=new l9(this,this.player,this.Pb);var a=(a=HSa())?a.currentTime:0;var b=i9()?new D8(c9(),void 0):null;0==a&&b&&(a=z8(E8(b)));0!==a&&this.Rb(a);MSa(this,this.md,this.md);this.player.Lk(6)};
...
g.k.TK=function(){var a=[this.lj],b=a.concat,c=ESa();r8()&&g.tz("yt-remote-cast-available")&&c.push({key:"cast-selector-receiver",name:"Cast..."});this.Mn=b.call(a,c);a=d9()||this.lj;v9(this,a);this.player.Ma("onMdxReceiversChange")};
