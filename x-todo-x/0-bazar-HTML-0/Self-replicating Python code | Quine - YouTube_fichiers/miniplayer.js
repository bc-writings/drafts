...
fill:"#fff","fill-rule":"nonzero"}}]}]}]};var e="Ouvrir la page de la vid\u00e9o";a.O().ia("kevlar_miniplayer_expand_top")&&(c="ytp-miniplayer-button-top-left",d=g.W?{D:"div",Y:["ytp-icon","ytp-icon-expand-miniplayer"]}:{D:"svg",P:{height:"24px",version:"1.1",viewBox:"0 0 24 24",width:"24px"},K:[{D:"g",P:{fill:"none","fill-rule":"evenodd",stroke:"none","stroke-width":"1"},K:[{D:"g",P:{transform:"translate(12.000000, 12.000000) scale(-1, 1) translate(-12.000000, -12.000000) "},K:[{D:"path",P:{d:"M19,19 L5,19 L5,5 L12,5 L12,3 L5,3 C3.89,3 3,3.9 3,5 L3,19 C3,20.1 3.89,21 5,21 L19,21 C20.1,21 21,20.1 21,19 L21,12 L19,12 L19,19 Z M14,3 L14,5 L17.59,5 L7.76,14.83 L9.17,16.24 L19,6.41 L19,10 L21,10 L21,3 L14,3 Z",
fill:"#fff","fill-rule":"nonzero"}}]}]}]},e="Agrandir");g.U.call(this,{D:"button",Y:["ytp-miniplayer-expand-watch-page-button","ytp-button",c],P:{title:"{{title}}","data-tooltip-target-id":"ytp-miniplayer-expand-watch-page-button"},K:[d]});this.H=a;this.na("click",this.onClick,this);this.ma("title",g.bO(a,e,"i"));g.Je(this,g.OO(b.tb(),this.element))},P5=function(a){g.U.call(this,{D:"div",
J:"ytp-miniplayer-ui"});this.ol=!1;this.player=a;this.L(a,"minimized",this.Si);this.L(a,"onStateChange",this.nP)},Q5=function(a){g.uN.call(this,a);
...
g.k.show=function(){this.Gc=new g.sn(this.Jn,null,this);this.Gc.start();if(!this.ol){this.tooltip=new g.$R(this.player,this);g.C(this,this.tooltip);g.gN(this.player,this.tooltip.element,4);this.tooltip.Td=.6;this.rb=new g.HO(this.player);g.C(this,this.rb);this.aj=new g.U({D:"div",J:"ytp-miniplayer-scrim"});g.C(this,this.aj);this.aj.ca(this.element);this.L(this.aj.element,"click",this.EC);var a=new g.U({D:"button",Y:["ytp-miniplayer-close-button","ytp-button"],P:{"aria-label":"Fermer"},K:[g.cM()]});
g.C(this,a);a.ca(this.aj.element);this.L(a.element,"click",this.Il);a=new O5(this.player,this);g.C(this,a);a.ca(this.aj.element);this.vj=new g.U({D:"div",J:"ytp-miniplayer-controls"});g.C(this,this.vj);this.vj.ca(this.aj.element);this.L(this.vj.element,"click",this.EC);var b=new g.U({D:"div",J:"ytp-miniplayer-button-container"});g.C(this,b);b.ca(this.vj.element);a=new g.U({D:"div",J:"ytp-miniplayer-play-button-container"});g.C(this,a);a.ca(this.vj.element);var c=new g.U({D:"div",J:"ytp-miniplayer-button-container"});
g.C(this,c);c.ca(this.vj.element);this.ZC=new g.AQ(this.player,this,!1);g.C(this,this.ZC);this.ZC.ca(b.element);b=new g.wQ(this.player,this);g.C(this,b);b.ca(a.element);this.nextButton=new g.AQ(this.player,this,!0);g.C(this,this.nextButton);this.nextButton.ca(c.element);this.fg=new g.JR(this.player,this);g.C(this,this.fg);this.fg.ca(this.aj.element);this.fc=new g.JQ(this.player,this);g.C(this,this.fc);g.gN(this.player,this.fc.element,4);this.zq=new g.U({D:"div",J:"ytp-miniplayer-buttons"});g.C(this,
this.zq);g.gN(this.player,this.zq.element,4);a=new g.U({D:"button",Y:["ytp-miniplayer-close-button","ytp-button"],P:{"aria-label":"Fermer"},K:[g.cM()]});g.C(this,a);a.ca(this.zq.element);this.L(a.element,"click",this.Il);a=new g.U({D:"button",Y:["ytp-miniplayer-replay-button","ytp-button"],P:{"aria-label":"Fermer"},K:[g.qM()]});g.C(this,a);a.ca(this.zq.element);this.L(a.element,"click",this.oN);this.L(this.player,"presentingplayerstatechange",this.Tb);this.L(this.player,"appresize",this.Oa);this.L(this.player,
...
g.k.oN=function(){this.player.playVideo()};
g.k.EC=function(a){if(a.target===this.aj.element||a.target===this.vj.element)g.Q(this.player.O().experiments,"kevlar_miniplayer_play_pause_on_scrim")?g.DC(g.SL(this.player))?this.player.pauseVideo():this.player.playVideo():this.player.ra("onExpandMiniplayer")};
...
g.k.Jn=function(){this.Yc();this.Gc&&this.Gc.start()};
g.k.Tb=function(a){g.T(a.state,32)&&this.tooltip.hide()};
g.k.Oa=function(){this.fc.setPosition(0,g.QM(this.player).getPlayerSize().width,!1);this.fc.Yw()};
g.k.nP=function(a){this.player.app.I.o&&(0===a?this.hide():this.show())};
