...
Z:"OK"}]}]}]});this.u=new g.jO(this,250);this.learnMoreButton=this.ia("ytp-mdx-manual-pairing-popup-learn-more");this.okButton=this.ia("ytp-mdx-manual-pairing-popup-ok");g.D(this,this.u);this.N(this.learnMoreButton,"click",this.B);this.N(this.okButton,"click",this.C)},P8=function(){g.V.call(this,{G:"div",
...
c=g.U(b,128)?g.KL("Erreur sur $RECEIVER_NAME",c):b.Gb()||g.U(b,4)?g.KL("Lecture sur $RECEIVER_NAME",c):g.KL("Connect\u00e9 \u00e0 $RECEIVER_NAME",c);a.za("statustext",c);a.u.show()}else a.u.hide()},R8=function(a,b){g.vX.call(this,"Lire sur",0,a,b);
...
this.Qh={key:i6(),name:"Cet ordinateur"};this.Kg=null;this.subscriptions=[];this.Tz=this.yb=null;this.Dl=[this.Qh];this.Hk=this.Qh;this.Lc=new g.HM(64);this.oE=0;this.Fe=-1;this.po=null;this.xr=this.Fu=!1;this.Um=this.Ro=null;if(!g.KD(this.player.T())){a=this.player;var b=g.yT(a);b&&(b=b.Pk())&&(b=new R8(a,b),g.D(this,b));b=new Q8(a);g.D(this,b);g.xP(a,b.element,4);this.Ro=new P8;g.D(this,this.Ro);g.xP(a,this.Ro.element,4);g.Q(this.player.T().experiments,"pair_servlet_deprecation_warning_enabled")&&
...
R8.prototype.Uh=function(a){return"cast-selector-receiver"===a?"Caster sur\u2026":this.Dl[a].name};
