...
Rappelons que les deux matrices du produit précédent sont des matrices entières $A$ vérifiant $A^T Q A = Q$ et $\det A = 1$ . Nous avons que pour ce type de matrice, la première colonne est solution de \textbf{[ED]} .
