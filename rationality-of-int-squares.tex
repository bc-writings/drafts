...
\input{rationality-of-int-squares/sqrt-of-2}



\section{$\sqrt3$ n'est pas rationnel}

\input{rationality-of-int-squares/sqrt-of-3}


\section{$\sqrt5$ n'est pas rationnel -- Besoin d'une nouvelle preuve}

\input{rationality-of-int-squares/sqrt-of-5}



\section{$\sqrt7$ et $\sqrt{11}$ ne sont pas rationnels}

\input{rationality-of-int-squares/sqrt-of-7}

\input{rationality-of-int-squares/sqrt-of-11}
...
\input{rationality-of-int-squares/general/sqrt-of-prime}


\subsection{Expérimentations}

\input{rationality-of-int-squares/general/computing}


%\subsection{L'arithmétique modulaire}
%
%\input{rationality-of-int-squares/general/modular}
