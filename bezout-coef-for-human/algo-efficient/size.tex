...
Nous avons établi que $a^\prime = \pm v_{n+1}$ et $b^\prime = \mp u_{n+1}$. Il nous reste à \myquote{remonter la récurrence} pour déduire de $u_{n+1} = \pm b^\prime$ des majorations des valeurs des précédents $u_k$.
