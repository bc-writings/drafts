...
\begin{algo}
    ...
    \Actions{
        ...
        \While{$b \neq 0$}{
			...
			\\
			$temp_u \Store u^{\prime\prime}$
			\SequSep
			$temp_v \Store v^{\prime\prime}$
			\\
			$u^{\prime\prime} \Store u^{\prime} - q u^{\prime\prime}$
			\SequSep
			$v^{\prime\prime} \Store v^{\prime} - q v^{\prime\prime}$
			\\
			$u^{\prime} \Store temp_u$
			\SequSep
			$v^{\prime} \Store temp_v$
		}
		\Return{$(u^{\prime\prime} ; v^{\prime\prime})$}
	}
\end{algo}
