...
\newpage
%\section{Une convention utile}  $F$ poly à coef réel et $f$ la fonction de $\RR$ dans $\RR$
...
\input{poly-eq-2nd-deg-no-cano/no-root}
...
\input{poly-eq-2nd-deg-no-cano/one-root-or-more}
