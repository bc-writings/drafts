var _gaq = _gaq || [];
_gaq.push(['_setAccount', ga_trackingId]);

if (typeof ga_domainName !== "undefined") {
    _gaq.push(['_setDomainName', ga_domainName]);
}
_gaq.push(['_setAllowLinker', true]);
_gaq.push(['_gat._anonymizeIp']); // must be before trackPageview!
...
function gaTrackSearchMaterial(action, keyword) {
    _gaq.push(["_trackEvent", "material_search", action, keyword, ga_userId]);
}
