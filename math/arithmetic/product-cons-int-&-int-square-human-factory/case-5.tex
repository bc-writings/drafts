...
L'idée suivie pour la preuve suivante est celle de la démonstration du cas \ref{case-10} qui utilise plus efficacement le principe des tiroirs, mais en commençant par un raisonnement plus grossier a priori. Comme quoi certains détails ne comptent pas, ou au contraire comptent trop !
...
\begin{proof}[Preuve 2]%
    ...
    Parmi les $3$ autres facteurs, qui sont premiers relativement à tout premier $p \in \PP_{\geq 3}$ , nous avons l'une des alternatives suivantes, d'après le principe des tiroirs
    \footnote{
    	Est-ce vraiement utile de le citer ici ce principe ?
    },
