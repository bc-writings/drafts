...
\begin{proof}
    ...
    \begin{itemize}
		...
		De même, $n+4 \notin \NNsquare$\,.
		Dès lors, nous avons $\setgene{n+i, n+i^\prime} \subseteq \setgene{n+1, n+2, n+3}$ qui donne deux carrés parfaits non nuls éloignés de moins de $3$\,, et ceci contredit le fait \ref{diff-square-ko}.
...
\begin{proof}[Une preuve alternative]%
	...
	\begin{itemize}
		...
		Le fait \ref{diff-square-ko} impose d'avoir $(u, q) = (4, 1)$\,, d'où $m^2 - 1 = 4$\,, mais ceci est impossible
		\footnote{
	...
	\begin{itemize}
		...
		\begin{enumerate}
        	...
        	\explnext*{Via le fait \ref{diff-square-ko}, mais \\ ceci contredit $m \in \NN_{\geq 3}$\,.}{}
        		m = 1
        	\end{stepcalc}
        	...
        	\explnext*{Voir le fait \ref{diff-square-ko}, mais \\ ceci contredit $m \in \NN_{\geq 3}$\,.}{}
        		m = 2
        	\end{stepcalc}
		\end{enumerate}		
