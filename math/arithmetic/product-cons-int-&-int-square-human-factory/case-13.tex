...
\begin{remark}
    ...
    À ce stade, il serait opportun de tenter une analyse informatique pour traiter les cas jusqu'à $100$ facteurs, c'est-à-dire ceux supposés connus dans la démonstration de Paul Erdős ; nous ne le ferons pas car ce document a préféré laisser la part belle aux humains.
\end{remark}
