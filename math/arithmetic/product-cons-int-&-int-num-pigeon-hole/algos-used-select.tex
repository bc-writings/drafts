...
La première phase consiste à tenter de trouver le moins possible de nombres premiers $p$ tels que tous les facteurs $(n+i)$ de $\consprod$ soient de valuation $p$-adique non nécessairement paire. 
...
\begin{enumerate}
	...
	\item Si $occu_{libre} > 2^{\card( \setgeo{P} )}$\,, nous posons $\setgeo{C} = \setgeo{P}$\,.
