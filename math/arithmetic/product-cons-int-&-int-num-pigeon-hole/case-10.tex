...
On peut adapter \enquote{mécaniquement} ce qui précède
\footnote{
	Voir le document \enquote{Carrés parfaits et produits d'entiers consécutifs -- Des solutions à la main} dispponible dans le dépôt associé au présent document.
},
afin de démontrer que $\forall n \in \NNs$\,, $\consprod<k> \notin \NNsquare$ si $k \in \setgene{5, 7, 9, 11, 12, 13}$\,.
