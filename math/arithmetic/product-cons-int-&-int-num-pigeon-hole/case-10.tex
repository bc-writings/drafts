...
\footnote{
	Voir le document \enquote{Carrés parfaits et produits d'entiers consécutifs -- Des solutions à la main} disponible dans le dépôt associé au présent document.
},
