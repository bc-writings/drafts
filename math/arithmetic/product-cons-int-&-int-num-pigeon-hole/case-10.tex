...
Dans le document \enquote{Carrés parfaits et produits d'entiers consécutifs -- Des solutions à la main}\,, des adaptations \enquote{mécaniques} de la preuve ci-dessus permettent de démontrer que $\forall n \in \NNs$\,, $\consprod<k> \notin \NNsquare$ si $k \in \setgene{5, 7, 9, 11, 12, 13}$\,.
Comme de plus, ces approches semblent peu gourmandes informatiquement, il semble opportun de tenter un traitement numérique des cas laissés de côté dans l'article de Paul Erdős. 
