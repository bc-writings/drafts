...
\section{Résolutions à fortes empreintes cognitives} \label{warmup-your-brain}

\foreach \k in {1,...,5} {
	\ifthenelse{\k = 1}{
		\subsection{Avec \k\ seul facteur}
	}{
		\subsection{Avec \k\ facteurs}
	}

	\input{\contentdir/by-hand/case-\k}
}
...
\section{Une méthode efficace} \label{lazzy-is-easy}

\subsection{Prenons du recul}

\input{\contentdir/table-trick}


\foreach \k in {2,...,5} {
%\foreach \k in {5} {
	\subsection{Application au cas de \k\ facteurs} \label{apply-\k}

	\input{\contentdir/table-trick/case-\k}
}


\subsection{Et après ?}

\input{\contentdir/table-trick/case-after}
