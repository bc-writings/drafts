...
\begin{proof}
    ...
    \begin{itemize}
		...
		Or $n \notin \NNsquare$ puisque sinon nous aurions $(n+1)(n+2)(n+3)(n+4) \in \NNsquare$ via $n(n+1)(n+2)(n+3)(n+4) \in \NNsquare$\,, mais ceci ne se peut d'après le fait \ref{case-3}.
		De même, $n+4 \notin \NNsquare$\,.
		...
		\smallskip
		\noindent
		Dans ce cas, on aurait deux facteurs différents divisibles par $6$\,, mais ceci est impossible. \qedhere
    \end{itemize}
\end{proof}
