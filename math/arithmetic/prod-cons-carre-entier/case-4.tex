...
\begin{proof}
    ...
    \begin{itemize}
		...
		\noindent
		Dans ce cas, on sait juste que $(n+i, n+i^\prime) \in \NNsquare \times \NNsquare$\,, mais ceci permet d'affirmer qu'au moins l'une des deux alternatives \alt{2} et \alt{3} a lieu, sinon on aurait deux entiers consécutifs qui seraient des carrés parfaits, mais ceci contredirait le fait \ref{dist-square}.
    	...
    	\item Comme dans le point précédent, on vérifie qu'il n'est pas possible d'avoir deux facteurs différents $(n+i)$ et $(n+i^\prime)$ vérifiant \alt{3} via $2 = 2 M^2 - 2 N^2$\,, ou $4 = 2 M^2 - 2 N^2$\,. 
	En effet, ici les couples possibles sont $(n, n + 2)$\,, $(n, n + 4)$\,,  $(n + 2, n + 4)$ et $(n + 1, n + 3)$\,, rien n'empêchant d'avoir $n$\,, $(n + 2)$ et $(n + 4)$ vérifiant tous les trois \alt{3}\,. \qedhere
    \end{itemize}
\end{proof}
