...
\begin{proof}
    ...
    Pour $p = 2$ et $p = 3$\,, comme dans la preuve alternative du fait \ref{case-3}, nous avons quatre alternatives, mais ici comme nous avons aussi cinq facteurs, ce bon vieux principe des tiroirs va nous permettre de lever des contradictions très facilement.
    %
    \begin{itemize}
