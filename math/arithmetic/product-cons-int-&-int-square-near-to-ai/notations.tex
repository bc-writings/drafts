...
\begin{itemize}
	...
	\medskip
	\item $\NNseq$ désigne l'ensemble des suites finies strictement croissantes de $n$ entiers naturels.
	
	
	\noindent
	$\PPseq$ désigne l'ensemble des suites finies strictement croissantes de $n$ nombres premiers.
