Supposons que $\consprod<3> = n(n+1)(n+2)(n+3) \in \NNssquare$\,. Nous avons alors les \sftab[x] partiels suivants pour $p \in \PP_{>3}$ divisant $\consprod<3>$\,.
...
Pour $p = 2$\,, nous avons les trois \sftab[x] partiels relatifs à $2$ donnés ci-après.
...
\newpage
Pour $p = 3$\,, nous obtenons les deux \sftab[x] partiels relatifs à $3$ donnés ci-après.
...
%\newpage
La multiplication des \sftab[x] partiels précédents donne les \sftab[x], non partiels, suivants.
...
\vspace{-1.5ex}
Le fait \ref{sftable-illegal} rejette quatre \sftab[x] : voir les cellules surlignées ci-dessous.
