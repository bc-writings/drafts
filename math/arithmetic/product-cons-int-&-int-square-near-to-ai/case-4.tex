...
En multipliant les colonnes extrêmes ensemble, et celles centrales aussi, nous arrivons aux \sftab[x] généralisés ci-après où les $2$ viennent de $6 \times 3 = 2 \times 3^2$\,.
...
Comme $x - \frac14 - \big( x - \frac94 \big) = 4$\,, le fait \ref{sftable-illegal-0-sol} nous montre que les \sftab[x] généralisés précédents sont impossibles. Joli ! Non ?
