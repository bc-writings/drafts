...
\begin{fact} \label{vogler-multiple}
	Dans la deuxième ligne d'un \sftab\ partiel relatif à un unique nombre premier $p$\,, les valeurs $p$ sont séparées par exactement $(p-1)$ valeurs $1$\,.
\end{fact}
...
\begin{fact} \label{vogler-parity-square}
	...
	alors dans le \sftab\ partiel relatif uniquement au nombre premier $p$\,, et associé à $\consprod$\,, le nombre de valeurs $p$ est forcément pair.
\end{fact}
