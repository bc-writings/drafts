...
Dans le dépôt en ligne associé à ce document sont placés les fichiers \verb#find-pb-sftab.py# et \verb#common.py# qui ne renvoient aucun \sftab\ problématique relativement à $\consprod<6>$\,, et ceci en s'appuyant sur les règles suivantes du fait \ref{sftable-illegal-0-sol}, ceci montrant que l'entreprise est humainement faisable. Magique ! Non ?
%
\begin{enumerate}
	\item Certaines valeurs $2$ et $3$ contrediseant le critère de non divisibilité.

	\item D'autres valeurs sont mal espacées.
	%
	\begin{itemize}[label=\small\textbullet]
		\item Des valeurs $1$ apparaissent distancées de $1$\,, $2$ ou $4$\,.
		
		\item Des valeurs $2$ apparaissent distancées de $2$\,.

		\item Des valeurs $5$ apparaissent distancées de $5$\,.
	\end{itemize}
\end{enumerate}