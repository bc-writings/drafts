...
%\newpage
%\medskip
\section{Une démonstration intéressante}
...
\subsection{De potentiels bons candidats}

\input{\contentdir/algo-select}


\subsection{Les cas gagnants}

\input{\contentdir/algo-OK}


\subsection{Les cas perdants}
