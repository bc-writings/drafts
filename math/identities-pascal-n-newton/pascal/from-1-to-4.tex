...
\begin{stepcalc}[style = sar]
	...
	(\redit{a} + \blueit{b}) (a + b)^3
		\explnext{}
	(\redit{a} + \blueit{b}) (a^3 + 3 a^2 b + 3 a b^2 + b^3)
		\explnext{}
	\redit{a^4 + a \cdot 3 a^2 b + a \cdot 3 a b^2 + a \cdot b^3}
	+
	\blueit{b \cdot a^3 + b \cdot 3 a^2 b + b \cdot 3 a b^2 + b^4}
		\explnext{}
	\redit{a^4 + 3 a^3 b + 3 a^2 b^2 + a b^3}
	+
	\blueit{b a^3 + 3 a^2 b^2 + 3 a b^3 + b^4}
		\explnext{}
