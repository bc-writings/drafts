...
;function $g(a){a=a.split("&");for(var b={},c=0,d=a.length;c<d;c++){var e=a[c].split("=");if(1==e.length&&e[0]||2==e.length)try{var f=decodeURIComponent((e[0]||"").replace(/\+/g," ")),g=decodeURIComponent((e[1]||"").replace(/\+/g," "));f in b?Array.isArray(b[f])?eb(b[f],g):b[f]=[b[f],g]:b[f]=g}catch(h){"q"!=e[0]&&(h.args=[{key:e[0],value:e[1]}],Bf(h))}}return b}
...
v(Wh,Error);var Xh=[];function Yh(a,b){Xh.push({type:"EVENT",eventType:a,payload:b});10<Xh.length&&Xh.shift()}
...
function ai(a,b,c){b=void 0===b?{}:b;c=void 0===c?$h[a]:c;Wh.call(this,c,Object.assign({name:"YtIdbKnownError",isSw:void 0===self.document,isIframe:self!==self.top,type:a},b));this.type=a;this.message=c;Object.setPrototypeOf(this,ai.prototype);Xh.push({type:"ERROR",payload:this});10<Xh.length&&Xh.shift()}
v(ai,Wh);function bi(a,b){ai.call(this,"UNKNOWN_ABORT",{objectStoreNames:a.join(),dbName:b});Object.setPrototypeOf(this,bi.prototype)}
v(bi,ai);function ci(a,b){this.f=a;this.options=b}
n=ci.prototype;n.add=function(a,b,c){return di(this,[a],"readwrite",function(d){return ei(d,a).add(b,c)})};
n.clear=function(a){return di(this,[a],"readwrite",function(b){return ei(b,a).clear()})};
n.close=function(){var a;this.f.close();(null===(a=this.options)||void 0===a?0:a.closed)&&this.options.closed()};
n.count=function(a,b){return di(this,[a],"readonly",function(c){return ei(c,a).count(b)})};
n["delete"]=function(a,b){return di(this,[a],"readwrite",function(c){return ei(c,a)["delete"](b)})};
n.get=function(a,b){return di(this,[a],"readwrite",function(c){return ei(c,a).get(b)})};
function di(a,b,c,d){a=a.f.transaction(b,void 0===c?"readonly":c);a=new fi(a);return gi(a,d)}
function hi(a){this.f=a}
n=hi.prototype;n.add=function(a,b){return Uh(this.f.add(a,b))};
...
n["delete"]=function(a){return a instanceof IDBKeyRange?ii(this,a):Uh(this.f["delete"](a))};
n.get=function(a){return Uh(this.f.get(a))};
n.index=function(a){return new ki(this.f.index(a))};
n.getName=function(){return this.f.name};
function ji(a,b,c){a=a.f.openCursor(b.query,b.direction);return li(a).then(function(d){return Vh(d,c)})}
function mi(a){for(var b=[],c=0;c<a.length;c++){var d=a.item(c);if(null===d)throw Error("Invariant: item in DOMStringList is null");b.push(d)}return b}
function fi(a){var b=this;this.f=a;this.g=new Map;this.h=W();this.aborted=!1;this.done=new N(function(c,d){b.f.addEventListener("complete",function(){ni(b,!0);c()});
b.f.addEventListener("error",function(e){e.currentTarget===e.target&&d(b.f.error)});
b.f.addEventListener("abort",function(){ni(b,!1);var e=b.f.error;if(e){var f;"QuotaExceededError"===e.name?f=new ai("QUOTA_EXCEEDED"):"UnknownError"===e.name&&(f=new ai("QUOTA_MAYBE_EXCEEDED"));f&&Yh("QUOTA_EXCEEDED",void 0);d(e)}else b.aborted||(e=new bi(mi(b.f.objectStoreNames),b.f.db.name),d(e))})})}
function gi(a,b){var c=new N(function(d,e){Oh(b(a).then(function(f){a.commit();d(f)}),e)});
return Re([c,a.done]).then(function(d){return t(d).next().value})}
fi.prototype.abort=function(){this.f.abort();this.aborted=!0;throw new ai("EXPLICIT_ABORT");};
fi.prototype.commit=function(){var a=this.f;a.commit&&!this.aborted&&a.commit()};
function ei(a,b){var c=a.f.objectStore(b),d=a.g.get(c);d||(d=new hi(c),a.g.set(c,d));return d}
function ni(a,b){Yh("TRANSACTION_ENDED",{objectStoreNames:mi(a.f.objectStoreNames).join(),duration:W()-a.h,isSuccessful:b})}
function ki(a){this.f=a}
ki.prototype.count=function(a){return Uh(this.f.count(a))};
ki.prototype.get=function(a){return Uh(this.f.get(a))};
ki.prototype.getKey=function(a){return Uh(this.f.getKey(a))};
function oi(a,b){this.request=a;this.cursor=b}
function li(a){return Uh(a).then(function(b){return null===b?null:new oi(a,b)})}
n=oi.prototype;n.advance=function(a){this.cursor.advance(a);return li(this.request)};
...
return b()})}
function qi(){var a=void 0===a?{}:a;return pi(a)}
;var ri,si,ti=["getAll","getAllKeys","getKey","openKeyCursor"],ui=["getAll","getAllKeys","getKey","openKeyCursor"];function vi(){return cc(this,function b(){var c,d;return Ba(b,function(e){switch(e.g){case 1:if(Ih&&Jh()&&!Kh()&&!R("ytidb_allow_on_ios_safari_v8_and_v9")||gc)return e["return"](!1);try{if(c=self,!(c.indexedDB&&c.IDBIndex&&c.IDBKeyRange&&c.IDBObjectStore))return e["return"](!1)}catch(f){return e["return"](!1)}sa(e);return ra(e,Te(qi(),function(){}));
...
function wi(){return void 0!==ri?Ne(ri):new N(function(a){vi().then(function(b){ri=b;a(b)})})}
function xi(){return void 0!==si?Ne(si):wi().then(function(a){if(!a)return!1;var b=t(ti);for(a=b.next();!a.done;a=b.next())if(!IDBObjectStore.prototype[a.value])return!1;b=t(ui);for(a=b.next();!a.done;a=b.next())if(!IDBIndex.prototype[a.value])return!1;return IDBObjectStore.prototype.getKey?!0:!1}).then(function(a){return si=a})}
;function yi(){Ae.call(this);this.h=zi();Ai(this);Bi(this)}
v(yi,Ae);function zi(){var a=window.navigator.onLine;return void 0===a?!0:a}
function Bi(a){window.addEventListener("online",function(){a.h=!0;a.m&&a.m()})}
function Ai(a){window.addEventListener("offline",function(){a.h=!1;a.l&&a.l()})}
;function Ci(a,b){b=void 0===b?{}:b;Di(a,b)}
function Di(a,b){b=void 0===b?{}:b;Ei().then(function(){yi.f||(yi.f=new yi);yi.f.h!==zi()&&Bf(Error("NetworkStatusManager isOnline does not match window status"));sh(a,b)})}
function Ei(){return cc(this,function b(){return Ba(b,function(c){return R("networkless_logging")?(2===Hf("networkless_ytidb_version")&&xi().then(function(d){return d}),c["return"](wi())):c["return"](!1)})})}
;function Fi(a){var b=this;this.f=null;a?this.f=a:zh()&&(this.f=Rg());gg(function(){Hh(b)},0,5E3)}
Fi.prototype.isReady=function(){!this.f&&zh()&&(this.f=Rg());return!!this.f};
...
timeout:d.timeout,withCredentials:!0},g="";(e=a.f.Sa)&&(g=e);var h=a.f.Ua||!1,k=Ah(h,g,d);Object.assign(f.headers,k);f.headers.Authorization&&!g&&(f.headers["x-origin"]=window.location.origin);e="/youtubei/"+a.f.innertubeApiVersion+"/"+b;var l={alt:"json"};a.f.Ta&&f.headers.Authorization||(l.key=a.f.innertubeApiKey);var m=ch(""+g+e,l||{},!0);Ei().then(function(p){if(d.retry&&R("retry_web_logging_batches")&&"www.youtube-nocookie.com"!=g){if(R("networkless_gel")&&!p||!R("networkless_gel"))var u=Fh(b,
c,k,h);if(u){var r=f.onSuccess,A=f.ya;f.onSuccess=function(D,T){Gh(u);r(D,T)};
c.ya=function(D,T){Gh(u);A(D,T)}}}try{R("use_fetch_for_op_xhr")?ph(m,f):R("networkless_gel")&&d.retry?(f.method="POST",Ci(m,f)):(f.method="POST",f.D||(f.D={}),sh(m,f))}catch(D){if("InvalidAccessError"==D.name)u&&(Gh(u),u=0),Cf(Error("An extension is blocking network request."));
else throw D;}u&&gg(function(){Hh(a)},0,5E3)})}
;function Gi(a,b,c){c=void 0===c?{}:c;var d=Fi;Q("ytLoggingEventsDefaultDisabled",!1)&&Fi==Fi&&(d=null);Wg(a,b,d,c)}
;var Hi=[{wa:function(a){return"Cannot read property '"+a.key+"'"},
...
var Ji;var Ki=new O;var Li=new Set,Mi=0,Ni=["PhantomJS","Googlebot","TO STOP THIS SECURITY SCAN go/scan"];function Oi(a){Pi(a,"WARNING")}
...
(window&&window.yterr||g)&&!(5<=Mi)&&0!==a.sampleWeight)){var h=xc(a);g=h.message||"Unknown Error";d=h.name||"UnknownError";e=h.lineNumber||"Not available";f=h.fileName||"Not available";h=h.stack||a.f||"Not available";if(a.hasOwnProperty("args")&&a.args&&a.args.length)for(var k=0,l=0;l<a.args.length;l++){var m=a.args[l],p="params."+l;k+=p.length;if(m)if(Array.isArray(m))for(var u=c,r=0;r<m.length&&!(m[r]&&(k+=Qi(r,m[r],p,u),500<k));r++);else if("object"===typeof m)for(u in u=void 0,r=c,m){if(m[u]&&
(k+=Qi(u,m[u],p,r),500<k))break}else c[p]=String(JSON.stringify(m)).substring(0,500),k+=c[p].length;else c[p]=String(JSON.stringify(m)).substring(0,500),k+=c[p].length;if(500<=k)break}else if(a.hasOwnProperty("params")&&a.params)if(m=a.params,"object"===typeof a.params)for(l in p=0,m){if(m[l]&&(k="params."+l,u=String(JSON.stringify(m[l])).substr(0,500),c[k]=u,p+=k.length+u.length,500<p))break}else c.params=String(JSON.stringify(m)).substr(0,500);navigator.vendor&&!c.hasOwnProperty("vendor")&&(c.vendor=
navigator.vendor);c={message:g,name:d,lineNumber:e,fileName:f,stack:h,params:c};a=Number(a.columnNumber);isNaN(a)||(c.lineNumber=c.lineNumber+":"+a);a=t(Hi);for(g=a.next();!g.done;g=a.next())if(g=g.value,g.ra[c.name])for(e=t(g.ra[c.name]),d=e.next();!d.done;d=e.next())if(f=d.value,d=c.message.match(f.regexp)){c.params["error.original"]=d[0];e=f.groups;f={};for(h=0;h<e.length;h++)f[e[h]]=d[h+1],c.params["error."+e[h]]=d[h+1];c.message=g.wa(f);break}window.yterr&&"function"===typeof window.yterr&&window.yterr(c);
if(!(Li.has(c.message)||0<=c.stack.indexOf("/YouTubeCenter.js")||0<=c.stack.indexOf("/mytube.js"))){Ki.P("handleError",c);if(R("kevlar_gel_error_routing")){a=b;a:{g=t(Ni);for(d=g.next();!d.done;d=g.next())if(Lh(d.value.toLowerCase())){g=!0;break a}g=!1}if(!g){g={stackTrace:c.stack};c.fileName&&(g.filename=c.fileName);d=c.lineNumber&&c.lineNumber.split?c.lineNumber.split(":"):[];0!==d.length&&(1!==d.length||isNaN(Number(d[0]))?2!==d.length||isNaN(Number(d[0]))||isNaN(Number(d[1]))||(g.lineNumber=Number(d[0]),
g.columnNumber=Number(d[1])):g.lineNumber=Number(d[0]));d=c.message;e=c.name;Ji||(Ji=new Ii);f=Ji;a:{h=t(f.g);for(l=h.next();!l.done;l=h.next())if(l=l.value,c.message&&c.message.match(l.f)){f=l.weight;break a}f=t(f.f);for(h=f.next();!h.done;h=f.next())if(h=h.value,h.Ga(c)){f=h.weight;break a}f=1}d={level:"ERROR_LEVEL_UNKNOWN",message:d,errorClassName:e,sampleWeight:f};"ERROR"===a?d.level="ERROR_LEVEL_ERROR":"WARNING"===a&&(d.level="ERROR_LEVEL_WARNNING");a={isObfuscated:!0,browserStackInfo:g};g={pageUrl:window.location.href};
Q("FEXP_EXPERIMENTS")&&(g.experimentIds=Q("FEXP_EXPERIMENTS"));g.kvPairs=[];if(e=c.params)for(f=t(Object.keys(e)),h=f.next();!h.done;h=f.next())h=h.value,g.kvPairs.push({key:"client."+h,value:String(e[h])});e=Q("SERVER_NAME",void 0);f=Q("SERVER_VERSION",void 0);e&&f&&(g.kvPairs.push({key:"server.name",value:e}),g.kvPairs.push({key:"server.version",value:f}));Gi("clientError",{errorMetadata:g,stackTrace:a,logMessage:d});Ng()}}if(!R("suppress_error_204_logging")){a=c.params||{};b={lb:{a:"logerror",
...
Q("SERVER_VERSION",void 0);a&&g&&(b.D["server.name"]=a,b.D["server.version"]=g)}sh(Q("ECATCHER_REPORT_HOST","")+"/error_204",b)}Li.add(c.message);Mi++}}}
function Qi(a,b,c,d){c+="."+a;a=String(JSON.stringify(b)).substr(0,500);d[c]=a;return c.length+a.length}
;function Ri(){this.g=!1;this.f=null}
Ri.prototype.initialize=function(a,b,c,d,e,f){var g=this;f=void 0===f?!1:f;b?(this.g=!0,Yf(b,function(){g.g=!1;window.botguard?Si(g,c,d,f):(cg(b),Oi(new Wh("Unable to load Botguard","from "+b)))},e)):a&&(e=Kc(document,"SCRIPT"),e.textContent=a,e.nonce=Ga(),document.head.appendChild(e),document.head.removeChild(e),window.botguard?Si(this,c,d,f):Oi(Error("Unable to load Botguard from JS")))};
function Si(a,b,c,d){if(d)try{a.f=new window.botguard.bg(b,c?function(){return c(b)}:z)}catch(e){Oi(e)}else{try{a.f=new window.botguard.bg(b)}catch(e){Oi(e)}c&&c(b)}}
Ri.prototype.dispose=function(){this.f=null};var Ti=new Ri;function Ui(){return!!Ti.f}
function Vi(a){a=void 0===a?{}:a;a=void 0===a?{}:a;return Ti.f?Ti.f.invoke(void 0,void 0,a):null}
;var Wi=E().toString();
function Xi(){a:{if(window.crypto&&window.crypto.getRandomValues)try{var a=Array(16),b=new Uint8Array(16);window.crypto.getRandomValues(b);for(var c=0;c<a.length;c++)a[c]=b[c];var d=a;break a}catch(e){}d=Array(16);for(a=0;16>a;a++){b=E();for(c=0;c<b%23;c++)d[a]=Math.random();d[a]=Math.floor(256*Math.random())}if(Wi)for(a=1,b=0;b<Wi.length;b++)d[a%16]=d[a%16]^d[(a-1)%16]/4^Wi.charCodeAt(b),a++}a=[];for(b=0;b<d.length;b++)a.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(d[b]&63));
return a.join("")}
;var Yi=w.ytLoggingDocDocumentNonce_||Xi();x("ytLoggingDocDocumentNonce_",Yi,void 0);var Zi=1;function $i(a){this.f=a}
$i.prototype.getAsJson=function(){var a={};void 0!==this.f.trackingParams?a.trackingParams=this.f.trackingParams:(a.veType=this.f.veType,void 0!==this.f.veCounter&&(a.veCounter=this.f.veCounter),void 0!==this.f.elementIndex&&(a.elementIndex=this.f.elementIndex));void 0!==this.f.dataElement&&(a.dataElement=this.f.dataElement.getAsJson());void 0!==this.f.youtubeData&&(a.youtubeData=this.f.youtubeData);return a};
$i.prototype.toString=function(){return JSON.stringify(this.getAsJson())};
$i.prototype.isClientVe=function(){return!this.f.trackingParams&&!!this.f.veType};function aj(a){a=void 0===a?0:a;return 0==a?"client-screen-nonce":"client-screen-nonce."+a}
function bj(a){a=void 0===a?0:a;return 0==a?"ROOT_VE_TYPE":"ROOT_VE_TYPE."+a}
function cj(a){return Q(bj(void 0===a?0:a),void 0)}
x("yt_logging_screen.getRootVeType",cj,void 0);function dj(){var a=cj(0),b;a?b=new $i({veType:a,youtubeData:void 0}):b=null;return b}
function ej(){var a=Q("csn-to-ctt-auth-info");a||(a={},P("csn-to-ctt-auth-info",a));return a}
function fj(a){a=void 0===a?0:a;var b=Q(aj(a));if(!b&&!Q("USE_CSN_FALLBACK",!0))return null;b||0!=a||(R("kevlar_client_side_screens")||R("c3_client_side_screens")?b="UNDEFINED_CSN":b=Q("EVENT_ID"));return b?b:null}
x("yt_logging_screen.getCurrentCsn",fj,void 0);function gj(a,b,c){var d=ej();(c=fj(c))&&delete d[c];b&&(d[a]=b)}
function hj(a){return ej()[a]}
x("yt_logging_screen.getCttAuthInfo",hj,void 0);function ij(a,b,c,d){c=void 0===c?0:c;if(a!==Q(aj(c))||b!==Q(bj(c)))if(gj(a,d,c),P(aj(c),a),P(bj(c),b),0==c||R("web_screen_associated_all_layers"))b=function(){setTimeout(function(){a&&Wg("foregroundHeartbeatScreenAssociated",{clientDocumentNonce:Yi,clientScreenNonce:a},Fi)},0)},"requestAnimationFrame"in window?window.requestAnimationFrame(b):b()}
x("yt_logging_screen.setCurrentScreen",ij,void 0);function jj(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=Q("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=void 0===e?!0:e;var f=Q("VALID_SESSION_TEMPDATA_DOMAINS",[]),g=K(window.location.href);g&&f.push(g);g=K(d);if(0<=Ya(f,g)||!g&&0==d.lastIndexOf("/",0))if(R("autoescape_tempdata_url")&&(f=document.createElement("a"),Sb(f,d),d=f.href),d){g=d.match(Wb);d=g[5];f=g[6];g=g[7];var h="";d&&(h+=d);f&&(h+="?"+f);g&&(h+="#"+g);d=h;f=d.indexOf("#");if(d=0>f?d:d.substr(0,f))if(e&&!b.csn&&(b.itct||b.ved)&&
(b=Object.assign({csn:fj()},b)),k){var k=parseInt(k,10);isFinite(k)&&0<k&&(e=b,b="ST-"+Vb(d).toString(36),e=e?Zb(e):"",Ff(b,e,k||5))}else k=b,e="ST-"+Vb(d).toString(36),k=k?Zb(k):"",Ff(e,k,5)}}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var l=void 0===l?{}:l;var m=void 0===m?"":m;var p=void 0===p?window:p;c=p.location;a=ac(a,l)+m;a=a instanceof I?a:Kb(a);c.href=Gb(a)}return!0}
;function kj(a,b){this.version=a;this.args=b}
;function lj(a,b){this.topic=a;this.f=b}
lj.prototype.toString=function(){return this.topic};var mj=y("ytPubsub2Pubsub2Instance")||new O;O.prototype.subscribe=O.prototype.subscribe;O.prototype.unsubscribeByKey=O.prototype.T;O.prototype.publish=O.prototype.P;O.prototype.clear=O.prototype.clear;x("ytPubsub2Pubsub2Instance",mj,void 0);var nj=y("ytPubsub2Pubsub2SubscribedKeys")||{};x("ytPubsub2Pubsub2SubscribedKeys",nj,void 0);var oj=y("ytPubsub2Pubsub2TopicToKeys")||{};x("ytPubsub2Pubsub2TopicToKeys",oj,void 0);var pj=y("ytPubsub2Pubsub2IsAsync")||{};x("ytPubsub2Pubsub2IsAsync",pj,void 0);
x("ytPubsub2Pubsub2SkipSubKey",null,void 0);function qj(a,b){var c=rj();c&&c.publish.call(c,a.toString(),a,b)}
function sj(a){var b=tj,c=rj();if(!c)return 0;var d=c.subscribe(b.toString(),function(e,f){var g=y("ytPubsub2Pubsub2SkipSubKey");g&&g==d||(g=function(){if(nj[d])try{if(f&&b instanceof lj&&b!=e)try{var h=b.f,k=f;if(!k.args||!k.version)throw Error("yt.pubsub2.Data.deserialize(): serializedData is incomplete.");try{if(!h.K){var l=new h;h.K=l.version}var m=h.K}catch(p){}if(!m||k.version!=m)throw Error("yt.pubsub2.Data.deserialize(): serializedData version is incompatible.");try{f=Reflect.construct(h,
db(k.args))}catch(p){throw p.message="yt.pubsub2.Data.deserialize(): "+p.message,p;}}catch(p){throw p.message="yt.pubsub2.pubsub2 cross-binary conversion error for "+b.toString()+": "+p.message,p;}a.call(window,f)}catch(p){Bf(p)}},pj[b.toString()]?y("yt.scheduler.instance")?fg(g):S(g,0):g())});
nj[d]=!0;oj[b.toString()]||(oj[b.toString()]=[]);oj[b.toString()].push(d);return d}
function uj(){var a=vj,b=sj(function(c){a.apply(void 0,arguments);wj(b)});
return b}
function wj(a){var b=rj();b&&("number"===typeof a&&(a=[a]),H(a,function(c){b.unsubscribeByKey(c);delete nj[c]}))}
function rj(){return y("ytPubsub2Pubsub2Instance")}
;function xj(a){kj.call(this,1,arguments);this.csn=a}
v(xj,kj);var tj=new lj("screen-created",xj),yj=[],zj=0;function Aj(a,b,c){var d=R("use_default_events_client")?void 0:Fi;b={csn:a,parentVe:b.getAsJson(),childVes:$a(c,function(f){return f.getAsJson()})};
c=t(c);for(var e=c.next();!e.done;e=c.next())e=e.value.getAsJson(),(jb(e)||!e.trackingParams&&!e.veType)&&Oi(Error("Child VE logged with no data"));c={ia:hj(a),V:a};"UNDEFINED_CSN"==a?Bj("visualElementAttached",b,c):d?Wg("visualElementAttached",b,d,c):Gi("visualElementAttached",b,c)}
function Bj(a,b,c){yj.push({payloadName:a,payload:b,options:c});zj||(zj=uj())}
function vj(a){if(yj){for(var b=t(yj),c=b.next();!c.done;c=b.next())c=c.value,c.payload&&(c.payload.csn=a.csn,Wg(c.payloadName,c.payload,null,c.options));yj.length=0}zj=0}
;function Cj(a){a=a||{};var b={},c={};this.url=a.url||"";this.args=a.args||mb(b);this.assets=a.assets||{};this.attrs=a.attrs||mb(c);this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
Cj.prototype.clone=function(){var a=new Cj,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];"object"==La(c)?a[b]=mb(c):a[b]=c}return a};function Dj(){M.call(this);this.f=[]}
v(Dj,M);Dj.prototype.o=function(){for(;this.f.length;){var a=this.f.pop();a.target.removeEventListener(a.name,a.Ga)}M.prototype.o.call(this)};var Ej=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function Fj(a){a=a||"";if(window.spf){var b=a.match(Ej);spf.style.load(a,b?b[1]:"",void 0)}else Gj(a)}
function Gj(a){var b=Hj(a),c=document.getElementById(b),d=c&&Kf(c,"loaded");d||c&&!d||(c=Ij(a,b,function(){Kf(c,"loaded")||(If(c),Tf(b),S(Sa(Uf,b),0))}))}
function Ij(a,b,c){var d=document.createElement("link");d.id=b;d.onload=function(){c&&setTimeout(c,0)};
a=Yc(a);d.rel="stylesheet";d.href=ub(a).toString();(document.getElementsByTagName("head")[0]||document.body).appendChild(d);return d}
function Hj(a){var b=Kc(document,"A");Sb(b,new I(a,Fb));a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+Vb(a)}
;function Jj(a,b,c,d){M.call(this);var e=this;this.m=this.aa=a;this.G=b;this.u=!1;this.api={};this.Y=this.F=null;this.H=new O;Sc(this,Sa(Tc,this.H));this.j={};this.N=this.Z=this.i=this.ha=this.f=null;this.M=!1;this.l=this.C=null;this.ba={};this.Da=["onReady"];this.ga=null;this.sa=NaN;this.W={};this.h=d;Kj(this);this.ca("WATCH_LATER_VIDEO_ADDED",this.Wa.bind(this));this.ca("WATCH_LATER_VIDEO_REMOVED",this.Xa.bind(this));this.ca("onAdAnnounce",this.Fa.bind(this));this.Ea=new Dj(this);Sc(this,Sa(Tc,this.Ea));
this.X=0;c?this.X=S(function(){e.loadNewVideoConfig(c)},0):d&&(Lj(this),Mj(this))}
v(Jj,M);n=Jj.prototype;n.getId=function(){return this.G};
n.loadNewVideoConfig=function(a){if(!this.g){this.X&&(U(this.X),this.X=0);a instanceof Cj||(a=new Cj(a));this.ha=a;this.f=a.clone();Lj(this);this.Z||(this.Z=Nj(this,this.f.args.jsapicallback||"onYouTubePlayerReady"));this.f.args.jsapicallback=null;if(a=this.f.attrs.width)this.m.style.width=$c(Number(a)||String(a));if(a=this.f.attrs.height)this.m.style.height=$c(Number(a)||String(a));Mj(this);this.u&&Oj(this)}};
function Lj(a){var b;a.h?b=a.h.rootElementId:b=a.f.attrs.id;a.i=b||a.i;"video-player"==a.i&&(a.i=a.G,a.h?a.h.rootElementId=a.G:a.f.attrs.id=a.G);a.m.id==a.i&&(a.i+="-player",a.h?a.h.rootElementId=a.i:a.f.attrs.id=a.i)}
n.Ka=function(){return this.ha};
function Oj(a){a.f&&!a.f.loaded&&(a.f.loaded=!0,"0"!=a.f.args.autoplay?a.api.loadVideoByPlayerVars(a.f.args):a.api.cueVideoByPlayerVars(a.f.args))}
function Pj(a){var b=!0,c=Qj(a);c&&a.f&&(a=Rj(a),b=Kf(c,"version")===a);return b&&!!y("yt.player.Application.create")}
function Mj(a){if(!a.g&&!a.M){var b=Pj(a);if(b&&"html5"==(Qj(a)?"html5":null))a.N="html5",a.u||Sj(a);else if(Tj(a),a.N="html5",b&&a.l)a.aa.appendChild(a.l),Sj(a);else{a.f&&(a.f.loaded=!0);var c=!1;a.C=function(){c=!0;var d=Uj(a,"player_bootstrap_method")?y("yt.player.Application.createAlternate")||y("yt.player.Application.create"):y("yt.player.Application.create");var e=a.f?a.f.clone():void 0;d(a.aa,e,a.h);Sj(a)};
a.M=!0;b?a.C():(Yf(Rj(a),a.C),(b=a.h?a.h.cssUrl:a.f.assets.css)&&Fj(b),Vj(a)&&!c&&x("yt.player.Application.create",null,void 0))}}}
function Qj(a){var b=Gc(a.i);!b&&a.m&&a.m.querySelector&&(b=a.m.querySelector("#"+a.i));return b}
function Sj(a){if(!a.g){var b=Qj(a),c=!1;b&&b.getApiInterface&&b.getApiInterface()&&(c=!0);c?(a.M=!1,!Uj(a,"html5_remove_not_servable_check_killswitch")&&b.isNotServable&&a.f&&b.isNotServable(a.f.args.video_id)||Wj(a)):a.sa=S(function(){Sj(a)},50)}}
function Wj(a){Kj(a);a.u=!0;var b=Qj(a);b.addEventListener&&(a.F=Xj(a,b,"addEventListener"));b.removeEventListener&&(a.Y=Xj(a,b,"removeEventListener"));var c=b.getApiInterface();c=c.concat(b.getInternalApiInterface());for(var d=0;d<c.length;d++){var e=c[d];a.api[e]||(a.api[e]=Xj(a,b,e))}for(var f in a.j)a.F(f,a.j[f]);Oj(a);a.Z&&a.Z(a.api);a.H.P("onReady",a.api)}
function Xj(a,b,c){var d=b[c];return function(){try{return a.ga=null,d.apply(b,arguments)}catch(e){"sendAbandonmentPing"!=c&&(e.params=c,a.ga=e,Cf(e))}}}
function Kj(a){a.u=!1;if(a.Y)for(var b in a.j)a.Y(b,a.j[b]);for(var c in a.W)U(parseInt(c,10));a.W={};a.F=null;a.Y=null;for(var d in a.api)a.api[d]=null;a.api.addEventListener=a.ca.bind(a);a.api.removeEventListener=a.bb.bind(a);a.api.destroy=a.dispose.bind(a);a.api.getLastError=a.La.bind(a);a.api.getPlayerType=a.Ma.bind(a);a.api.getCurrentVideoConfig=a.Ka.bind(a);a.api.loadNewVideoConfig=a.loadNewVideoConfig.bind(a);a.api.isReady=a.Va.bind(a)}
n.Va=function(){return this.u};
n.ca=function(a,b){var c=this,d=Nj(this,b);if(d){if(!(0<=Ya(this.Da,a)||this.j[a])){var e=Yj(this,a);this.F&&this.F(a,e)}this.H.subscribe(a,d);"onReady"==a&&this.u&&S(function(){d(c.api)},0)}};
n.bb=function(a,b){if(!this.g){var c=Nj(this,b);c&&df(this.H,a,c)}};
function Nj(a,b){var c=b;if("string"==typeof b){if(a.ba[b])return a.ba[b];c=function(){var d=y(b);d&&d.apply(w,arguments)};
a.ba[b]=c}return c?c:null}
function Yj(a,b){var c="ytPlayer"+b+a.G;a.j[b]=c;w[c]=function(d){var e=S(function(){if(!a.g){a.H.P(b,d);var f=a.W,g=String(e);g in f&&delete f[g]}},0);
kb(a.W,String(e))};
return c}
...
n.Ma=function(){return this.N||(Qj(this)?"html5":null)};
n.La=function(){return this.ga};
function Tj(a){a.cancel();Kj(a);a.N=null;a.f&&(a.f.loaded=!1);var b=Qj(a);b&&(Pj(a)||!Vj(a)?a.l=b:(b&&b.destroy&&b.destroy(),a.l=null));for(a=a.aa;b=a.firstChild;)a.removeChild(b)}
n.cancel=function(){if(this.C){var a=Rj(this);dg(a,this.C)}U(this.sa);this.M=!1};
n.o=function(){Tj(this);if(this.l&&this.f&&this.l.destroy)try{this.l.destroy()}catch(b){Bf(b)}this.ba=null;for(var a in this.j)w[this.j[a]]=null;this.ha=this.f=this.api=null;delete this.aa;delete this.m;M.prototype.o.call(this)};
function Vj(a){return a.f&&a.f.args&&a.f.args.fflags?-1!=a.f.args.fflags.indexOf("player_destroy_old_version=true"):!1}
function Rj(a){return a.h?a.h.jsUrl:a.f.assets.js}
function Uj(a,b){if(a.h)var c=a.h.serializedExperimentFlags;else a.f&&a.f.args&&(c=a.f.args.fflags);return"true"==$g(c||"")[b]}
;var Zj={},ak="player_uid_"+(1E9*Math.random()>>>0);
function bk(a,b,c){var d="player";c=void 0===c?!0:c;var e;"string"===typeof d?e=Gc(d):e=d;d=e;e=ak+"_"+Na(d);var f=Zj[e];if(f&&c)return(b&&b.serializedExperimentFlags?b.serializedExperimentFlags.includes("web_player_remove_playerproxy=true"):a&&a.args&&a.args.fflags&&a.args.fflags.includes("web_player_remove_playerproxy=true"))?f.api.loadVideoByPlayerVars(a.args||null):f.loadNewVideoConfig(a),f.api;f=new Jj(d,e,a,b);Zj[e]=f;Tf("player-added",f.api);Sc(f,Sa(ck,f));return f.api}
function ck(a){delete Zj[a.getId()]}
;function dk(a){return(0===a.search("cue")||0===a.search("load"))&&"loadModule"!==a}
...
function gk(a,b,c,d){if(B(a)&&!Array.isArray(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}b={index:b,startSeconds:c,suggestedQuality:d};"string"===typeof a&&16===a.length?b.list="PL"+a:b.playlist=a;return b}
;function hk(a){a=void 0===a?!1:a;M.call(this);this.f=new O(a);Sc(this,Sa(Tc,this.f))}
F(hk,M);hk.prototype.subscribe=function(a,b,c){return this.g?0:this.f.subscribe(a,b,c)};
hk.prototype.j=function(a,b){this.g||this.f.P.apply(this.f,arguments)};function ik(a,b,c){hk.call(this);this.h=a;this.i=b;this.l=c}
v(ik,hk);function jk(a,b,c){if(!a.g){var d=a.h;d.g||a.i!=d.f||(a={id:a.l,command:b},c&&(a.data=c),d.f.postMessage(Ce(a),d.i))}}
ik.prototype.o=function(){this.i=this.h=null;hk.prototype.o.call(this)};function kk(a){M.call(this);this.f=a;this.f.subscribe("command",this.Ba,this);this.h={};this.j=!1}
v(kk,M);n=kk.prototype;n.start=function(){this.j||this.g||(this.j=!0,jk(this.f,"RECEIVING"))};
n.Ba=function(a,b,c){if(this.j&&!this.g){var d=b||{};switch(a){case "addEventListener":"string"===typeof d.event&&(a=d.event,a in this.h||(c=C(this.eb,this,a),this.h[a]=c,this.addEventListener(a,c)));break;case "removeEventListener":"string"===typeof d.event&&lk(this,d.event);break;default:this.i.isReady()&&this.i.isExternalMethodAvailable(a,c||null)&&(b=mk(a,b||{}),c=this.i.handleExternalCall(a,b,c||null),(c=nk(a,c))&&this.j&&!this.g&&jk(this.f,a,c))}}};
n.eb=function(a,b){this.j&&!this.g&&jk(this.f,a,this.ka(a,b))};
n.ka=function(a,b){if(null!=b)return{value:b}};
function lk(a,b){b in a.h&&(a.removeEventListener(b,a.h[b]),delete a.h[b])}
n.o=function(){var a=this.f;a.g||df(a.f,"command",this.Ba,this);this.f=null;for(var b in this.h)lk(this,b);M.prototype.o.call(this)};function ok(a,b){kk.call(this,b);this.i=a;this.start()}
v(ok,kk);ok.prototype.addEventListener=function(a,b){this.i.addEventListener(a,b)};
ok.prototype.removeEventListener=function(a,b){this.i.removeEventListener(a,b)};
function mk(a,b){switch(a){case "loadVideoById":return b=fk(b),[b];case "cueVideoById":return b=fk(b),[b];case "loadVideoByPlayerVars":return[b];case "cueVideoByPlayerVars":return[b];case "loadPlaylist":return b=gk(b),[b];case "cuePlaylist":return b=gk(b),[b];case "seekTo":return[b.seconds,b.allowSeekAhead];case "playVideoAt":return[b.index];case "setVolume":return[b.volume];case "setPlaybackQuality":return[b.suggestedQuality];case "setPlaybackRate":return[b.suggestedRate];case "setLoop":return[b.loopPlaylists];
case "setShuffle":return[b.shufflePlaylist];case "getOptions":return[b.module];case "getOption":return[b.module,b.option];case "setOption":return[b.module,b.option,b.value];case "handleGlobalKeyDown":return[b.keyCode,b.shiftKey,b.ctrlKey,b.altKey,b.metaKey,b.key,b.code]}return[]}
function nk(a,b){switch(a){case "isMuted":return{muted:b};case "getVolume":return{volume:b};case "getPlaybackRate":return{playbackRate:b};case "getAvailablePlaybackRates":return{availablePlaybackRates:b};case "getVideoLoadedFraction":return{videoLoadedFraction:b};case "getPlayerState":return{playerState:b};case "getCurrentTime":return{currentTime:b};case "getPlaybackQuality":return{playbackQuality:b};case "getAvailableQualityLevels":return{availableQualityLevels:b};case "getDuration":return{duration:b};
case "getVideoUrl":return{videoUrl:b};case "getVideoEmbedCode":return{videoEmbedCode:b};case "getPlaylist":return{playlist:b};case "getPlaylistIndex":return{playlistIndex:b};case "getOptions":return{options:b};case "getOption":return{option:b}}}
ok.prototype.ka=function(a,b){switch(a){case "onReady":return;case "onStateChange":return{playerState:b};case "onPlaybackQualityChange":return{playbackQuality:b};case "onPlaybackRateChange":return{playbackRate:b};case "onError":return{errorCode:b}}return kk.prototype.ka.call(this,a,b)};
ok.prototype.o=function(){kk.prototype.o.call(this);delete this.i};function pk(a,b,c){M.call(this);var d=this;c=c||Q("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname;this.h=b||null;this.u="*";this.i=c;this.sessionId=null;this.channel="widget";this.C=!!a;this.m=function(e){a:if(!("*"!=d.i&&e.origin!=d.i||d.h&&e.source!=d.h||"string"!==typeof e.data)){try{var f=JSON.parse(e.data)}catch(g){break a}if(!(null==f||d.C&&(d.sessionId&&d.sessionId!=f.id||d.channel&&d.channel!=f.channel))&&f)switch(f.event){case "listening":"null"!=
...
v(pk,M);pk.prototype.sendMessage=function(a,b){var c=b||this.h;if(c){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var d=JSON.stringify(a);c.postMessage(d,this.u)}catch(e){Cf(e)}}};
pk.prototype.o=function(){window.removeEventListener("message",this.m);M.prototype.o.call(this)};function qk(){var a=this.g=new pk(!!Q("WIDGET_ID_ENFORCE")),b=C(this.ab,this);a.j=b;a.l=null;this.g.channel="widget";if(a=Q("WIDGET_ID"))this.g.sessionId=a;this.i=[];this.l=!1;this.j={}}
n=qk.prototype;n.ab=function(a,b,c){"addEventListener"==a&&b?(a=b[0],this.j[a]||"onReady"==a||(this.addEventListener(a,rk(this,a)),this.j[a]=!0)):this.xa(a,b,c)};
n.xa=function(){};
...
n.dispose=function(){this.g=null};function tk(a){qk.call(this);this.f=a;this.h=[];this.addEventListener("onReady",C(this.Ya,this));this.addEventListener("onVideoProgress",C(this.ib,this));this.addEventListener("onVolumeChange",C(this.jb,this));this.addEventListener("onApiChange",C(this.cb,this));this.addEventListener("onPlaybackQualityChange",C(this.fb,this));this.addEventListener("onPlaybackRateChange",C(this.gb,this));this.addEventListener("onStateChange",C(this.hb,this));this.addEventListener("onWebglSettingsChanged",C(this.kb,
this))}
v(tk,qk);n=tk.prototype;n.xa=function(a,b,c){if(this.f.isExternalMethodAvailable(a,c)){b=b||[];if(0<b.length&&dk(a)){var d=b;if(B(d[0])&&!Array.isArray(d[0]))d=d[0];else{var e={};switch(a){case "loadVideoById":case "cueVideoById":e=fk.apply(window,d);break;case "loadVideoByUrl":case "cueVideoByUrl":e=ek.apply(window,d);break;case "loadPlaylist":case "cuePlaylist":e=gk.apply(window,d)}d=e}b.length=1;b[0]=d}this.f.handleExternalCall(a,b,c);dk(a)&&sk(this,this.la())}};
...
this.f.getVideoUrl());this.f.getVideoContentRect&&(a.videoContentRect=this.f.getVideoContentRect());this.f.getProgressState&&(a.progressState=this.f.getProgressState());this.f.getPlaylist&&(a.playlist=this.f.getPlaylist());this.f.getPlaylistIndex&&(a.playlistIndex=this.f.getPlaylistIndex());this.f.getStoryboardFormat&&(a.storyboardFormat=this.f.getStoryboardFormat());sk(this,a)};
n.fb=function(a){sk(this,{playbackQuality:a})};
n.gb=function(a){sk(this,{playbackRate:a})};
...
n.jb=function(){sk(this,{muted:this.f.isMuted(),volume:this.f.getVolume()})};
n.ib=function(a){a={currentTime:a,videoBytesLoaded:this.f.getVideoBytesLoaded(),videoLoadedFraction:this.f.getVideoLoadedFraction(),currentTimeLastUpdated_:E()/1E3,playbackRate:this.f.getPlaybackRate(),mediaReferenceTime:this.f.getMediaReferenceTime()};this.f.getProgressState&&(a.progressState=this.f.getProgressState());sk(this,a)};
n.kb=function(){var a={sphericalProperties:this.f.getSphericalProperties()};sk(this,a)};
n.dispose=function(){qk.prototype.dispose.call(this);for(var a=0;a<this.h.length;a++){var b=this.h[a];this.f.removeEventListener(b.eventType,b.listener)}this.h=[]};function uk(a,b,c){M.call(this);this.f=a;this.i=c;this.j=V(window,"message",C(this.l,this));this.h=new ik(this,a,b);Sc(this,Sa(Tc,this.h))}
v(uk,M);uk.prototype.l=function(a){var b;if(b=!this.g)if(b=a.origin==this.i)a:{b=this.f;do{b:{var c=a.source;do{if(c==b){c=!0;break b}if(c==c.parent)break;c=c.parent}while(null!=c);c=!1}if(c){b=!0;break a}b=b.opener}while(null!=b);b=!1}if(b&&(b=a.data,"string"===typeof b)){try{b=JSON.parse(b)}catch(d){return}b.command&&(c=this.h,c.g||c.j("command",b.command,b.data,a.origin))}};
uk.prototype.o=function(){tg(this.j);this.f=null;M.prototype.o.call(this)};function vk(){var a=mb(wk),b;return Te(new N(function(c,d){a.onSuccess=function(e){jh(e)?c(e):d(new xk("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
a.onError=function(e){d(new xk("Unknown request error","net.unknown",e))};
a.U=function(e){d(new xk("Request timed out","net.timeout",e))};
b=sh("//googleads.g.doubleclick.net/pagead/id",a)}),function(c){c instanceof Ue&&b.abort();
return Oe(c)})}
function xk(a,b,c){G.call(this,a+", errorCode="+b);this.errorCode=b;this.xhr=c;this.name="PromiseAjaxError"}
v(xk,G);function yk(){this.g=0;this.f=null}
yk.prototype.then=function(a,b,c){return 1===this.g&&a?(a=a.call(c,this.f),Ie(a)?a:zk(a)):2===this.g&&b?(a=b.call(c,this.f),Ie(a)?a:Ak(a)):this};
yk.prototype.getValue=function(){return this.f};
yk.prototype.$goog_Thenable=!0;function Ak(a){var b=new yk;a=void 0===a?null:a;b.g=2;b.f=void 0===a?null:a;return b}
function zk(a){var b=new yk;a=void 0===a?null:a;b.g=1;b.f=void 0===a?null:a;return b}
;function Bk(a){G.call(this,a.message||a.description||a.name);this.isMissing=a instanceof Ck;this.isTimeout=a instanceof xk&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof Ue}
v(Bk,G);Bk.prototype.name="BiscottiError";function Ck(){G.call(this,"Biscotti ID is missing from server")}
v(Ck,G);Ck.prototype.name="BiscottiMissingError";var wk={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},Dk=null;
function Yg(){if(R("disable_biscotti_fetch_on_html5_clients"))return Oe(Error("Fetching biscotti ID is disabled."));if(R("condition_biscotti_fetch_on_consent_cookie_html5_clients")&&!Cc.get("CONSENT","").startsWith("YES+"))return Oe(Error("User has not consented - not fetching biscotti id."));if("1"===gb(xf(),"args","privembed"))return Oe(Error("Biscotti ID is not available in private embed mode"));Dk||(Dk=Te(vk().then(Ek),function(a){return Fk(2,a)}));
return Dk}
function Ek(a){a=a.responseText;if(0!=a.lastIndexOf(")]}'",0))throw new Ck;a=JSON.parse(a.substr(4));if(1<(a.type||1))throw new Ck;a=a.id;Zg(a);Dk=zk(a);Gk(18E5,2);return a}
function Fk(a,b){var c=new Bk(b);Zg("");Dk=Ak(c);0<a&&Gk(12E4,a-1);throw c;}
function Gk(a,b){S(function(){Te(vk().then(Ek,function(c){return Fk(b,c)}),z)},a)}
function Hk(){try{var a=y("yt.ads.biscotti.getId_");return a?a():Yg()}catch(b){return Oe(b)}}
;function Ik(a){if("1"!==gb(xf(),"args","privembed")){a&&Xg();try{Hk().then(function(){},function(){}),S(Ik,18E5)}catch(b){Bf(b)}}}
;var Y=y("ytglobal.prefsUserPrefsPrefs_")||{};x("ytglobal.prefsUserPrefsPrefs_",Y,void 0);function Jk(){this.f=Q("ALT_PREF_COOKIE_NAME","PREF");var a=Cc.get(""+this.f,void 0);if(a){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Y[d]=c.toString())}}}
n=Jk.prototype;n.get=function(a,b){Kk(a);Lk(a);var c=void 0!==Y[a]?Y[a].toString():null;return null!=c?c:b?b:""};
n.set=function(a,b){Kk(a);Lk(a);if(null==b)throw Error("ExpectedNotNull");Y[a]=b.toString()};
n.remove=function(a){Kk(a);Lk(a);delete Y[a]};
...
function Lk(a){if(/^f([1-9][0-9]*)$/.test(a))throw Error("ExpectedRegexMatch: "+a);}
function Kk(a){if(!/^\w+$/.test(a))throw Error("ExpectedRegexMismatch: "+a);}
function Mk(a){a=void 0!==Y[a]?Y[a].toString():null;return null!=a&&/^[A-Fa-f0-9]+$/.test(a)?parseInt(a,16):null}
Ka(Jk);function Nk(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];if(!Ok(a)||c.some(function(e){return!Ok(e)}))throw Error("Only objects may be merged.");
c=t(c);for(d=c.next();!d.done;d=c.next())Pk(a,d.value);return a}
function Pk(a,b){for(var c in b)if(Ok(b[c])){if(c in a&&!Ok(a[c]))throw Error("Cannot merge an object into a non-object.");c in a||(a[c]={});Pk(a[c],b[c])}else if(Qk(b[c])){if(c in a&&!Qk(a[c]))throw Error("Cannot merge an array into a non-array.");c in a||(a[c]=[]);Rk(a[c],b[c])}else a[c]=b[c];return a}
function Rk(a,b){for(var c=t(b),d=c.next();!d.done;d=c.next())d=d.value,Ok(d)?a.push(Pk({},d)):Qk(d)?a.push(Rk([],d)):a.push(d);return a}
...
c))&&c<l;){var m=a.charCodeAt(c-1);if(38==m||63==m){var p=a.charCodeAt(c+2);if(!p||61==p||38==p||35==p){var u=c;break d}}c+=3}u=-1}if(0>u)var r=null;else{var A=a.indexOf("&",u);if(0>A||A>l)A=l;u+=3;r=decodeURIComponent(a.substr(u,A-u).replace(/\+/g," "))}k="1"!==r}f=!k;break b}}catch(D){}f=!1}f?Vk(a)?(b&&b(),f=!0):f=!1:f=!1;f||Wk(a,b)}}
function Vk(a,b){try{if(window.navigator&&window.navigator.sendBeacon&&window.navigator.sendBeacon(a,void 0===b?"":b))return!0}catch(c){}return!1}
function Wk(a,b){var c=new Image,d=""+Tk++;Sk[d]=c;c.onload=c.onerror=function(){b&&Sk[d]&&b();delete Sk[d]};
c.src=a}
;function Xk(a,b){kj.call(this,1,arguments)}
v(Xk,kj);function Yk(a,b){kj.call(this,1,arguments)}
v(Yk,kj);var Zk=new lj("aft-recorded",Xk),$k=new lj("timing-sent",Yk);var al=window;function bl(){this.timing={};this.clearResourceTimings=function(){};
this.webkitClearResourceTimings=function(){};
this.mozClearResourceTimings=function(){};
this.msClearResourceTimings=function(){};
this.oClearResourceTimings=function(){}}
var cl=al.performance||al.mozPerformance||al.msPerformance||al.webkitPerformance||new bl;var dl=!1;C(cl.clearResourceTimings||cl.webkitClearResourceTimings||cl.mozClearResourceTimings||cl.msClearResourceTimings||cl.oClearResourceTimings||z,cl);function el(a){var b=fl(a);if(b.aft)return b.aft;a=Q((a||"")+"TIMING_AFT_KEYS",["ol"]);for(var c=a.length,d=0;d<c;d++){var e=b[a[d]];if(e)return e}return NaN}
function gl(a){var b;(b=y("ytcsi."+(a||"")+"data_"))||(b={tick:{},info:{}},Ua("ytcsi."+(a||"")+"data_",b));return b}
function hl(a){a=gl(a);a.info||(a.info={});return a.info}
function fl(a){a=gl(a);a.tick||(a.tick={});return a.tick}
function il(a){var b=gl(a).nonce;b||(b=Xi(),gl(a).nonce=b);return b}
function jl(a){var b=fl(a||""),c=el(a);c&&!dl&&(qj(Zk,new Xk(Math.round(c-b._start),a)),dl=!0)}
;function kl(){var a=y("ytcsi.debug");a||(a=[],x("ytcsi.debug",a,void 0),x("ytcsi.reference",{},void 0));return a}
function ll(a){a=a||"";var b=y("ytcsi.reference");b||(kl(),b=y("ytcsi.reference"));if(b[a])return b[a];var c=kl(),d={timerName:a,info:{},tick:{},span:{}};c.push(d);return b[a]=d}
;var ml=w.ytLoggingLatencyUsageStats_||{};x("ytLoggingLatencyUsageStats_",ml,void 0);function nl(){this.f=0}
function ol(){nl.f||(nl.f=new nl);return nl.f}
nl.prototype.tick=function(a,b,c){pl(this,"tick_"+a+"_"+b)||Gi("latencyActionTicked",{tickName:a,clientActionNonce:b},{timestamp:c})};
nl.prototype.info=function(a,b){var c=Object.keys(a).join("");pl(this,"info_"+c+"_"+b)||(c=Object.assign({},a),c.clientActionNonce=b,Gi("latencyActionInfo",c))};
nl.prototype.span=function(a,b){var c=Object.keys(a).join("");pl(this,"span_"+c+"_"+b)||(a.clientActionNonce=b,Gi("latencyActionSpan",a))};
function pl(a,b){ml[b]=ml[b]||{count:0};var c=ml[b];c.count++;c.time=W();a.f||(a.f=gg(function(){var d=W(),e;for(e in ml)ml[e]&&6E4<d-ml[e].time&&delete ml[e];a&&(a.f=0)},0,5E3));
return 5<c.count?(6===c.count&&1>1E5*Math.random()&&(c=new Wh("CSI data exceeded logging limit with key",b.split("_")),0<=b.indexOf("plev")||Oi(c)),!0):!1}
;var Z={},ql=(Z.ad_allowed="adTypesAllowed",Z.yt_abt="adBreakType",Z.ad_cpn="adClientPlaybackNonce",Z.ad_docid="adVideoId",Z.yt_ad_an="adNetworks",Z.ad_at="adType",Z.aida="appInstallDataAgeMs",Z.browse_id="browseId",Z.p="httpProtocol",Z.t="transportProtocol",Z.cpn="clientPlaybackNonce",Z.ccs="creatorInfo.creatorCanaryState",Z.cseg="creatorInfo.creatorSegment",Z.csn="clientScreenNonce",Z.docid="videoId",Z.GetHome_rid="requestIds",Z.GetSearch_rid="requestIds",Z.GetPlayer_rid="requestIds",Z.GetWatchNext_rid=
...
Z.rcl="mwebInfo.responseContentLength",Z.GetSettings_rid="requestIds",Z.GetTrending_rid="requestIds",Z.GetMusicSearchSuggestions_rid="requestIds",Z.REQUEST_ID="requestIds",Z),rl="isContinuation isNavigation kabukiInfo.earlyBrowseRequestInfo.adopted kabukiInfo.isPrefetch kabukiInfo.isSecondaryNav isMonetized navigationRequestedSameUrl performanceNavigationTiming playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber tvInfo.isMdx tvInfo.isPreloaded isVisible watchInfo.isPlaylist playbackRequiresTap".split(" "),
sl={},tl=(sl.ccs="CANARY_STATE_",sl.mver="MEASUREMENT_VERSION_",sl.pis="PLAYER_INITIALIZED_STATE_",sl.yt_pt="LATENCY_PLAYER_",sl.pa="LATENCY_ACTION_",sl.aq="TV_APP_QUALITY_",sl.yt_vst="VIDEO_STREAM_TYPE_",sl),ul="all_vc ap c cver cbrand cmodel cplatform ctheme ei l_an l_mm plid srt yt_fss yt_li vpst vpni2 vpil2 icrc icrt pa GetAccountOverview_rid GetHistory_rid cmt d_vpct d_vpnfi d_vpni nsru pc pfa pfeh pftr pnc prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis ytu_pvis yt_ref yt_sts tds".split(" ");
function vl(a){return!!Q("FORCE_CSI_ON_GEL",!1)||R("csi_on_gel")||!!gl(a).useGel}
function wl(a){a=gl(a);if(!("gel"in a))a.gel={gelTicks:{},gelInfos:{}};else if(a.gel){var b=a.gel;b.gelInfos||(b.gelInfos={});b.gelTicks||(b.gelTicks={})}return a.gel}
;function xl(a,b,c){if(null!==b)if(hl(c)[a]=b,vl(c)){var d=b;b=wl(c);if(b.gelInfos)b.gelInfos["info_"+a]=!0;else{var e={};b.gelInfos=(e["info_"+a]=!0,e)}if(a.match("_rid")){var f=a.split("_rid")[0];a="REQUEST_ID"}if(a in ql){b=ql[a];0<=Ya(rl,b)&&(d=!!d);a in tl&&"string"===typeof d&&(d=tl[a]+d.toUpperCase().replace(/-/g,"_"));a=d;d=b.split(".");for(var g=e={},h=0;h<d.length-1;h++){var k=d[h];g[k]={};g=g[k]}g[d[d.length-1]]="requestIds"===b?[{id:a,endpoint:f}]:a;f=Nk({},e)}else 0<=Ya(ul,a)||Oi(new Wh("Unknown label logged with GEL CSI",
a)),f=void 0;f&&vl(c)&&(b=ll(c||""),Nk(b.info,f),b=wl(c),"gelInfos"in b||(b.gelInfos={}),Nk(b.gelInfos,f),c=il(c),ol().info(f,c))}else ll(c||"").info[a]=b}
function yl(a,b,c){var d=fl(c);if(R("use_first_tick")&&zl(a,c))return d[a];if(!b&&"_"!==a[0]){var e=a;cl.mark&&(0==e.lastIndexOf("mark_",0)||(e="mark_"+e),c&&(e+=" ("+c+")"),cl.mark(e))}e=b||W();d[a]=e;e=wl(c);e.gelTicks&&(e.gelTicks["tick_"+a]=!0);c||b||W();if(vl(c)){ll(c||"").tick[a]=b||W();e=il(c);if("_start"===a){var f=ol();pl(f,"baseline_"+e)||Gi("latencyActionBaselined",{clientActionNonce:e},{timestamp:b})}else ol().tick(a,e,b);jl(c);e=!0}else e=!1;if(!e){if(!y("yt.timing."+(c||"")+"pingSent_")&&
(f=Q((c||"")+"TIMING_ACTION",void 0),e=fl(c),y("ytglobal.timing"+(c||"")+"ready_")&&f&&zl("_start")&&el(c)))if(jl(c),c)Al(c);else{f=!0;var g=Q("TIMING_WAIT",[]);if(g.length)for(var h=0,k=g.length;h<k;++h)if(!(g[h]in e)){f=!1;break}f&&Al(c)}ll(c||"").tick[a]=b||W()}return d[a]}
function zl(a,b){var c=fl(b);return a in c}
function Al(a){if(!vl(a)){var b=fl(a),c=hl(a),d=b._start,e=Q("CSI_SERVICE_NAME","youtube"),f={v:2,s:e,action:Q((a||"")+"TIMING_ACTION",void 0)},g=c.srt;void 0!==b.srt&&delete c.srt;b.aft=el(a);var h=fl(a),k=h.pbr,l=h.vc;h=h.pbs;k&&l&&h&&k<l&&l<h&&hl(a).yt_pvis&&"youtube"===e&&(xl("yt_lt","hot_bg",a),e=b.vc,k=b.pbs,delete b.aft,c.aft=Math.round(k-e));for(var m in c)"_"!==m.charAt(0)&&(f[m]=c[m]);b.ps=W();m={};e=[];for(var p in b)"_"!==p.charAt(0)&&(k=Math.round(b[p]-d),m[p]=k,e.push(p+"."+k));f.rt=
e.join(",");b=!!c.ap;R("debug_csi_data")&&(c=y("yt.timing.csiData"),c||(c=[],Ua("yt.timing.csiData",c)),c.push({page:location.href,time:new Date,args:f}));c="";for(var u in f)f.hasOwnProperty(u)&&(c+="&"+u+"="+f[u]);f="/csi_204?"+c.substring(1);if(window.navigator&&window.navigator.sendBeacon&&b){var r=void 0===r?"":r;Vk(f,r)||Uk(f,void 0,void 0,void 0,r)}else Uk(f);x("yt.timing."+(a||"")+"pingSent_",!0,void 0);qj($k,new Yk(m.aft+(Number(g)||0),a))}}
var Bl=window;Bl.ytcsi&&(Bl.ytcsi.info=xl,Bl.ytcsi.tick=yl);var Cl=null,Dl=null,El=null,Fl={};function Gl(a){var b=a.id;a=a.ve_type;var c=Zi++;a=new $i({veType:a,veCounter:c,elementIndex:void 0,dataElement:void 0,youtubeData:void 0});Fl[b]=a;b=fj();c=dj();b&&c&&Aj(b,c,[a])}
function Hl(){var a=Cl.getVideoData(1);a=a.title?a.title+" - YouTube":"YouTube";document.title!==a&&(document.title=a)}
function Il(a){var b=a.csn;a=a.root_ve_type;if(b&&a&&(ij(b,a),a=dj()))for(var c in Fl){var d=Fl[c];d&&Aj(b,a,[d])}}
function Jl(a){Fl[a.id]=new $i({trackingParams:a.tracking_params})}
function Kl(a){var b=fj(),c=Fl[a.id];if(b&&c){a=R("use_default_events_client")?void 0:Fi;var d="INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK";c={csn:b,ve:c.getAsJson(),gestureType:d};d={ia:hj(b),V:b};"UNDEFINED_CSN"==b?Bj("visualElementGestured",c,d):a?Wg("visualElementGestured",c,a,d):Gi("visualElementGestured",c,d)}}
function Ll(a){a=a.ids;var b=fj();if(b)for(var c=0;c<a.length;c++){var d=Fl[a[c]];if(d){var e=b,f=R("use_default_events_client")?void 0:Fi;d={csn:e,ve:d.getAsJson(),eventType:1};var g={ia:hj(e),V:e};"UNDEFINED_CSN"==e?Bj("visualElementShown",d,g):f?Wg("visualElementShown",d,f,g):Gi("visualElementShown",d,g)}}}
;x("yt.setConfig",P,void 0);x("yt.config.set",P,void 0);x("yt.setMsg",Ef,void 0);x("yt.msgs.set",Ef,void 0);x("yt.logging.errors.log",Pi,void 0);
x("writeEmbed",function(){var a=Q("PLAYER_CONFIG",void 0);if(!a){var b=Q("PLAYER_VARS",void 0);b&&(a={args:b})}Ik(!0);"gvn"==a.args.ps&&(document.body.style.backgroundColor="transparent");a.args.forced_experiments||(b=window.location.href,-1!=b.indexOf("?")?(b=(b||"").split("#")[0],b=b.split("?",2),b=bh(1<b.length?b[1]:b[0])):b={},b.forced_experiments&&(a.args.forced_experiments=b.forced_experiments));a.attrs||(a.attrs={width:"100%",height:"100%",id:"video-player"});var c=document.referrer;b=Q("POST_MESSAGE_ORIGIN");
window!=window.top&&c&&c!=document.URL&&(a.args.loaderUrl=c);Cl=a=(c=Q("WEB_PLAYER_CONTEXT_CONFIGS",void 0))&&"WEB_PLAYER_CONTEXT_CONFIG_ID_EMBEDDED_PLAYER"in c?bk(a,c.WEB_PLAYER_CONTEXT_CONFIG_ID_EMBEDDED_PLAYER,!1):bk(a);a.addEventListener("onScreenChanged",Il);a.addEventListener("onLogClientVeCreated",Gl);a.addEventListener("onLogServerVeCreated",Jl);a.addEventListener("onLogVeClicked",Kl);a.addEventListener("onLogVesShown",Ll);a.addEventListener("onVideoDataChange",Hl);c=Q("POST_MESSAGE_ID","player");
Q("ENABLE_JS_API")?El=new tk(a):Q("ENABLE_POST_API")&&"string"===typeof c&&"string"===typeof b&&(Dl=new uk(window.parent,c,b),El=new ok(a,Dl.h));kg()},void 0);
var Ml=Af(function(){yl("ol");var a=Jk.getInstance(),b=!!((Mk("f"+(Math.floor(119/31)+1))||0)&67108864),c=1<window.devicePixelRatio;if(document.body&&Ld(document.body,"exp-invert-logo"))if(c&&!Ld(document.body,"inverted-hdpi")){var d=document.body;if(d.classList)d.classList.add("inverted-hdpi");else if(!Ld(d,"inverted-hdpi")){var e=Jd(d);Kd(d,e+(0<e.length?" inverted-hdpi":"inverted-hdpi"))}}else!c&&Ld(document.body,"inverted-hdpi")&&Md();b!=c&&(b="f"+(Math.floor(119/31)+1),d=Mk(b)||0,d=c?d|67108864:
d&-67108865,0==d?delete Y[b]:(c=d.toString(16),Y[b]=c.toString()),a.save())}),Nl=Af(function(){var a=Cl;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();Q("PL_ATT")&&Ti.dispose();a=0;for(var b=ig.length;a<b;a++){var c=ig[a];if(!isNaN(c)){var d=y("yt.scheduler.instance.cancelJob");d?d(c):U(c)}}ig.length=0;cg("//static.doubleclick.net/instream/ad_status.js");jg=!1;P("DCLKSTAT",0);Uc(El,Dl);if(a=Cl)a.removeEventListener("onScreenChanged",Il),a.removeEventListener("onLogClientVeCreated",Gl),a.removeEventListener("onLogServerVeCreated",Jl),a.removeEventListener("onLogVeClicked",Kl),a.removeEventListener("onLogVesShown",
Ll),a.removeEventListener("onVideoDataChange",Hl),a.destroy();Fl={}});
window.addEventListener?(window.addEventListener("load",Ml),window.addEventListener("unload",Nl)):window.attachEvent&&(window.attachEvent("onload",Ml),window.attachEvent("onunload",Nl));Ua("yt.abuse.player.botguardInitialized",y("yt.abuse.player.botguardInitialized")||Ui);Ua("yt.abuse.player.invokeBotguard",y("yt.abuse.player.invokeBotguard")||Vi);Ua("yt.abuse.dclkstatus.checkDclkStatus",y("yt.abuse.dclkstatus.checkDclkStatus")||lg);
Ua("yt.player.exports.navigate",y("yt.player.exports.navigate")||jj);Ua("yt.util.activity.init",y("yt.util.activity.init")||xg);Ua("yt.util.activity.getTimeSinceActive",y("yt.util.activity.getTimeSinceActive")||Ag);Ua("yt.util.activity.setTimestamp",y("yt.util.activity.setTimestamp")||yg);}).call(this);
