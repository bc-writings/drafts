...
(function($){
    ...
    //end of code related to ssl login issues
		...
		// Auto fill username with email address on membership application form
		$("#personify-pages-create-department-membership-form #edit-email").on('change', function(){
  		$("#personify-pages-create-department-membership-form #edit-username").val($(this).val());
		});
