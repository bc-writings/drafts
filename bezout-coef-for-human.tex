...
\date{10 Sept. 2019 - 17  Sept. 2019}
...
\input{bezout-coef-for-human/algo}
...
%\newpage
%\section{Trouver de bons coefficients de \bb}

%\input{bezout-coef-for-human/good-coef}



%%%% coef inf en val absolue à a et b dans l'laog de montée et descente (m^ê relation de récu doù facil à prouver) 
%%%%
%%%% montrere aussi toutes les solutions via au + bv = aU + bV  <==> a(u-U)=b(V-v) 
%%%% on divise par pgcd et alors lemme euclide donne toutes le spossibilité
